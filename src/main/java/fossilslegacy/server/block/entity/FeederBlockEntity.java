...
import fossilslegacy.server.item.FeederMeatLevel;
import fossilslegacy.server.item.FeederPlantsLevel;
...
public class FeederBlockEntity extends BaseContainerBlockEntity {
	...
	public static Map<Item, Integer> getMeatFoodLevel() {
		...
		map.put(FossilsLegacyItems.COOKED_PTEROSAURUS_MEAT.get(), 100);
		...
		map.put(FossilsLegacyItems.RAW_PTEROSAURUS_MEAT.get(), 100);
