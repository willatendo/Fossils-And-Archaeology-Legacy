...
public class FossilsLegacyBlocks {
	...
	public static final RegistryObject<Block> JURASSIC_FERN = BLOCKS.register("jurassic_fern", () -> new JurassicFernBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().randomTicks().sound(SoundType.GRASS)));
