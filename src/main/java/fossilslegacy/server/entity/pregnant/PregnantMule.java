...
public class PregnantMule extends Mule implements DinosaurEncyclopediaInfo, PregnantAnimal {
	...
	private static final EntityDataAccessor<Integer> PREGNANCY = SynchedEntityData.defineId(PregnantMule.class, EntityDataSerializers.INT);
