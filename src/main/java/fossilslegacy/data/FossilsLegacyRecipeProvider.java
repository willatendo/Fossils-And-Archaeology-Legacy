...
public class FossilsLegacyRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes(Consumer<FinishedRecipe> finishedRecipe) {
		...
		SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_SWORD), Ingredient.of(FossilsLegacyItems.GEM_ARTIFACT.get()), Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), RecipeCategory.TOOLS, FossilsLegacyItems.GEM_SWORD.get()).unlocks("has_item", has(FossilsLegacyItems.GEM_ARTIFACT.get())).save(finishedRecipe, FossilsLegacyUtils.resource("gem_sword"));
		SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_SHOVEL), Ingredient.of(FossilsLegacyItems.GEM_ARTIFACT.get()), Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), RecipeCategory.TOOLS, FossilsLegacyItems.GEM_SHOVEL.get()).unlocks("has_item", has(FossilsLegacyItems.GEM_ARTIFACT.get())).save(finishedRecipe, FossilsLegacyUtils.resource("gem_shovel"));
		SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_PICKAXE), Ingredient.of(FossilsLegacyItems.GEM_ARTIFACT.get()), Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), RecipeCategory.TOOLS, FossilsLegacyItems.GEM_PICKAXE.get()).unlocks("has_item", has(FossilsLegacyItems.GEM_ARTIFACT.get())).save(finishedRecipe, FossilsLegacyUtils.resource("gem_pickaxe"));
		SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_AXE), Ingredient.of(FossilsLegacyItems.GEM_ARTIFACT.get()), Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), RecipeCategory.TOOLS, FossilsLegacyItems.GEM_AXE.get()).unlocks("has_item", has(FossilsLegacyItems.GEM_ARTIFACT.get())).save(finishedRecipe, FossilsLegacyUtils.resource("gem_axe"));
		SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_HOE), Ingredient.of(FossilsLegacyItems.GEM_ARTIFACT.get()), Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), RecipeCategory.TOOLS, FossilsLegacyItems.GEM_HOE.get()).unlocks("has_item", has(FossilsLegacyItems.GEM_ARTIFACT.get())).save(finishedRecipe, FossilsLegacyUtils.resource("gem_hoe"));
