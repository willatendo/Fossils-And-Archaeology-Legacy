...
public class FossilsLegacyLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		this.add("cave_painting.fossilslegacy.lighting.title", "Lightning");
		this.add("cave_painting.fossilslegacy.lighting.author", "Team July");
		this.add("cave_painting.fossilslegacy.social.title", "Social");
		this.add("cave_painting.fossilslegacy.great_war.title", "Great War");
		this.add("cave_painting.fossilslegacy.great_war.author", "Team July");
		this.add("cave_painting.fossilslegacy.anu_death.title", "Anu's Death");
		this.add("cave_painting.fossilslegacy.anu_death.author", "Team July");
		this.add("cave_painting.fossilslegacy.portal.title", "Portal");
		this.add("cave_painting.fossilslegacy.portal.author", "Team July");
		this.add("cave_painting.fossilslegacy.herobrine.title", "Herobrine");
		this.add("cave_painting.fossilslegacy.herobrine.author", "Team July");
		this.add("cave_painting.fossilslegacy.skeleton_and_creeper.title", "Skeleton and Creeper");
		this.add("cave_painting.fossilslegacy.skeleton_and_creeper.author", "Team July");
		this.add("cave_painting.fossilslegacy.zombie_and_spider.title", "Zombie and Spider");
		this.add("cave_painting.fossilslegacy.zombie_and_spider.author", "Team July");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_in_iceberg.title", "Tyrannosaurus in Iceberg");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_in_iceberg.author", "Team July");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_transport.title", "Tyrannosaurus Transport");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_transport.author", "Team July");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_melt.title", "Tyrannosaurus Melt");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_melt.author", "Team July");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_attack.title", "Tyrannosaurus Attack");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_attack.author", "Team July");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_death.title", "Tyrannosaurus Death");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_death.author", "Team July");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_corpse.title", "Tyrannosaurus Corpse");
		this.add("cave_painting.fossilslegacy.tyrannosaurus_corpse.author", "Team July");
		this.add("cave_painting.fossilslegacy.princess.title", "Princess");
		this.add("cave_painting.fossilslegacy.princess.author", "Team July");
		this.add("cave_painting.fossilslegacy.mosasaurus.title", "Mosasaurus");
		this.add("cave_painting.fossilslegacy.mosasaurus.author", "Team July");
		this.add("cave_painting.fossilslegacy.holy_mosasaurus.title", "Holy Mosasaurus");
		this.add("cave_painting.fossilslegacy.holy_mosasaurus.author", "Team July");
		this.add("cave_painting.fossilslegacy.past.title", "Past");
		this.add("cave_painting.fossilslegacy.past.author", "Team July");
		this.add("cave_painting.fossilslegacy.time_machine.title", "Time Machine");
		this.add("cave_painting.fossilslegacy.time_machine.author", "Team July");
		this.add("cave_painting.fossilslegacy.future.title", "Future");
		this.add("cave_painting.fossilslegacy.future.author", "Team July");
