...
//		Advancement fossil =
		...
		Advancement ancientHelmetArtifact = Advancement.Builder.advancement().parent(relicScraps).display(FossilsLegacyItems.ANCIENT_HELMET_ARTIFACT.get(), FossilsLegacyUtils.translation("advancements", "legacy.ancient_helmet_artifact.title"), FossilsLegacyUtils.translation("advancements", "legacy.ancient_helmet_artifact.desc"), null, FrameType.TASK, true, true, true).addCriterion("has_helmet_artifact", InventoryChangeTrigger.TriggerInstance.hasItems(FossilsLegacyItems.ANCIENT_HELMET_ARTIFACT.get())).save(saver, FossilsLegacyUtils.resource("legacy/helmet_artifact"), existingFileHelper);
		...
		Advancement.Builder.advancement().parent(archaeologyWorkbench).display(FossilsLegacyItems.STONE_TABLET.get(), FossilsLegacyUtils.translation("advancements", "legacy.stone_tablet.title"), FossilsLegacyUtils.translation("advancements", "legacy.stone_tablet.desc"), null, FrameType.TASK, true, true, true).addCriterion("used_stone_tablet", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.ANY), ItemPredicate.Builder.item().of(FossilsLegacyItems.STONE_TABLET.get()))).save(saver, FossilsLegacyUtils.resource("legacy/stone_tablet"), existingFileHelper);
