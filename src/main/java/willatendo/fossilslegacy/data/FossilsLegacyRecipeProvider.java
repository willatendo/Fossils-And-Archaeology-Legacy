...
public class FossilsLegacyRecipeProvider extends FabricRecipeProvider {
	...
	public void buildRecipes(RecipeOutput recipeOutput) {
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, FossilsLegacyBlocks.CULTIVATOR.get()).pattern("#$#").pattern("#%#").pattern("@@@").define('#', FossilsLegacyItemTags.GLASS).define('$', Items.GREEN_DYE).define('%', Items.WATER_BUCKET).define('@', Items.IRON_INGOT).unlockedBy("has_item", has(FossilsLegacyItemTags.GLASS)).save(recipeOutput, FossilsLegacyUtils.resource("cultivator"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, FossilsLegacyBlocks.FEEDER.get()).pattern("#$#").pattern("%@!").pattern("!!!").define('#', Items.IRON_INGOT).define('$', FossilsLegacyItemTags.GLASS).define('%', Blocks.STONE_BUTTON).define('@', Items.BUCKET).define('!', Blocks.STONE).unlockedBy("has_item", has(Blocks.STONE)).save(recipeOutput, FossilsLegacyUtils.resource("feeder"));
		...
		CultivationRecipeBuilder.recipe(FossilsLegacyItems.PTEROSAURUS_DNA.get(), FossilsLegacyItems.PTEROSAURUS_EGG.get(), 6000).unlockedBy("has_item", has(FossilsLegacyItems.PTEROSAURUS_DNA.get())).save(recipeOutput, FossilsLegacyUtils.resource("pterosaurus_egg"));
		...
		CultivationRecipeBuilder.recipe(FossilsLegacyItems.AXOLOTL_DNA.get(), FossilsLegacyItems.AXOLOTL_EGGS.get(), 6000).unlockedBy("has_item", has(FossilsLegacyItems.AXOLOTL_DNA.get())).save(recipeOutput, FossilsLegacyUtils.resource("axolotl_eggs"));
		...
		CultivationRecipeBuilder.recipe(FossilsLegacyItems.FROG_DNA.get(), FossilsLegacyItems.FROG_EGGS.get(), 6000).unlockedBy("has_item", has(FossilsLegacyItems.FROG_DNA.get())).save(recipeOutput, FossilsLegacyUtils.resource("frog_eggs"));
		...
		CultivationRecipeBuilder.recipe(FossilsLegacyItems.TURTLE_DNA.get(), Items.TURTLE_EGG, 6000).unlockedBy("has_item", has(FossilsLegacyItems.TURTLE_DNA.get())).save(recipeOutput, FossilsLegacyUtils.resource("turtle_egg"));
		...
		SpecialRecipeBuilder.special(MagicConchRecipe::new).save(recipeOutput, FossilsLegacyUtils.resource("magic_conch").toString());
		...
		meatAnalyzation(FossilsLegacyItems.RAW_PTEROSAURUS_MEAT.get(), FossilsLegacyItems.PTEROSAURUS_DNA.get(), recipeOutput);
	...
	protected static <T extends AbstractCookingRecipe> void faCookRecipes(RecipeOutput recipeOutput, String type, RecipeSerializer<T> recipeSerialiser, AbstractCookingRecipe.Factory<T> factory, int time) {
		...
		faCookingRecipe(recipeOutput, type, recipeSerialiser, factory, time, FossilsLegacyItems.RAW_PTEROSAURUS_MEAT.get(), FossilsLegacyItems.COOKED_PTEROSAURUS_MEAT.get(), 0.35F);
