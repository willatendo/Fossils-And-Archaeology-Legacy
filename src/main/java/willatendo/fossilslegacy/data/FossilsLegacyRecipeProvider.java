...
public class FossilsLegacyRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes(Consumer<FinishedRecipe> finishedRecipe) {
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.TOOLS, FossilsLegacyItems.DINOPEDIA.get()).requires(Items.BOOK).requires(FossilsLegacyItemTags.DNA).unlockedBy("has_item", has(FossilsLegacyItemTags.DNA)).save(finishedRecipe, FossilsLegacyUtils.resource("dinopedia"));
		...
		CultivationRecipeBuilder.recipe(FossilsLegacyItems.VELOCIRAPTOR_DNA.get(), FossilsLegacyItems.VELOCIRAPTOR_EGG.get(), 6000).unlockedBy("has_item", has(FossilsLegacyItems.VELOCIRAPTOR_DNA.get())).save(finishedRecipe, FossilsLegacyUtils.resource("velociraptor_egg"));
		...
		ArchaeologyRecipeBuilder.recipe(FossilsLegacyItems.ANCIENT_HELMET_ARTIFACT.get(), FossilsLegacyItems.ANCIENT_HELMET.get(), 3000).unlockedBy("has_item", has(FossilsLegacyItems.ANCIENT_HELMET_ARTIFACT.get())).save(finishedRecipe, FossilsLegacyUtils.resource("ancient_helmet"));
		ArchaeologyRecipeBuilder.recipe(FossilsLegacyItems.ANCIENT_SWORD_ARTIFACT.get(), FossilsLegacyItems.ANCIENT_SWORD.get(), 3000).unlockedBy("has_item", has(FossilsLegacyItems.ANCIENT_SWORD_ARTIFACT.get())).save(finishedRecipe, FossilsLegacyUtils.resource("ancient_sword"));
		...
		meatAnalyzation(FossilsLegacyItems.RAW_VELOCIRAPTOR_MEAT.get(), FossilsLegacyItems.VELOCIRAPTOR_DNA.get(), finishedRecipe);
	}
	...
	protected static void cookRecipes(Consumer<FinishedRecipe> finishedRecipe, String type, RecipeSerializer<? extends AbstractCookingRecipe> recipeSerialiser, int time) {
		...
		simpleCookingRecipe(finishedRecipe, type, recipeSerialiser, time, FossilsLegacyItems.RAW_VELOCIRAPTOR_MEAT.get(), FossilsLegacyItems.COOKED_VELOCIRAPTOR_MEAT.get(), 0.35F);
