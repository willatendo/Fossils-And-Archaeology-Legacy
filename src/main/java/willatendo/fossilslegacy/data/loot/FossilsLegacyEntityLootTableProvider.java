...
public class FossilsLegacyEntityLootTableProvider extends SimpleEntityLootSubProvider {
	...
	public void generate() {
		...
		this.add(FossilsLegacyEntityTypes.ANU.get(), LootTable.lootTable().withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 3.0F)).add(LootItem.lootTableItem(Items.COOKED_PORKCHOP)).add(LootItem.lootTableItem(FossilsExperimentsBlocks.TIME_MACHINE.get()))));
