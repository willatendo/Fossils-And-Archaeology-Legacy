...
public class FossilsLegacySoundDefinitionsProvider extends SimpleSoundDefinitionsProvider {
	...
	public void registerSounds() {
		...
		this.add(FossilsLegacySoundEvents.FUTABASAURUS_AMBIENT.get(), SoundDefinition.definition().subtitle(FossilsLegacyUtils.translation("sound", "futabasaurus.ambient").getString()).with(Sound.sound(FossilsLegacyUtils.resource("futabasaurus_ambient"), SoundType.SOUND)));
		this.add(FossilsLegacySoundEvents.FUTABASAURUS_HURT.get(), SoundDefinition.definition().subtitle(FossilsLegacyUtils.translation("sound", "futabasaurus.hurt").getString()).with(Sound.sound(FossilsLegacyUtils.resource("futabasaurus_hurt"), SoundType.SOUND)));
		this.add(FossilsLegacySoundEvents.FUTABASAURUS_DEATH.get(), SoundDefinition.definition().subtitle(FossilsLegacyUtils.translation("sound", "futabasaurus.death").getString()).with(Sound.sound(FossilsLegacyUtils.resource("futabasaurus_death"), SoundType.SOUND)));
