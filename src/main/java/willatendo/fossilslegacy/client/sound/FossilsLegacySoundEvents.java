...
public class FossilsLegacySoundEvents {
	...
	public static final RegistryObject<SoundEvent> DILOPHOSAURUS_AMBIENT = SOUND_EVENTS.register("entity.dilophosaurus.ambient", () -> SoundEvent.createVariableRangeEvent(FossilsLegacyUtils.resource("entity.dilophosaurus.ambient")));
	public static final RegistryObject<SoundEvent> DILOPHOSAURUS_CALL = SOUND_EVENTS.register("entity.dilophosaurus.call", () -> SoundEvent.createVariableRangeEvent(FossilsLegacyUtils.resource("entity.dilophosaurus.call")));
	public static final RegistryObject<SoundEvent> DILOPHOSAURUS_HURT = SOUND_EVENTS.register("entity.dilophosaurus.hurt", () -> SoundEvent.createVariableRangeEvent(FossilsLegacyUtils.resource("entity.dilophosaurus.hurt")));
	public static final RegistryObject<SoundEvent> DILOPHOSAURUS_DEATH = SOUND_EVENTS.register("entity.dilophosaurus.death", () -> SoundEvent.createVariableRangeEvent(FossilsLegacyUtils.resource("entity.dilophosaurus.death")));
