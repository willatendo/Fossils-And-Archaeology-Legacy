...
//public class VelociraptorLegacyModel extends LegacyModel {
//
//	public VelociraptorLegacyModel(ModelPart modelPart) {
//		super(modelPart);
...
//		if (!HeadTailFree) {
//			// right leg
//			thigh_R2.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//			leg_R2.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1 + 0.9948377F;
//			horn_1_R.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//			right_nail_1.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1 - 0.8726646F;
//			right_nail_2.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1 - 2.617994F;
//			// left leg
//			thigh_L2.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//			leg_L2.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 + 0.9948377F;
//			horn_2_L.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//			left_nail_1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 - 0.8726646F;
//			left_nail_2.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 - 2.617994F;
//			// right arm
//			thigh_R1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//			leg_R1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 + 0.994461F;
//			// left arm
//			thigh_L1.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//			leg_L1.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1 + 0.994461F;
//			// tail
...
//			// Head
//			/*
//			 * head2.rotateAngleY = -f3 / 57.29578F; head3_up.rotateAngleY = -f3 / 57.29578F; head3_down.rotateAngleY = -f3 / 57.29578F;
//			 */
//			if (Math.abs(thigh_L2.rotateAngleX) >= 0.174532F) {
//				// moving
//				HeadLower();
...
//			noumenon4.rotateAngleX += (0.6981317F / 10);
//		else
...
//		else
//			noumenon3.rotateAngleX = -0.5235988F;
//		if (noumenon4.rotateAngleX > -0.6981317F)
//			noumenon4.rotateAngleX -= (0.6981317F / 10);
//		else
//			noumenon4.rotateAngleX = -0.6981317F;
//	}
