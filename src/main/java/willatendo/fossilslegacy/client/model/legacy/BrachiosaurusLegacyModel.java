...
//public class BrachiosaurusLegacyModel extends DinosaurLegacyModel {
//	// fields
//	ModelRenderer Snout;
//	ModelRenderer Head;
//	ModelRenderer Crest;
...
//
//	public BrachiosaurusLegacyModel(ModelPart modelPart) {
//		super(modelPart);
...
//		if (modelized)
//			return;
//		Front_Thigh.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//		Front_Calf1.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//		Front_Thigh1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//		Front_Calf2.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//		Back_Thigh1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//		Back_CalfRight.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//		Back_Thigh.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//		Back_CalfLeft.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//
//	}
//}
