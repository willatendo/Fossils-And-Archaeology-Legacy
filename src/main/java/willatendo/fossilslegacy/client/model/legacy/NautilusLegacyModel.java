...
//public class NautilusLegacyModel extends LegacyModel<Nautilus> {
//	public NautilusLegacyModel(ModelPart modelPart) {
//		super(modelPart);
...
//	}
//
//	public void render(Nautilus entity, float f, float f1, float f2, float f3, float f4, float f5) {
...
//	}
//
//	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Nautilus par7Entity) {
//		super.setRotationAngles(f, f1, f2, f3, f4, f5, par7Entity);
//		Tech1.rotateAngleX = 0.2F * Mth.sin(f2 * 0.3F + (float) 1) + 0.4F;
//		Tech2.rotateAngleX = 0.2F * Mth.sin(f2 * 0.3F + (float) 2) + 0.4F;
//		Tech3.rotateAngleX = 0.2F * Mth.sin(f2 * 0.3F + (float) 3) + 0.4F;
//		Tech4.rotateAngleX = 0.2F * Mth.sin(f2 * 0.3F + (float) 4) + 0.4F;
//		Tech5.rotateAngleX = 0.2F * Mth.sin(f2 * 0.3F + (float) 5) + 0.4F;
//		Tech6.rotateAngleX = 0.2F * Mth.sin(f2 * 0.3F + (float) 6) + 0.4F;
//	}
//
//	// fields
