...
//public class DilophosaurusLegacyModel extends DinosaurLegacyModel {
//	// fields
//	ModelRenderer Head;
//	ModelRenderer Jaw1;
//	ModelRenderer Jaw2;
...
//
//	public DilophosaurusLegacyModel(ModelPart modelPart) {
//		super(modelPart);
...
//
//		/*
//		 * Heel1 = new ModelRenderer(this, 24, 12).setTextureSize(64, 32); Heel1.addBox(-1F, 0F, -1F, 2, 7, 2); Heel1.setRotationPoint(5F, 16F, 5F); setRotation(Heel1, -0.3717861F, 0F, 0F); Heel1.mirror = true; Heel2 = new ModelRenderer(this, 24, 12).setTextureSize(64, 32); Heel2.addBox(-1F, 0F, -1F, 2, 7, 2); Heel2.setRotationPoint(-5F, 16F, 5F); setRotation(Heel2, -0.3717861F, 0F, 0F); Heel2.mirror = true; Feet1 = new ModelRenderer(this, 35, 21).setTextureSize(64, 32); Feet1.addBox(-1F, 0F, -3F, 3, 2, 4); Feet1.setRotationPoint(5F, 22F, 3F); setRotation(Feet1, 0F, 0F, 0F); Feet1.mirror = true; Feet2 = new ModelRenderer(this, 35, 21).setTextureSize(64, 32); Feet2.addBox(-2F, 0F, -3F, 3, 2, 4); Feet2.setRotationPoint(-5F, 22F, 3F); setRotation(Feet2, 0F, 0F, 0F); Feet2.mirror = true;
//		 */
//
...
//			return;
//		// right leg
//		Thigh2.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//		Heel2.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1 - 0.372F;
//		Feet2.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//
//		// left leg
//		Thigh1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//		Heel1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 - 0.372F;
//		Feet1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//
//	}
//}
