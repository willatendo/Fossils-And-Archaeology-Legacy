...
public class StegosaurusModel extends EntityModel<Stegosaurus> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partDefinition.addOrReplaceChild("tail_3", CubeListBuilder.create().texOffs(56, 6).addBox(-0.5F, 2.5F, 7.5F, 2.0F, 2.0F, 4.0F).mirror(), PartPose.offset(0.0F, 14.0F, -1.0F));
