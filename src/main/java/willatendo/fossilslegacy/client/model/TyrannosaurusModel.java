...
//public class TyrannosaurusLegacyModel extends DinosaurLegacyModel {
//	final float SwingAngle = 0.174533F;
//
//	public TyrannosaurusLegacyModel(ModelPart modelPart) {
//		super(modelPart);
...
//		foot_R_1.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//		foot_R_2.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1 - 0.6108652F;
//		foot_R_3.rotateAngleX = Mth.cos(f * 0.6662F) * 1.4F * f1;
//		foot_L_1.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
//		foot_L_2.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 - 0.6108652F;
//		foot_L_3.rotateAngleX = Mth.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
