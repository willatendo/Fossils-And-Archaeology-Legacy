...
public class FossilsLegacyEntityTypes {
	...
	public static final SimpleHolder<EntityType<Futabasaurus>> FUTABASAURUS = ENTITY_TYPES.register("futabasaurus", () -> FabricEntityTypeBuilder.<Futabasaurus>create(MobCategory.WATER_CREATURE, Futabasaurus::new).dimensions(EntityDimensions.scalable(1.0F, 0.65F)).build());
