...
public class PregnantCat extends Cat implements DinosaurEncyclopediaInfo, PregnantAnimal {
	...
	private static final EntityDataAccessor<Integer> PREGNANCY = SynchedEntityData.defineId(PregnantCat.class, EntityDataSerializers.INT);
