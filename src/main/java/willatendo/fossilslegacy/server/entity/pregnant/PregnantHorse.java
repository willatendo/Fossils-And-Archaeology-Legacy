...
public class PregnantHorse extends Horse implements DinosaurEncyclopediaInfo, PregnantAnimal {
	...
	private static final EntityDataAccessor<Integer> PREGNANCY = SynchedEntityData.defineId(PregnantHorse.class, EntityDataSerializers.INT);
