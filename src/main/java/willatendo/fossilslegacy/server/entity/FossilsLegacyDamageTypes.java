...
public class FossilsLegacyDamageTypes {
	...
	public static void bootstrap(BootstapContext<DamageType> bootstapContext) {
		bootstapContext.register(ANIMAL_STARVE, new DamageType("animal_starve", 0.1F));
		bootstapContext.register(DILOPHOSAURUS_ENVENOMATION, new DamageType("dilophosaurus_envenomation", 0.1F));
		bootstapContext.register(JAVELIN, new DamageType("javelin", 0.1F));
	}
}
