...
public class FossilsLegacyFossilVariants {
	...
	public static final SimpleHolder<FossilVariant> PLESIOSAURUS = register("plesiosaurus", 12, 1.0F, 0.25F, 0.15F, fossil -> FossilScaleFactor.create(1.5F + (0.3F * (float) fossil.getSize())));
	public static final SimpleHolder<FossilVariant> PTERANODON = register("pteranodon", 8, 0.25F, 0.15F, 0.125F, fossil -> FossilScaleFactor.create(0.8F + (0.2F * (float) fossil.getSize())));
