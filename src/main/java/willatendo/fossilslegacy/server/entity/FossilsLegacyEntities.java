...
public class FossilsLegacyEntities {
	...
	public static final SimpleHolder<EntityType<Pteranodon>> PTERANODON = ENTITY_TYPES.register("pteranodon", () -> FabricEntityTypeBuilder.<Pteranodon>create(MobCategory.CREATURE, Pteranodon::new).dimensions(EntityDimensions.scalable(0.25F, 0.25F)).build());
