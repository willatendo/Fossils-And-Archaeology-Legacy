...
public class FossilsLegacyEntities {
	...
	public static final RegistryObject<EntityType<Tyrannosaurus>> TYRANNOSAURUS = ENTITY_TYPES.register("tyrannosaurus", () -> EntityType.Builder.<Tyrannosaurus>of(Tyrannosaurus::new, MobCategory.CREATURE).sized(0.5F, 0.5F).build("tyrannosaurus"));
	public static final RegistryObject<EntityType<Velociraptor>> VELOCIRAPTOR = ENTITY_TYPES.register("velociraptor", () -> EntityType.Builder.<Velociraptor>of(Velociraptor::new, MobCategory.CREATURE).sized(0.5F, 0.5F).build("velociraptor"));
