...
public class FossilsLegacyItems {
	...
	public static final SimpleHolder<EggItem> TRICERATOPS_EGG = ITEMS.register("triceratops_egg", () -> new EggItem(Egg.EggType.TRICERATOPS, new Item.Properties().stacksTo(1)));
	public static final SimpleHolder<EggItem> VELOCIRAPTOR_EGG = ITEMS.register("velociraptor_egg", () -> new EggItem(Egg.EggType.VELOCIRAPTOR, new Item.Properties().stacksTo(1)));
	public static final SimpleHolder<EggItem> TYRANNOSAURUS_EGG = ITEMS.register("tyrannosaurus_egg", () -> new EggItem(Egg.EggType.TYRANNOSAURUS, new Item.Properties().stacksTo(1)));
	public static final SimpleHolder<EggItem> PTERANODON_EGG = ITEMS.register("pteranodon_egg", () -> new EggItem(Egg.EggType.PTERANODON, new Item.Properties().stacksTo(1)));
	...
	public static final SimpleHolder<EggItem> PLESIOSAURUS_EGG = ITEMS.register("plesiosaurus_egg", () -> new EggItem(Egg.EggType.PLESIOSAURUS, new Item.Properties().stacksTo(1)));
	public static final SimpleHolder<EggItem> MOSASAURUS_EGG = ITEMS.register("mosasaurus_egg", () -> new EggItem(Egg.EggType.MOSASAURUS, new Item.Properties().stacksTo(1)));
	public static final SimpleHolder<EggItem> STEGOSAURUS_EGG = ITEMS.register("stegosaurus_egg", () -> new EggItem(Egg.EggType.STEGOSAURUS, new Item.Properties().stacksTo(1)));
	public static final SimpleHolder<EggItem> DILOPHOSAURUS_EGG = ITEMS.register("dilophosaurus_egg", () -> new EggItem(Egg.EggType.DILOPHOSAURUS, new Item.Properties().stacksTo(1)));
	public static final SimpleHolder<EggItem> BRACHIOSAURUS_EGG = ITEMS.register("brachiosaurus_egg", () -> new EggItem(Egg.EggType.BRACHIOSAURUS, new Item.Properties().stacksTo(1)));
	...
	public static final SimpleHolder<SpawnEggItem> BRACHIOSAURUS_SPAWN_EGG = ITEMS.register("brachiosaurus_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.BRACHIOSAURUS.get(), 0x3b3e55, 0x7f8ba1, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> DILOPHOSAURUS_SPAWN_EGG = ITEMS.register("dilophosaurus_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.DILOPHOSAURUS.get(), 0x686442, 0xf1bc2c, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> MAMMOTH_SPAWN_EGG = ITEMS.register("mammoth_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.MAMMOTH.get(), 0x3d2700, 0x211500, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> MOSASAURUS_SPAWN_EGG = ITEMS.register("mosasaurus_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.MOSASAURUS.get(), 0x0d7346, 0xffe1a7, new Item.Properties()));
	...
	public static final SimpleHolder<SpawnEggItem> PLESIOSAURUS_SPAWN_EGG = ITEMS.register("plesiosaurus_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.PLESIOSAURUS.get(), 0xca6700, 0xb92200, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> PTERANODON_SPAWN_EGG = ITEMS.register("pteranodon_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.PTERANODON.get(), 0x7c5d89, 0x450e5b, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> SMILODON_SPAWN_EGG = ITEMS.register("smilodon_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.SMILODON.get(), 0xefa745, 0x9a6527, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> STEGOSAURUS_SPAWN_EGG = ITEMS.register("stegosaurus_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.STEGOSAURUS.get(), 0x839d00, 0x785f00, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> TRICERATOPS_SPAWN_EGG = ITEMS.register("triceratops_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.TRICERATOPS.get(), 0xc2ff51, 0x638a25, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> TYRANNOSAURUS_SPAWN_EGG = ITEMS.register("tyrannosaurus_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.TYRANNOSAURUS.get(), 0x918066, 0x4f473a, new Item.Properties()));
	public static final SimpleHolder<SpawnEggItem> VELOCIRAPTOR_SPAWN_EGG = ITEMS.register("velociraptor_spawn_egg", () -> new SpawnEggItem(FossilsLegacyEntities.VELOCIRAPTOR.get(), 0x66965f, 0x884c2e, new Item.Properties()));
