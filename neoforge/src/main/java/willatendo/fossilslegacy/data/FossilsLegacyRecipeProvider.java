...
public class FossilsLegacyRecipeProvider extends RecipeProvider {
    ...
    public void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.BONE, 5).requires(FossilsLegacyBlocks.SKULL_BLOCK.get()).unlockedBy("has_item", has(FossilsLegacyBlocks.SKULL_BLOCK.get())).save(recipeOutput, FossilsLegacyUtils.resource("skull_bonemeal"));
