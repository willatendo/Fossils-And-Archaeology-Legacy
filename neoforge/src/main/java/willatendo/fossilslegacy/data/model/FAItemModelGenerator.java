...
public class FAItemModelGenerator extends SimpleItemModelGenerator {
    ...
    public void run() {
        ...
        this.generatedItem(FAItems.CENOCERAS_DNA.get());
        ...
        this.generatedItem(FAItems.CENOCERAS_EGGS.get());
        ...
        this.generatedItem(FAItems.CENOCERAS.get());
        ...
        this.generatedItem(FAItems.NAUTILUS_SIO_CHIU_LE.get());
        this.generatedItem(FAItems.CENOCERAS_SIO_CHIU_LE.get());
        ...
        this.generatedItem(FAItems.CENOCERAS_SHELL.get());
        ...
        this.generatedItem(FAItems.BAT_DNA.get());
        this.generatedItem(FAItems.BEE_DNA.get());
        this.generatedItem(FAItems.CAT_DNA.get());
        this.generatedItem(FAItems.CAMEL_DNA.get());
        this.generatedItem(FAItems.CHICKEN_DNA.get());
        this.generatedItem(FAItems.COD_DNA.get());
        ...
        this.generatedItem(FAItems.PUFFERFISH_DNA.get());
        this.generatedItem(FAItems.RABBIT_DNA.get());
        this.generatedItem(FAItems.SALMON_DNA.get());
        this.generatedItem(FAItems.SHEEP_DNA.get());
        this.generatedItem(FAItems.SQUID_DNA.get());
        this.generatedItem(FAItems.TROPICAL_FISH_DNA.get());
        this.generatedItem(FAItems.TURTLE_DNA.get());
        ...
        this.generatedItem(FAItems.BAT_EMBRYO_SYRINGE.get());
        this.generatedItem(FAItems.BEE_EGGS.get());
        this.generatedItem(FAItems.CAT_EMBRYO_SYRINGE.get());
        this.generatedItem(FAItems.CAMEL_EMBRYO_SYRINGE.get());
        this.generatedItem(FAItems.INCUBATED_CHICKEN_EGG.get());
        this.generatedItem(FAItems.COD_EGGS.get());
        ...
        this.generatedItem(FAItems.PUFFERFISH_EGGS.get());
        this.generatedItem(FAItems.RABBIT_EMBRYO_SYRINGE.get());
        this.generatedItem(FAItems.SALMON_EGGS.get());
        this.generatedItem(FAItems.SHEEP_EMBRYO_SYRINGE.get());
        this.generatedItem(FAItems.SQUID_EGGS.get());
        this.generatedItem(FAItems.TROPICAL_FISH_EGGS.get());
        ...
        this.generatedItem(FAItems.NAUTILUS_MAGIC_CONCH.get());
        this.generatedItem(FAItems.CENOCERAS_MAGIC_CONCH.get());
        ...
        this.spawnEggItem(FAItems.NAUTILUS_SPAWN_EGG.get(), 0xD48080, 0xE2C1AE);
        this.spawnEggItem(FAItems.CENOCERAS_SPAWN_EGG.get(), 0xa95453, 0xc1c1c1);
