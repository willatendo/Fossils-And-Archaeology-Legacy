...
public class FABlockModelGenerator extends SimpleBlockModelGenerator {
    ...
    private void createCycadHead(Block cycadHead) {
        ResourceLocation headCone = FAModelTemplates.TEMPLATE_CYCAD_HEAD_CONE.createWithSuffix(cycadHead, "_cone", new TextureMapping().put(TextureSlot.SIDE, this.modLocation("block/cycad_log")).put(TextureSlot.TOP, this.modLocation("block/cycad_log_top")).put(FATextureSlot.HEAD, this.modLocation("block/cycad_head")).put(FATextureSlot.LEAVES, this.modLocation("block/cycad_leaves")), this.modelOutput);
    ...
    private void createCycadLog(Block cycadLog) {
        this.block(MultiVariantGenerator.multiVariant(cycadLog, Variant.variant().with(VariantProperties.MODEL, FAModelTemplates.TEMPLATE_CYCAD_LOG.create(cycadLog, new TextureMapping().put(TextureSlot.SIDE, this.modLocation("block/cycad_log")).put(TextureSlot.TOP, this.modLocation("block/cycad_log_top")), this.modelOutput))));
    }
