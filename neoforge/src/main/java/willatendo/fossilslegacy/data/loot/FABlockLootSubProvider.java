...
public class FABlockLootSubProvider extends SimpleBlockLootSubProvider {
    ...
    public void generate() {
        ...
        this.createOtherWhenSilkTouch(FABlocks.SHATTERED_CULTIVATOR.get(), Items.IRON_INGOT, 3);
        ...
        this.dropSelf(FABlocks.NIPA_STEM.get());
        this.dropSelf(FABlocks.NIPA_LEAVES.get());
        this.dropSelf(FABlocks.DRIED_NIPA_LEAVES.get());
        ...
        this.dropSelf(FABlocks.THATCH_BLOCK.get());
        this.dropSelf(FABlocks.THATCH_STAIRS.get());
        this.dropSelfSlab(FABlocks.THATCH_SLAB.get());
