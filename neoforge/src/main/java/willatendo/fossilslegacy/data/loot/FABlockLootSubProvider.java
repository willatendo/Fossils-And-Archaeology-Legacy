...
public class FABlockLootSubProvider extends SimpleBlockLootSubProvider {
    ...
    public void generate() {
        ...
        this.dropSelf(FABlocks.ARAUCARIOXYLON_PLANKS.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_SAPLING.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_LOG.get());
        this.dropSelf(FABlocks.STRIPPED_ARAUCARIOXYLON_LOG.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_WOOD.get());
        this.dropSelf(FABlocks.STRIPPED_ARAUCARIOXYLON_WOOD.get());
        this.add(FABlocks.ARAUCARIOXYLON_LEAVES.get(), block -> this.createLeavesDrops(block, FABlocks.ARAUCARIOXYLON_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        this.dropSelf(FABlocks.ARAUCARIOXYLON_STAIRS.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_SIGN.get());
        this.add(FABlocks.ARAUCARIOXYLON_DOOR.get(), this::createDoorTable);
        this.dropSelf(FABlocks.ARAUCARIOXYLON_HANGING_SIGN.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_PRESSURE_PLATE.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_FENCE.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_TRAPDOOR.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_FENCE_GATE.get());
        this.dropPottedContents(FABlocks.POTTED_ARAUCARIOXYLON_SAPLING.get());
        this.dropSelf(FABlocks.ARAUCARIOXYLON_BUTTON.get());
        this.add(FABlocks.ARAUCARIOXYLON_SLAB.get(), this::createSlabItemTable);
        this.dropSelf(FABlocks.CORDAITES_PLANKS.get());
        this.dropSelf(FABlocks.CORDAITES_SAPLING.get());
        this.dropSelf(FABlocks.CORDAITES_LOG.get());
        this.dropSelf(FABlocks.STRIPPED_CORDAITES_LOG.get());
        this.dropSelf(FABlocks.CORDAITES_WOOD.get());
        this.dropSelf(FABlocks.STRIPPED_CORDAITES_WOOD.get());
        this.add(FABlocks.CORDAITES_LEAVES.get(), block -> this.createLeavesDrops(block, FABlocks.CORDAITES_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        this.dropSelf(FABlocks.CORDAITES_STAIRS.get());
        this.dropSelf(FABlocks.CORDAITES_SIGN.get());
        this.add(FABlocks.CORDAITES_DOOR.get(), this::createDoorTable);
        this.dropSelf(FABlocks.CORDAITES_HANGING_SIGN.get());
        this.dropSelf(FABlocks.CORDAITES_PRESSURE_PLATE.get());
        this.dropSelf(FABlocks.CORDAITES_FENCE.get());
        this.dropSelf(FABlocks.CORDAITES_TRAPDOOR.get());
        this.dropSelf(FABlocks.CORDAITES_FENCE_GATE.get());
        this.dropPottedContents(FABlocks.POTTED_CORDAITES_SAPLING.get());
        this.dropSelf(FABlocks.CORDAITES_BUTTON.get());
        this.add(FABlocks.CORDAITES_SLAB.get(), this::createSlabItemTable);
        this.dropSelf(FABlocks.WOLLEMIA_PLANKS.get());
        this.dropSelf(FABlocks.WOLLEMIA_SAPLING.get());
        this.dropSelf(FABlocks.WOLLEMIA_LOG.get());
        this.dropSelf(FABlocks.STRIPPED_WOLLEMIA_LOG.get());
        this.dropSelf(FABlocks.WOLLEMIA_WOOD.get());
        this.dropSelf(FABlocks.STRIPPED_WOLLEMIA_WOOD.get());
        this.add(FABlocks.WOLLEMIA_LEAVES.get(), block -> this.createLeavesDrops(block, FABlocks.WOLLEMIA_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        this.dropSelf(FABlocks.WOLLEMIA_STAIRS.get());
        this.dropSelf(FABlocks.WOLLEMIA_SIGN.get());
        this.add(FABlocks.WOLLEMIA_DOOR.get(), this::createDoorTable);
        this.dropSelf(FABlocks.WOLLEMIA_HANGING_SIGN.get());
        this.dropSelf(FABlocks.WOLLEMIA_PRESSURE_PLATE.get());
        this.dropSelf(FABlocks.WOLLEMIA_FENCE.get());
        this.dropSelf(FABlocks.WOLLEMIA_TRAPDOOR.get());
        this.dropSelf(FABlocks.WOLLEMIA_FENCE_GATE.get());
