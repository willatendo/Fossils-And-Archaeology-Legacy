...
public class FossilsLegacyBlockLootSubProvider extends SimpleBlockLootSubProvider {
    ...
    public void generate() {
        ...
        this.dropSelf(FossilsLegacyBlocks.IRON_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.COPPER_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.EXPOSED_COPPER_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.WEATHERED_COPPER_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.OXIDIZED_COPPER_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.WAXED_COPPER_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.WAXED_EXPOSED_COPPER_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.WAXED_WEATHERED_COPPER_LLAMA_STATUE.get());
        this.dropSelf(FossilsLegacyBlocks.WAXED_OXIDIZED_COPPER_LLAMA_STATUE.get());
