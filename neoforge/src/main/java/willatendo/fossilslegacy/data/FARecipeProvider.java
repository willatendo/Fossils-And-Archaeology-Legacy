...
public class FARecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        for (int i = 0; i < FABlockRegistry.woodSize(); i++) {
            this.woodType(FABlockRegistry.getLog(i).get(), FABlockRegistry.getStrippedLog(i).get(), FABlockRegistry.getWood(i).get(), FABlockRegistry.getStrippedWood(i).get(), FABlockRegistry.ITEM_LOG_TAGS[i], FABlockRegistry.getPlanks(i).get(), FABlockRegistry.getStairs(i).get(), FABlockRegistry.getSlab(i).get(), FABlockRegistry.getFence(i).get(), FABlockRegistry.getFenceGate(i).get(), FABlockRegistry.getDoor(i).get(), FABlockRegistry.getTrapdoor(i).get(), FABlockRegistry.getPressurePlate(i).get(), FABlockRegistry.getButton(i).get(), FAItemRegistry.getSign(i).get(), FAItemRegistry.getHangingSign(i).get(), FAItemRegistry.getBoat(i).get(), FAItemRegistry.getChestBoat(i).get());
        }
