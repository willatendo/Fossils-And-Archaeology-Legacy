...
public class FARecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        this.woodType(FABlocks.ARAUCARIOXYLON_LOG.get(), FABlocks.STRIPPED_ARAUCARIOXYLON_LOG.get(), FABlocks.ARAUCARIOXYLON_WOOD.get(), FABlocks.STRIPPED_ARAUCARIOXYLON_WOOD.get(), FAItemTags.ARAUCARIOXYLON_LOGS, FABlocks.ARAUCARIOXYLON_PLANKS.get(), FABlocks.ARAUCARIOXYLON_STAIRS.get(), FABlocks.ARAUCARIOXYLON_SLAB.get(), FABlocks.ARAUCARIOXYLON_FENCE.get(), FABlocks.ARAUCARIOXYLON_FENCE_GATE.get(), FABlocks.ARAUCARIOXYLON_DOOR.get(), FABlocks.ARAUCARIOXYLON_TRAPDOOR.get(), FABlocks.ARAUCARIOXYLON_PRESSURE_PLATE.get(), FABlocks.ARAUCARIOXYLON_BUTTON.get(), FAItems.ARAUCARIOXYLON_SIGN.get(), FAItems.ARAUCARIOXYLON_HANGING_SIGN.get(), FAItems.ARAUCARIOXYLON_BOAT.get(), FAItems.ARAUCARIOXYLON_CHEST_BOAT.get());
        this.woodType(FABlocks.CORDAITES_LOG.get(), FABlocks.STRIPPED_CORDAITES_LOG.get(), FABlocks.CORDAITES_WOOD.get(), FABlocks.STRIPPED_CORDAITES_WOOD.get(), FAItemTags.CORDAITES_LOGS, FABlocks.CORDAITES_PLANKS.get(), FABlocks.CORDAITES_STAIRS.get(), FABlocks.CORDAITES_SLAB.get(), FABlocks.CORDAITES_FENCE.get(), FABlocks.CORDAITES_FENCE_GATE.get(), FABlocks.CORDAITES_DOOR.get(), FABlocks.CORDAITES_TRAPDOOR.get(), FABlocks.CORDAITES_PRESSURE_PLATE.get(), FABlocks.CORDAITES_BUTTON.get(), FAItems.CORDAITES_SIGN.get(), FAItems.CORDAITES_HANGING_SIGN.get(), FAItems.CORDAITES_BOAT.get(), FAItems.CORDAITES_CHEST_BOAT.get());
        this.woodType(FABlocks.ARAUCARIA_LOG.get(), FABlocks.STRIPPED_WOLLEMIA_LOG.get(), FABlocks.WOLLEMIA_WOOD.get(), FABlocks.STRIPPED_WOLLEMIA_WOOD.get(), FAItemTags.WOLLEMIA_LOGS, FABlocks.WOLLEMIA_PLANKS.get(), FABlocks.WOLLEMIA_STAIRS.get(), FABlocks.WOLLEMIA_SLAB.get(), FABlocks.WOLLEMIA_FENCE.get(), FABlocks.WOLLEMIA_FENCE_GATE.get(), FABlocks.WOLLEMIA_DOOR.get(), FABlocks.WOLLEMIA_TRAPDOOR.get(), FABlocks.WOLLEMIA_PRESSURE_PLATE.get(), FABlocks.WOLLEMIA_BUTTON.get(), FAItems.WOLLEMIA_SIGN.get(), FAItems.WOLLEMIA_HANGING_SIGN.get(), FAItems.WOLLEMIA_BOAT.get(), FAItems.WOLLEMIA_CHEST_BOAT.get());
        ...
        this.cultivate(CultivationBookCategory.PLANT, FAItems.CYCADEOIDEA_DNA.get(), FAItems.CYCADEOIDEA_SEED.get(), 6000);
        this.cultivate(CultivationBookCategory.PLANT, FAItems.CLAYTOSMUNDA_DNA.get(), FAItems.CLAYTOSMUNDA_SPORES.get(), 6000);
