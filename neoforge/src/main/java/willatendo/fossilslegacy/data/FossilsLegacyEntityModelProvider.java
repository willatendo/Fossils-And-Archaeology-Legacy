...
public class FossilsLegacyEntityModelProvider extends EntityModelProvider {
    ...
    protected void getAll() {
        ...
        this.add(EntityModelHolder.builder(this.mod("legacy_dilophosaurus"), DilophosaurusModels.createLegacyDilophosaurusBodyLayer()).withBuiltInAnimation("walk", BuiltInAnimationTypes.DILOPHOSAURUS_WALK).build());
        ...
        this.add(EntityModelHolder.builder(this.mod("legacy_mosasaurus"), MosasaurusModels.createLegacyMosausarusBodyLayer()).withBuiltInAnimation("walk", BuiltInAnimationTypes.MOSASAURUS_SWIM).withBuiltInAnimation("swim", BuiltInAnimationTypes.MOSASAURUS_SWIM).build());
        ...
        this.add(EntityModelHolder.builder(this.mod("legacy_stegosaurus"), StegosaurusModels.createLegacyStegosaurusBodyLayer()).withBuiltInAnimation("walk", BuiltInAnimationTypes.STEGOSAURUS_WALK).build());
        this.add(EntityModelHolder.builder(this.mod("legacy_therizinosaurus"), TherizinosaurusModels.createLegacyTherizinosaurusBodyLayer()).withBuiltInAnimation("walk", BuiltInAnimationTypes.THERIZINOSAURUS_WALK).build());
        ...
        this.add(EntityModelHolder.builder(this.mod("legacy_tyrannosaurus"), TyrannosaurusModels.createLegacyTyrannosaurusBodyLayer()).withBuiltInAnimation("walk", BuiltInAnimationTypes.TYRANNOSAURUS_WALK).withBuiltInAnimation("head", BuiltInAnimationTypes.TYRANNOSAURUS_HEAD).build());
        ...
        this.add(EntityModelHolder.builder(this.mod("legacy_velociraptor"), VelociraptorModels.createLegacyVelociraptorBodyLayer()).withBuiltInAnimation("walk", BuiltInAnimationTypes.LEGACY_VELOCIRAPTOR_WALK).build());
        ...
        this.add(EntityModelHolder.builder(this.mod("smilodon"), SmilodonModels.createSmilodonBodyLayer()).withAnimation("walk", this.mod("smilodon_walk")).withHeadPeices("neck").build());
        this.add(EntityModelHolder.builder(this.mod("legacy_smilodon"), SmilodonModels.createLegacySmilodonBodyLayer()).withBuiltInAnimation("walk", BuiltInAnimationTypes.LEGACY_SMILODON_WALK).withBuiltInAnimation("sit", BuiltInAnimationTypes.LEGACY_SMILODON_SIT).withBuiltInAnimation("shake", BuiltInAnimationTypes.LEGACY_SMILODON_SHAKE).withBuiltInAnimation("tail", BuiltInAnimationTypes.LEGACY_SMILODON_TAIL).build());
