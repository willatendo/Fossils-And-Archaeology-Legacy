...
public class FossilsLegacyEntityModelProvider extends EntityModelProvider {
    ...
    protected void getAll() {
        ...
        this.add(EntityModelHolder.builder(this.mod("mosasaurus"), MosasaurusModels.createMosasaurusBodyLayer()).withAnimation("walk", this.mod("mosasaurus_walk")).withAnimation("swim", this.mod("mosasaurus_swim")).build());
