...
public class FossilsLegacyEntityModelProvider extends EntityModelProvider {
    ...
    protected void getAll() {
        ...
        this.add(EntityModelHolder.builder(this.mod("pteranodon"), PteranodonModel.createBodyLayer()).withAnimation("walk", this.mod("pteranodon_walk")).withAnimation("fly", this.mod("pteranodon_fly"), BuiltInAnimationTypes.PTERANODON_BODY_FLY.getId()).withAnimation("land", this.mod("pteranodon_land")).withHeadPeices("head").build());
