...
public class FossilsLegacyBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(Provider provider) {
        this.tag(BlockTags.PLANKS).add(FossilsLegacyBlocks.LEPIDODENDRON_PLANKS.get());
        this.tag(BlockTags.WOODEN_BUTTONS).add(FossilsLegacyBlocks.LEPIDODENDRON_BUTTON.get());
        this.tag(BlockTags.WOODEN_DOORS).add(FossilsLegacyBlocks.LEPIDODENDRON_DOOR.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(FossilsLegacyBlocks.LEPIDODENDRON_STAIRS.get());
        this.tag(BlockTags.WOODEN_SLABS).add(FossilsLegacyBlocks.LEPIDODENDRON_SLAB.get());
        this.tag(BlockTags.WOODEN_FENCES).add(FossilsLegacyBlocks.LEPIDODENDRON_FENCE.get());
        this.tag(BlockTags.SAPLINGS).add(FossilsLegacyBlocks.LEPIDODENDRON_SAPLING.get());
        this.tag(BlockTags.LOGS_THAT_BURN).addTags(FossilsLegacyBlockTags.LEPIDODENDRON_LOGS);
        this.tag(BlockTags.OVERWORLD_NATURAL_LOGS).addTags(FossilsLegacyBlockTags.LEPIDODENDRON_LOGS);
        this.tag(BlockTags.FLOWER_POTS).add(FossilsLegacyBlocks.POTTED_LEPIDODENDRON_SAPLING.get());
        this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(FossilsLegacyBlocks.LEPIDODENDRON_PRESSURE_PLATE.get());
        this.tag(BlockTags.LEAVES).add(FossilsLegacyBlocks.LEPIDODENDRON_LEAVES.get());
        this.tag(BlockTags.WOODEN_TRAPDOORS).add(FossilsLegacyBlocks.LEPIDODENDRON_TRAPDOOR.get());
        this.tag(BlockTags.STANDING_SIGNS).add(FossilsLegacyBlocks.LEPIDODENDRON_SIGN.get());
        this.tag(BlockTags.WALL_SIGNS).add(FossilsLegacyBlocks.LEPIDODENDRON_WALL_SIGN.get());
        this.tag(BlockTags.CEILING_HANGING_SIGNS).add(FossilsLegacyBlocks.LEPIDODENDRON_HANGING_SIGN.get());
        this.tag(BlockTags.WALL_HANGING_SIGNS).add(FossilsLegacyBlocks.LEPIDODENDRON_WALL_HANGING_SIGN.get());
        this.tag(BlockTags.FENCE_GATES).add(FossilsLegacyBlocks.LEPIDODENDRON_FENCE_GATE.get());
