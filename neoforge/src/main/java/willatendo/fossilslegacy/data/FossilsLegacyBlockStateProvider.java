...
public class FossilsLegacyBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        this.getVariantBuilder(FossilsLegacyBlocks.JURASSIC_FERN.get())
                .partialState()
                .with(JurassicFernBlock.GROWTH, 0)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.LOWER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_lower_0", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_lower_0")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_lower_0"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 1)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.LOWER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_lower_1",this.modLoc("block/template_colored_crop")).texture("crop",  this.modLoc("block/jurassic_fern_colored_lower_1")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_lower_1"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 2)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.LOWER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_lower_2", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_lower_2")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_lower_2"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 3)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.LOWER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_lower_3", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_lower_3")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_lower_3"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 4)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.LOWER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_lower_4", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_lower_4")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_lower_4"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 5)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.LOWER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_lower_5", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_lower_5")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_lower_5"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 0)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.UPPER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_upper_0", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_upper_4")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_upper_4"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 1)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.UPPER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_upper_1",this.modLoc("block/template_colored_crop")).texture("crop",  this.modLoc("block/jurassic_fern_colored_upper_4")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_upper_4"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 2)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.UPPER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_upper_2",this.modLoc("block/template_colored_crop")).texture("crop",  this.modLoc("block/jurassic_fern_colored_upper_4")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_upper_4"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 3)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.UPPER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_upper_3",this.modLoc("block/template_colored_crop")).texture("crop",  this.modLoc("block/jurassic_fern_colored_upper_4")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_upper_4"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 4)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.UPPER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_upper_4", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_upper_4")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_lower_0"))
                        .renderType(this.mcLoc("cutout"))))
                .partialState()
                .with(JurassicFernBlock.GROWTH, 5)
                .with(JurassicFernBlock.HALF, DoubleBlockHalf.UPPER)
                .addModels(new ConfiguredModel(this.models().withExistingParent("jurassic_fern_upper_5", this.modLoc("block/template_colored_crop")).texture("crop", this.modLoc("block/jurassic_fern_colored_upper_5")).texture("crop_leaves", this.modLoc("block/jurassic_fern_leaves_upper_5"))
                        .renderType(this.mcLoc("cutout"))));
