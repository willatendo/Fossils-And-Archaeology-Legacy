...
public class FossilsLegacyBlockStateProvider extends SimpleBlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        this.horizontalBlock(FossilsLegacyBlocks.SKULL_LANTERN_BLOCK.get(), blockState -> this.models().cube("skull_lanturn_block", this.modLoc("block/skull"), this.modLoc("block/skull"), this.modLoc("block/skull_lanturn_front"), this.modLoc("block/skull_crack"), this.modLoc("block/skull_crack"), this.modLoc("block/skull_crack")).texture("particle", this.modLoc("block/skull_crack")));
