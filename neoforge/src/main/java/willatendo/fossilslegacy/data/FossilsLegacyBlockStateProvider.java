...
public class FossilsLegacyBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        this.horizontalBlock(FossilsLegacyBlocks.GENE_MODIFIER.get(), blockState -> blockState.getValue(GeneModifierBlock.ACTIVE) ? this.models().withExistingParent("gene_modifier", this.modLoc("template_gene_modifier")).texture("front", this.modLoc("block/gene_modifier_front_on")) : this.models().withExistingParent("gene_modifier", this.modLoc("template_gene_modifier")).texture("front", this.modLoc("block/gene_modifier_front_off")));
