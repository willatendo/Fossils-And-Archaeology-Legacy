...
public class FossilsLegacyDataMapProvider extends DataMapProvider {
    ...
    protected void gather() {
        this.builder(NeoForgeDataMaps.COMPOSTABLES).add(FossilsLegacyBlocks.JURASSIC_FERN.get().asItem().builtInRegistryHolder(), new Compostable(0.65F), false).add(FossilsLegacyItems.JURASSIC_FERN_SPORES.get().builtInRegistryHolder(), new Compostable(0.65F), false).add(FossilsLegacyBlocks.LEPIDODENDRON_LEAVES.get().asItem().builtInRegistryHolder(), new Compostable(0.3F), false).add(FossilsLegacyBlocks.LEPIDODENDRON_SAPLING.get().asItem().builtInRegistryHolder(), new Compostable(0.3F), false)
                .add(FossilsLegacyBlocks.SIGILLARIA_LEAVES.get().asItem().builtInRegistryHolder(), new Compostable(0.3F), false).add(FossilsLegacyBlocks.SIGILLARIA_SAPLING.get().asItem().builtInRegistryHolder(), new Compostable(0.3F), false)
                .add(FossilsLegacyBlocks.CALAMITES_LEAVES.get().asItem().builtInRegistryHolder(), new Compostable(0.3F), false).add(FossilsLegacyBlocks.CALAMITES_SAPLING.get().asItem().builtInRegistryHolder(), new Compostable(0.3F), false);
    }
}
