...
public class FAItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags(Provider provider) {
        this.tag(ItemTags.PLANKS).add(FAItems.ARCHAEOPTERIS_PLANKS, FAItems.LEPIDODENDRON_PLANKS, FAItems.SIGILLARIA_PLANKS, FAItems.CALAMITES_PLANKS, FAItems.GINKGO_PLANKS);
        this.tag(ItemTags.WOODEN_BUTTONS).add(FAItems.ARCHAEOPTERIS_BUTTON, FAItems.LEPIDODENDRON_BUTTON, FAItems.SIGILLARIA_BUTTON, FAItems.CALAMITES_BUTTON, FAItems.GINKGO_BUTTON);
        this.tag(ItemTags.WOODEN_DOORS).add(FAItems.ARCHAEOPTERIS_DOOR.get(), FAItems.LEPIDODENDRON_DOOR.get(), FAItems.SIGILLARIA_DOOR.get(), FAItems.CALAMITES_DOOR.get(), FAItems.GINKGO_DOOR.get());
        this.tag(ItemTags.WOODEN_STAIRS).add(FAItems.ARCHAEOPTERIS_STAIRS, FAItems.LEPIDODENDRON_STAIRS, FAItems.SIGILLARIA_STAIRS, FAItems.CALAMITES_STAIRS, FAItems.GINKGO_STAIRS);
        this.tag(ItemTags.WOODEN_SLABS).add(FAItems.ARCHAEOPTERIS_SLAB, FAItems.LEPIDODENDRON_SLAB, FAItems.SIGILLARIA_SLAB, FAItems.CALAMITES_SLAB, FAItems.GINKGO_SLAB);
        this.tag(ItemTags.WOODEN_FENCES).add(FAItems.ARCHAEOPTERIS_FENCE, FAItems.LEPIDODENDRON_FENCE, FAItems.SIGILLARIA_FENCE, FAItems.CALAMITES_FENCE, FAItems.GINKGO_FENCE);
        this.tag(Tags.Items.FENCE_GATES_WOODEN).add(FAItems.ARCHAEOPTERIS_FENCE_GATE, FAItems.LEPIDODENDRON_FENCE_GATE, FAItems.SIGILLARIA_FENCE_GATE, FAItems.CALAMITES_FENCE_GATE, FAItems.GINKGO_FENCE_GATE);
        this.tag(ItemTags.SAPLINGS).add(FAItems.ARCHAEOPTERIS_SAPLING, FAItems.LEPIDODENDRON_SAPLING, FAItems.SIGILLARIA_SAPLING, FAItems.CALAMITES_SAPLING, FAItems.GINKGO_SAPLING);
        this.tag(ItemTags.LOGS_THAT_BURN).addTags(FAItemTags.ARCHAEOPTERIS_LOGS, FAItemTags.LEPIDODENDRON_LOGS, FAItemTags.SIGILLARIA_LOGS, FAItemTags.CALAMITES_LOGS, FAItemTags.GINKGO_LOGS);
        this.tag(ItemTags.WOODEN_PRESSURE_PLATES).add(FAItems.ARCHAEOPTERIS_PRESSURE_PLATE, FAItems.LEPIDODENDRON_PRESSURE_PLATE, FAItems.SIGILLARIA_PRESSURE_PLATE, FAItems.CALAMITES_PRESSURE_PLATE, FAItems.GINKGO_PRESSURE_PLATE);
        this.tag(ItemTags.LEAVES).add(FAItems.ARCHAEOPTERIS_LEAVES, FAItems.LEPIDODENDRON_LEAVES, FAItems.SIGILLARIA_LEAVES, FAItems.CALAMITES_LEAVES, FAItems.GINKGO_LEAVES);
        this.tag(ItemTags.WOODEN_TRAPDOORS).add(FAItems.ARCHAEOPTERIS_TRAPDOOR, FAItems.LEPIDODENDRON_TRAPDOOR, FAItems.SIGILLARIA_TRAPDOOR, FAItems.CALAMITES_TRAPDOOR, FAItems.GINKGO_TRAPDOOR);
        this.tag(ItemTags.SIGNS).add(FAItems.ARCHAEOPTERIS_SIGN.get(), FAItems.LEPIDODENDRON_SIGN.get(), FAItems.SIGILLARIA_SIGN.get(), FAItems.CALAMITES_SIGN.get(), FAItems.GINKGO_SIGN.get());
        this.tag(ItemTags.HANGING_SIGNS).add(FAItems.ARCHAEOPTERIS_HANGING_SIGN.get(), FAItems.LEPIDODENDRON_HANGING_SIGN.get(), FAItems.SIGILLARIA_HANGING_SIGN.get(), FAItems.CALAMITES_HANGING_SIGN.get(), FAItems.GINKGO_HANGING_SIGN.get());
        this.tag(ItemTags.FENCE_GATES).add(FAItems.ARCHAEOPTERIS_FENCE_GATE, FAItems.LEPIDODENDRON_FENCE_GATE, FAItems.SIGILLARIA_FENCE_GATE, FAItems.CALAMITES_FENCE_GATE, FAItems.GINKGO_FENCE_GATE);
        this.tag(ItemTags.BOATS).add(FAItems.ARCHAEOPTERIS_BOAT.get(), FAItems.ARCHAEOPTERIS_CHEST_BOAT.get(), FAItems.LEPIDODENDRON_BOAT.get(), FAItems.LEPIDODENDRON_CHEST_BOAT.get(), FAItems.SIGILLARIA_BOAT.get(), FAItems.SIGILLARIA_CHEST_BOAT.get(), FAItems.CALAMITES_BOAT.get(), FAItems.CALAMITES_CHEST_BOAT.get(), FAItems.GINKGO_BOAT.get(), FAItems.GINKGO_CHEST_BOAT.get());
        ...
        this.tag(Tags.Items.SEEDS).add(FAItems.ARCHAEOPTERIS_SPORE.get(), FAItems.CALAMITES_SPORE.get(), FAItems.CYCAD_CONE.get(), FAItems.GINKGO_SPORE.get(), FAItems.HORSETAIL_SPORE.get(), FAItems.JURASSIC_FERN_SPORES.get(), FAItems.SIGILLARIA_SPORE.get());
        ...
        this.tag(Tags.Items.BONES).add(FAItems.MESOZOIC_FOSSIL.get(), FAItems.PLANT_FOSSIL.get());
        ...
        this.tag(FAItemTags.HERBIVORE_FOODS).add(Items.APPLE, Items.WHEAT, Items.BREAD, Items.SUGAR_CANE, Items.WHEAT_SEEDS, Items.BEETROOT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.MELON_SLICE, Items.SWEET_BERRIES, Items.GLOW_BERRIES, Items.CARROT, Items.POTATO, Items.BAKED_POTATO, Items.BEETROOT, Items.KELP, FAItems.JURASSIC_FERN_SPORES.get(), FAItems.ARCHAEOPTERIS_SPORE.get(), FAItems.CALAMITES_SPORE.get(), FAItems.CYCAD_CONE.get(), FAItems.GINKGO_SPORE.get(), FAItems.HORSETAIL_SPORE.get(), FAItems.SIGILLARIA_SPORE.get());
        ...
        this.tag(FAItemTags.PLANT_DNA).add(FAItems.ARCHAEOPTERIS_DNA.get(), FAItems.CALAMITES_DNA.get(), FAItems.CYCAD_DNA.get(), FAItems.GINKGO_DNA.get(), FAItems.HORSETAIL_DNA.get(), FAItems.JURASSIC_FERN_DNA.get(), FAItems.LEPIDODENDRON_DNA.get(), FAItems.SIGILLARIA_DNA.get());
