...
public abstract class DataDrivenTagsProvider<T> implements DataProvider {
    ...
    public DataDrivenTagsProvider(PackOutput packOutput, ResourceKey<? extends Registry<T>> registryKey, CompletableFuture<HolderLookup.Provider> registries, String modId, ExistingFileHelper existingFileHelper) {
        this(packOutput, registryKey, registries, CompletableFuture.completedFuture(TagsProvider.TagLookup.empty()), modId, existingFileHelper);
    }

    public DataDrivenTagsProvider(PackOutput packOutput, ResourceKey<? extends Registry<T>> registryKey, CompletableFuture<HolderLookup.Provider> registries, CompletableFuture<TagsProvider.TagLookup<T>> parentProvider, String modId, @Nullable ExistingFileHelper existingFileHelper) {
