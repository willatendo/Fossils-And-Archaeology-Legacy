...
public class FABlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(Provider provider) {
        this.tag(BlockTags.PLANKS).add(FABlocks.ARCHAEOPTERIS_PLANKS.get(), FABlocks.LEPIDODENDRON_PLANKS.get(), FABlocks.SIGILLARIA_PLANKS.get(), FABlocks.CALAMITES_PLANKS.get(), FABlocks.GINKGO_PLANKS.get());
        this.tag(BlockTags.WOODEN_BUTTONS).add(FABlocks.ARCHAEOPTERIS_BUTTON.get(), FABlocks.LEPIDODENDRON_BUTTON.get(), FABlocks.SIGILLARIA_BUTTON.get(), FABlocks.CALAMITES_BUTTON.get(), FABlocks.GINKGO_BUTTON.get());
        this.tag(BlockTags.WOODEN_DOORS).add(FABlocks.ARCHAEOPTERIS_DOOR.get(), FABlocks.LEPIDODENDRON_DOOR.get(), FABlocks.SIGILLARIA_DOOR.get(), FABlocks.CALAMITES_DOOR.get(), FABlocks.GINKGO_DOOR.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(FABlocks.ARCHAEOPTERIS_STAIRS.get(), FABlocks.LEPIDODENDRON_STAIRS.get(), FABlocks.SIGILLARIA_STAIRS.get(), FABlocks.CALAMITES_STAIRS.get(), FABlocks.GINKGO_STAIRS.get());
        this.tag(BlockTags.WOODEN_SLABS).add(FABlocks.ARCHAEOPTERIS_SLAB.get(), FABlocks.LEPIDODENDRON_SLAB.get(), FABlocks.SIGILLARIA_SLAB.get(), FABlocks.CALAMITES_SLAB.get(), FABlocks.GINKGO_SLAB.get());
        this.tag(BlockTags.WOODEN_FENCES).add(FABlocks.ARCHAEOPTERIS_FENCE.get(), FABlocks.LEPIDODENDRON_FENCE.get(), FABlocks.SIGILLARIA_FENCE.get(), FABlocks.CALAMITES_FENCE.get(), FABlocks.GINKGO_FENCE.get());
        this.tag(BlockTags.SAPLINGS).add(FABlocks.ARCHAEOPTERIS_SAPLING.get(), FABlocks.LEPIDODENDRON_SAPLING.get(), FABlocks.SIGILLARIA_SAPLING.get(), FABlocks.CALAMITES_SAPLING.get(), FABlocks.GINKGO_SAPLING.get());
        this.tag(BlockTags.LOGS_THAT_BURN).addTags(FABlockTags.ARCHAEOPTERIS_LOGS, FABlockTags.LEPIDODENDRON_LOGS, FABlockTags.SIGILLARIA_LOGS, FABlockTags.CALAMITES_LOGS, FABlockTags.GINKGO_LOGS);
        this.tag(BlockTags.OVERWORLD_NATURAL_LOGS).addTags(FABlockTags.ARCHAEOPTERIS_LOGS, FABlockTags.LEPIDODENDRON_LOGS, FABlockTags.SIGILLARIA_LOGS, FABlockTags.CALAMITES_LOGS, FABlockTags.GINKGO_LOGS);
        this.tag(BlockTags.FLOWER_POTS).add(FABlocks.POTTED_ARCHAEOPTERIS_SAPLING.get(), FABlocks.POTTED_LEPIDODENDRON_SAPLING.get(), FABlocks.POTTED_SIGILLARIA_SAPLING.get(), FABlocks.POTTED_CALAMITES_SAPLING.get(), FABlocks.POTTED_GINKGO_SAPLING.get());
        this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(FABlocks.ARCHAEOPTERIS_PRESSURE_PLATE.get(), FABlocks.LEPIDODENDRON_PRESSURE_PLATE.get(), FABlocks.SIGILLARIA_PRESSURE_PLATE.get(), FABlocks.CALAMITES_PRESSURE_PLATE.get(), FABlocks.GINKGO_PRESSURE_PLATE.get());
        this.tag(BlockTags.LEAVES).add(FABlocks.ARCHAEOPTERIS_LEAVES.get(), FABlocks.LEPIDODENDRON_LEAVES.get(), FABlocks.SIGILLARIA_LEAVES.get(), FABlocks.CALAMITES_LEAVES.get(), FABlocks.GINKGO_LEAVES.get());
        this.tag(BlockTags.WOODEN_TRAPDOORS).add(FABlocks.ARCHAEOPTERIS_TRAPDOOR.get(), FABlocks.LEPIDODENDRON_TRAPDOOR.get(), FABlocks.SIGILLARIA_TRAPDOOR.get(), FABlocks.CALAMITES_TRAPDOOR.get(), FABlocks.GINKGO_TRAPDOOR.get());
        this.tag(BlockTags.STANDING_SIGNS).add(FABlocks.ARCHAEOPTERIS_SIGN.get(), FABlocks.LEPIDODENDRON_SIGN.get(), FABlocks.SIGILLARIA_SIGN.get(), FABlocks.CALAMITES_SIGN.get(), FABlocks.GINKGO_SIGN.get());
        this.tag(BlockTags.WALL_SIGNS).add(FABlocks.ARCHAEOPTERIS_WALL_SIGN.get(), FABlocks.LEPIDODENDRON_WALL_SIGN.get(), FABlocks.SIGILLARIA_WALL_SIGN.get(), FABlocks.CALAMITES_WALL_SIGN.get(), FABlocks.GINKGO_WALL_SIGN.get());
        this.tag(BlockTags.CEILING_HANGING_SIGNS).add(FABlocks.ARCHAEOPTERIS_HANGING_SIGN.get(), FABlocks.LEPIDODENDRON_HANGING_SIGN.get(), FABlocks.SIGILLARIA_HANGING_SIGN.get(), FABlocks.CALAMITES_HANGING_SIGN.get(), FABlocks.GINKGO_HANGING_SIGN.get());
        this.tag(BlockTags.WALL_HANGING_SIGNS).add(FABlocks.ARCHAEOPTERIS_WALL_HANGING_SIGN.get(), FABlocks.LEPIDODENDRON_WALL_HANGING_SIGN.get(), FABlocks.SIGILLARIA_WALL_HANGING_SIGN.get(), FABlocks.CALAMITES_WALL_HANGING_SIGN.get(), FABlocks.GINKGO_WALL_HANGING_SIGN.get());
        this.tag(BlockTags.FENCE_GATES).add(FABlocks.ARCHAEOPTERIS_FENCE_GATE.get(), FABlocks.LEPIDODENDRON_FENCE_GATE.get(), FABlocks.SIGILLARIA_FENCE_GATE.get(), FABlocks.CALAMITES_FENCE_GATE.get(), FABlocks.GINKGO_FENCE_GATE.get());
