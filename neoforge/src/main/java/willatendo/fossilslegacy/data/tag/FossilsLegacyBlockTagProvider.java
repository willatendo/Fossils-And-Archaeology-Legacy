...
public class FossilsLegacyBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(Provider provider) {
        ...
        this.tag(FossilsLegacyBlockTags.CARNOTAURUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.COMPSOGNATHUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.CRYOLOPHOSAURUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.DILOPHOSAURUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.DIMETRODON_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.DODO_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        ...
        this.tag(FossilsLegacyBlockTags.GALLIMIMUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON).add(Blocks.SAND);
        ...
        this.tag(FossilsLegacyBlockTags.MAMMOTH_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.MOA_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.PACHYCEPHALOSAURUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.PERMAFROST_FROSTABLE).add(Blocks.STONE, Blocks.GRANITE, Blocks.ANDESITE, Blocks.DIORITE);
        this.tag(FossilsLegacyBlockTags.PTERANODON_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.SMILODON_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        ...
        this.tag(FossilsLegacyBlockTags.SPINOSAURUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        ...
        this.tag(FossilsLegacyBlockTags.STEGOSAURUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.THERIZINOSAURUS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON);
        this.tag(FossilsLegacyBlockTags.TRICERATOPS_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON).add(Blocks.SAND);
        ...
        this.tag(FossilsLegacyBlockTags.VELOCIRAPTOR_SPAWNABLE).addTags(BlockTags.ANIMALS_SPAWNABLE_ON).add(Blocks.SAND);
    }
}
