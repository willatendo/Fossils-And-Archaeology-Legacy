...
public class FALanguageProvider extends SimpleLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(FABlocks.PLANT_FOSSIL_ORE.get());
        this.add(FABlocks.DEEPSLATE_PLANT_FOSSIL_ORE.get());
        ...
        this.add(FABlocks.SALVINIA.get());
        this.add(FABlocks.LOTUS.get());
        this.add(FABlocks.SARCANDRA.get());
        for (int i = 0; i < FABlockRegistry.woodSize(); i++) {
            this.add(FABlockRegistry.getPlanks(i).get());
            this.add(FABlockRegistry.getSapling(i).get());
            this.add(FABlockRegistry.getLog(i).get());
            this.add(FABlockRegistry.getStrippedLog(i).get());
            this.add(FABlockRegistry.getWood(i).get());
            this.add(FABlockRegistry.getStrippedWood(i).get());
            this.add(FABlockRegistry.getLeaves(i).get());
            this.add(FABlockRegistry.getStairs(i).get());
            this.add(FABlockRegistry.getSign(i).get());
            this.add(FABlockRegistry.getDoor(i).get());
            this.add(FABlockRegistry.getHangingSign(i).get());
            this.add(FABlockRegistry.getPressurePlate(i).get());
            this.add(FABlockRegistry.getFence(i).get());
            this.add(FABlockRegistry.getTrapdoor(i).get());
            this.add(FABlockRegistry.getFenceGate(i).get());
        ...
        // Coat Types
        this.addModelType(FAModelGenes.ANKYLOSAURUS, "Ankylosaurus (2024)");
        this.addModelType(FAModelGenes.BARYONYX, "Baryonyx (2025)");
        this.addModelType(FAModelGenes.BRACHIOSAURUS, "Brachiosaurus (2024)");
        this.addModelType(FAModelGenes.CARNOTAURUS, "Carnotaurus (2024)");
        this.addModelType(FAModelGenes.COMPSOGNATHUS, "Compsognathus (2024)");
        this.addModelType(FAModelGenes.CRYOLOPHOSAURUS, "Cryolophosaurus (2024)");
        this.addModelType(FAModelGenes.DILOPHOSAURUS, "Dilophosaurus (2024)");
        this.addModelType(FAModelGenes.DODO, "Dodo (2024)");
        this.addModelType(FAModelGenes.DRYOSAURUS, "Dryosaurus (2025)");
        this.addModelType(FAModelGenes.ELASMOTHERIUM, "Elasmotherium (2025)");
        this.addModelType(FAModelGenes.FUTABASAURUS, "Futabasaurus (2024)");
        this.addModelType(FAModelGenes.GALLIMIMUS, "Gallimimus (2024)");
        this.addModelType(FAModelGenes.ICHTHYOSAURUS, "Ichthyosaurus (2025)");
        this.addModelType(FAModelGenes.MOA, "Moa (2024)");
        this.addModelType(FAModelGenes.MAMMOTH, "Mammoth (2024)");
        this.addModelType(FAModelGenes.MOSASAURUS, "Mosasaurus (2024)");
        this.addModelType(FAModelGenes.PACHYCEPHALOSAURUS, "Pachycephalosaurus (2024)");
        this.addModelType(FAModelGenes.PTERANODON, "Pteranodon (2024)");
        this.addModelType(FAModelGenes.SMILODON, "Smilodon 2024)");
        this.addModelType(FAModelGenes.SPINOSAURUS, "Spinosaurus (2024)");
        this.addModelType(FAModelGenes.STEGOSAURUS, "Stegosaurus (2024)");
        this.addModelType(FAModelGenes.THERIZINOSAURUS, "Therizinosaurus (2024)");
        this.addModelType(FAModelGenes.TRICERATOPS, "Triceratops (2024)");
        this.addModelType(FAModelGenes.TYRANNOSAURUS, "Tyrannosaurus (2024)");
        this.addModelType(FAModelGenes.VELOCIRAPTOR, "Velociraptor (2024)");

        this.addModelType(FAModelGenes.LEGACY_BRACHIOSAURUS, "Brachiosaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_CARNOTAURUS, "Carnotaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_CRYOLOPHOSAURUS, "Cryolophosaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_DILOPHOSAURUS, "Dilophosaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_FUTABASAURUS, "Futabasaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_MAMMOTH, "Mammoth (2011)");
        this.addModelType(FAModelGenes.LEGACY_MOSASAURUS, "Mosasaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_PTERANODON, "Pteranodon (2011)");
        this.addModelType(FAModelGenes.LEGACY_SMILODON, "Smilodon (2011)");
        this.addModelType(FAModelGenes.LEGACY_STEGOSAURUS, "Stegosaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_THERIZINOSAURUS, "Therizinosaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_TRICERATOPS, "Triceratops (2011)");
        this.addModelType(FAModelGenes.LEGACY_TYRANNOSAURUS, "Tyrannosaurus (2011)");
        this.addModelType(FAModelGenes.LEGACY_VELOCIRAPTOR, "Velociraptor (2011)");
        ...
        this.add(FAEntityTypes.CORDAITES_BOAT.get(), "Cordaites Boat");
        this.add(FAEntityTypes.CORDAITES_CHEST_BOAT.get(), "Cordaites Boat with Chest");
        ...
        this.add(FAEntityTypes.METASEQUOIA_BOAT.get(), "Metasequoia Boat");
        this.add(FAEntityTypes.METASEQUOIA_CHEST_BOAT.get(), "Metasequoia Boat with Chest");
        ...
        this.addFossilVariant(FAFossilVariants.DODO, "Dodo");
        this.addFossilVariant(FAFossilVariants.DRYOSAURUS, "Dryosaurus");
        this.addFossilVariant(FAFossilVariants.ELASMOTHERIUM, "Elasmotherium");
        ...
        this.addFossilVariant(FAFossilVariants.ISOTELUS, "Isotelus");
        this.addFossilVariant(FAFossilVariants.MAMMOTH, "Mammoth");
        this.addFossilVariant(FAFossilVariants.MOA, "Moa");
        ...
        this.add(FAItems.CYCAD_DNA.get(), "Cycad DNA");
        this.add(FAItems.CYCADEOIDEA_DNA.get(), "Cycadeoidea DNA");
        this.add(FAItems.CLAYTOSMUNDA_DNA.get(), "Claytosmunda DNA");
        this.add(FAItems.COOKSONIA_DNA.get(), "Cooksonia DNA");
        this.add(FAItems.HORSETAIL_DNA.get(), "Horsetail DNA");
        this.add(FAItems.JURASSIC_FERN_DNA.get(), "Jurassic Fern DNA");
        ...
        this.add(FAItems.CLAYTOSMUNDA_SPORES.get());
        this.add(FAItems.SARCANDRA_BERRIES.get());
        this.add(FAItems.CYCADEOIDEA_SEED.get());
        ...
        this.add("item.fossilslegacy.articulated_fossil.dodo", "Articulated Dodo Fossil");
        this.add("item.fossilslegacy.articulated_fossil.dryosaurus", "Articulated Dryosaurus Fossil");
        this.add("item.fossilslegacy.articulated_fossil.elasmotherium", "Articulated Elasmotherium Fossil");
        ...
        this.add("item.fossilslegacy.articulated_fossil.isotelus", "Articulated Isotelus Fossil");
        this.add("item.fossilslegacy.articulated_fossil.mammoth", "Articulated Mammoth Fossil");
        this.add("item.fossilslegacy.articulated_fossil.moa", "Articulated Moa Fossil");
        ...
        this.add("item.fossilslegacy.user_manual.drop.requirement.shears", "Shears");
        ...
        this.add("item.fossilslegacy.user_manual.information.amber_ore.description", "Amber in stone.");
        this.add("item.fossilslegacy.user_manual.information.amber_ore.use", "Can be found from y25-y-25.");
        ...
        this.add("item.fossilslegacy.user_manual.information.archaeology_workbench.use", "Used to repair and restore relics, as well as repair certain broken tools.");
        this.add("item.fossilslegacy.user_manual.information.articulated_fossil.description", "Bones from an ancient creature articulated in a statue.");
        this.add("item.fossilslegacy.user_manual.information.articulated_fossil.use", "Left-click to place, use a hammer to articulate the fossil further.");
        ...
        this.add("item.fossilslegacy.user_manual.information.boat.description", "Wooden boards en row in a boat-shape.");
        this.add("item.fossilslegacy.user_manual.information.boat.use", "Wooden planks that allow for water-travel with potential for a friend.");
        ...
        this.add("item.fossilslegacy.user_manual.information.button.description", "Wooden boards en row in button-shape.");
        this.add("item.fossilslegacy.user_manual.information.button.use", "Decorative block with activating capabilities.");
        ...
        this.add("item.fossilslegacy.user_manual.information.cenozoic_fossil_ore.description", "Cenozoic fossils in stone.");
        this.add("item.fossilslegacy.user_manual.information.cenozoic_fossil_ore.use", "Can be found from y128-y50 and under tar pits.");
        this.add("item.fossilslegacy.user_manual.information.chest_boat.description", "Wooden boards en row in a boat-shape with a chest.");
        this.add("item.fossilslegacy.user_manual.information.chest_boat.use", "Wooden planks that allow for water-travel with a chest's worth of items.");
        ...
        this.add("item.fossilslegacy.user_manual.information.cooked_berry_medley_bucket.description", "A bucket of cooked chicken in broth.");
        this.add("item.fossilslegacy.user_manual.information.cooked_berry_medley_bucket.use", "Used to make Chicken Essence and is a hearty meal.");
        this.add("item.fossilslegacy.user_manual.information.cooked_chicken_soup_bucket.description", "A bucket of cooked berries, meat, and vegetable.");
        this.add("item.fossilslegacy.user_manual.information.cooked_chicken_soup_bucket.use", "Used to make Romantic Concoction and can be eaten.");
        ...
        this.add("item.fossilslegacy.user_manual.information.cooksonia.description", "Early Plant.");
        this.add("item.fossilslegacy.user_manual.information.cooksonia.use", "Can plant up to four on a block.");
        ...
        this.add("item.fossilslegacy.user_manual.information.cycad_head.description", "Growing part.");
        this.add("item.fossilslegacy.user_manual.information.cycad_head.use", "Grows upwards and cones, which can be harvested by left-clicking with an axe. Can grow up to three cycad logs below.");
        this.add("item.fossilslegacy.user_manual.information.cycad_log.description", "Wood-like part of a cycad.");
        this.add("item.fossilslegacy.user_manual.information.cycad_log.use", "Has three thicknesses, going from thickest at the bottom of a cycad, to the thinnest at the top.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_amber_ore.description", "Amber in deepslate.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_amber_ore.use", "Can be found from y25-y-25.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_cenozoic_fossil_ore.description", "Cenozoic fossils in deepslate.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_cenozoic_fossil_ore.use", "Does not naturally generate, can be purchased from an palaeontologist villager.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_mesozoic_fossil_ore.description", "Mesozoic fossils in deepslate.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_mesozoic_fossil_ore.use", "Does not naturally generate, can be purchased from an palaeontologist villager.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_palaeozoic_fossil_ore.description", "Palaeozoic fossils in deepslate.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_palaeozoic_fossil_ore.use", "Can be found from y20-y0.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_plant_fossil_ore.description", "Plant fossils in deepslate.");
        this.add("item.fossilslegacy.user_manual.information.deepslate_plant_fossil_ore.use", "Can be found from y90-y-30.");
        this.add("item.fossilslegacy.user_manual.information.diamond_hammer.description", "A diamond tool.");
        this.add("item.fossilslegacy.user_manual.information.diamond_javelin.description", "A massive diamond arrow-like weapon.");
        this.add("item.fossilslegacy.user_manual.information.diamond_javelin.use", "Can wind up and throw like a trident.");
        ...
        this.add("item.fossilslegacy.user_manual.information.dna_analyzer.description", "A utility block.");
        this.add("item.fossilslegacy.user_manual.information.dna_analyzer.use", "Used to repair and restore broken artifacts.");
        ...
        this.add("item.fossilslegacy.user_manual.information.door.description", "Wooden door.");
        this.add("item.fossilslegacy.user_manual.information.door.use", "Decorative block with opening capabilities.");
        ...
        this.add("item.fossilslegacy.user_manual.information.fence.description", "Wooden boards en row in fence-shape.");
        this.add("item.fossilslegacy.user_manual.information.fence.use", "Decorative block with containing abilities.");
        this.add("item.fossilslegacy.user_manual.information.fence_gate.description", "Wooden boards en row in fence-gate-shape.");
        this.add("item.fossilslegacy.user_manual.information.fence_gate.use", "Decorative block with containing and opening capabilities.");
        ...
        this.add("item.fossilslegacy.user_manual.information.frozen_leech.description", "Leech in a block of ice, often from an iceburg.");
        this.add("item.fossilslegacy.user_manual.information.frozen_leech.use", "Can give water-animal DNA from many eras.");
        this.add("item.fossilslegacy.user_manual.information.golden_hammer.description", "A golden tool.");
        this.add("item.fossilslegacy.user_manual.information.golden_javelin.description", "A massive golden arrow-like weapon.");
        this.add("item.fossilslegacy.user_manual.information.golden_javelin.use", "Can wind up and throw like a trident.");
        ...
        this.add("item.fossilslegacy.user_manual.information.hanging_sign.description", "Wooden boards en row in sign-shape.");
        this.add("item.fossilslegacy.user_manual.information.hanging_sign.use", "Decorative block with text-displaying capabilities.");
        this.add("item.fossilslegacy.user_manual.information.iced_stone.description", "Frozen stone.");
        this.add("item.fossilslegacy.user_manual.information.iced_stone.use", "Is created when permafrost is mined.");
        ...
        this.add("item.fossilslegacy.user_manual.information.iron_javelin.description", "A massive iron arrow-like weapon.");
        this.add("item.fossilslegacy.user_manual.information.iron_javelin.use", "Can wind up and throw like a trident.");
        this.add("item.fossilslegacy.user_manual.information.iron_llama_statue.description", "A Mayan relic from the past, found in Mayan structures.");
        this.add("item.fossilslegacy.user_manual.information.iron_llama_statue.use", "A decorative iron llama.");
        ...
        this.add("item.fossilslegacy.user_manual.information.jurassic_fern.description", "A fern plant from the Jurassic.");
        this.add("item.fossilslegacy.user_manual.information.jurassic_fern.use", "Must be placed under leaves blocks. Spreads naturally.");
        this.add("item.fossilslegacy.user_manual.information.leaves.description", "The photosynthesising part of a plant.");
        this.add("item.fossilslegacy.user_manual.information.leaves.use", "Decorative block to top tree-like plants.");
        ...
        this.add("item.fossilslegacy.user_manual.information.leech_in_ice.use", "When broken, gives a frozen leech with prehistoric blood.");
        ...
        this.add("item.fossilslegacy.user_manual.information.log.description", "Woody stem of a plant.");
        this.add("item.fossilslegacy.user_manual.information.log.use", "Stem of a tree-like plant and decorative block.");
        ...
        this.add("item.fossilslegacy.user_manual.information.mayan_vase.description", "A decorated vase.");
        this.add("item.fossilslegacy.user_manual.information.mayan_vase.use", "Can store items. Acts like a decorated pot");
        this.add("item.fossilslegacy.user_manual.information.medium_cage.description", "A cage made for medium animals.");
        this.add("item.fossilslegacy.user_manual.information.medium_cage.use", "Left-click on a tranquilized creature to put it in the cage. Used for quick transportation.");
        ...
        this.add("item.fossilslegacy.user_manual.information.mesozoic_fossil_ore.description", "Mesozoic Fossils in stone.");
        this.add("item.fossilslegacy.user_manual.information.mesozoic_fossil_ore.use", "Can be found from y50-y20.");
        ...
        this.add("item.fossilslegacy.user_manual.information.netherite_javelin.description", "A massive netherite arrow-like weapon.");
        this.add("item.fossilslegacy.user_manual.information.netherite_javelin.use", "Can wind up and throw like a trident.");
        ...
        this.add("item.fossilslegacy.user_manual.information.palaeozoic_fossil_ore.description", "Palaeozoic fossils in stone.");
        this.add("item.fossilslegacy.user_manual.information.palaeozoic_fossil_ore.use", "Can be found from y20-y0.");
        this.add("item.fossilslegacy.user_manual.information.permafrost.description", "Frozen soil.");
        this.add("item.fossilslegacy.user_manual.information.permafrost.use", "Can be found from y256-y25.");
        ...
        this.add("item.fossilslegacy.user_manual.information.planks.description", "Wooden boards en row.");
        this.add("item.fossilslegacy.user_manual.information.planks.use", "Decorative block.");
        ...
        this.add("item.fossilslegacy.user_manual.information.plant_fossil_ore.description", "Plant fossils in stone.");
        this.add("item.fossilslegacy.user_manual.information.plant_fossil_ore.use", "Can be found from y90-y-30.");
        ...
        this.add("item.fossilslegacy.user_manual.information.pressure_plate.description", "Wooden boards en row in pressure-plate-shape.");
        this.add("item.fossilslegacy.user_manual.information.pressure_plate.use", "Decorative block with entity-detecting capabilities.");
        ...
        this.add("item.fossilslegacy.user_manual.information.raw_berry_medley_bucket.description", "Bucket of various berries, meat, and vegetables.");
        this.add("item.fossilslegacy.user_manual.information.raw_berry_medley_bucket.use", "Used to make Romantic Concoction.");
        this.add("item.fossilslegacy.user_manual.information.raw_chicken_soup_bucket.description", "A bucket of chicken in broth.");
        this.add("item.fossilslegacy.user_manual.information.raw_chicken_soup_bucket.use", "Used to make Chicken Essence.");
        ...
        this.add("item.fossilslegacy.user_manual.information.relic_in_deepslate.description", "Relic in deepslate.");
        this.add("item.fossilslegacy.user_manual.information.relic_in_deepslate.use", "Does not naturally generate, can be purchased from an palaeontologist villager.");
        this.add("item.fossilslegacy.user_manual.information.relic_in_stone.description", "Relic in stone.");
        this.add("item.fossilslegacy.user_manual.information.relic_in_stone.use", "Can be found from y256-y50.");
        ...
        this.add("item.fossilslegacy.user_manual.information.sapling.description", "A small tree.");
        this.add("item.fossilslegacy.user_manual.information.sapling.use", "Can grow into a full-sized tree or be placed in a flower pot.");
        ...
        this.add("item.fossilslegacy.user_manual.information.scarab_gem_javelin.description", "A massive wooden arrow-like weapon.");
        this.add("item.fossilslegacy.user_manual.information.scarab_gem_javelin.use", "Can wind up and throw like a trident. When it strikes an animal, it summons lightning");
        ...
        this.add("item.fossilslegacy.user_manual.information.short_horsetail.description", "A meter-tall horsetail.");
        this.add("item.fossilslegacy.user_manual.information.short_horsetail.use", "Can place up to three on a block.");
        this.add("item.fossilslegacy.user_manual.information.sign.description", "Wooden boards en row in sign-shape.");
        this.add("item.fossilslegacy.user_manual.information.sign.use", "Decorative block with text-displaying capabilities.");
        ...
        this.add("item.fossilslegacy.user_manual.information.slab.description", "Wooden boards en row in slab-shape.");
        this.add("item.fossilslegacy.user_manual.information.slab.use", "Decorative block.");
        this.add("item.fossilslegacy.user_manual.information.small_cage.description", "A cage made for small animals.");
        this.add("item.fossilslegacy.user_manual.information.small_cage.use", "Left-click on a tranquilized creature to put it in the cage. Used for quick transportation.");
        this.add("item.fossilslegacy.user_manual.information.stairs.description", "Wooden boards en row in stair-shape.");
        this.add("item.fossilslegacy.user_manual.information.stairs.use", "Decorative block.");
        this.add("item.fossilslegacy.user_manual.information.stone_hammer.description", "A stone tool.");
        this.add("item.fossilslegacy.user_manual.information.stone_javelin.description", "A massive stone arrow-like weapon.");
        this.add("item.fossilslegacy.user_manual.information.stone_javelin.use", "Can wind up and throw like a trident.");
        ...
        this.add("item.fossilslegacy.user_manual.information.stripped_log.description", "Woody stem of a plant without bark.");
        this.add("item.fossilslegacy.user_manual.information.stripped_log.use", "Barkless decorative block.");
        this.add("item.fossilslegacy.user_manual.information.stripped_wood.description", "Woody stem of a plant without bark.");
        this.add("item.fossilslegacy.user_manual.information.stripped_wood.use", "Barkless decorative block.");
        this.add("item.fossilslegacy.user_manual.information.tall_horsetail.description", "A two-meter-tall horsetail.");
        this.add("item.fossilslegacy.user_manual.information.tall_horsetail.use", "Can place up to three on a block.");
        this.add("item.fossilslegacy.user_manual.information.trapdoor.description", "Wooden trapdoor.");
        this.add("item.fossilslegacy.user_manual.information.trapdoor.use", "Decorative block with opening capabilities.");
        ...
        this.add("item.fossilslegacy.user_manual.information.wood.description", "Woody stem of a plant with bark on all sides.");
        this.add("item.fossilslegacy.user_manual.information.wood.use", "Bark on all sides decorative block.");
        this.add("item.fossilslegacy.user_manual.information.wooden_hammer.description", "A wooden tool.");
        this.add("item.fossilslegacy.user_manual.information.wooden_javelin.description", "A massive wooden arrow-like weapon.");
        this.add("item.fossilslegacy.user_manual.information.wooden_javelin.use", "Can wind up and throw like a trident.");
        this.add("item.fossilslegacy.user_manual.loot_table.academy_loot", "Academy Loot");
        ...
        this.add("item.fossilslegacy.user_manual.loot_table.weapon_shop_decoy", "Weapon Shop Decoy");
        ...
        */
        ...
        this.add(FAItems.ARAUCARIOXYLON_BOAT.get());
        this.add(FAItems.ARAUCARIOXYLON_CHEST_BOAT.get(), "Araucarioxylon Boat with Chest");
        this.add(FAItems.CORDAITES_BOAT.get());
        this.add(FAItems.CORDAITES_CHEST_BOAT.get(), "Cordaites Boat with Chest");
        this.add(FAItems.WOLLEMIA_BOAT.get());
        this.add(FAItems.WOLLEMIA_CHEST_BOAT.get(), "Wollemia Boat with Chest");
        this.add(FAItems.METASEQUOIA_BOAT.get());
        this.add(FAItems.METASEQUOIA_CHEST_BOAT.get(), "Metasequoia Boat with Chest");
        ...
        this.add(FAItemTags.ARAUCARIOXYLON_LOGS, "Araucarioxylon Logs");
        ...
        this.add(FAItemTags.CENOZOIC_FOSSIL, "Cenozoic Fossil");
        this.add(FAItemTags.COMPSOGNATHUS_COMMANDABLES, "Compsognathus Commandables");
        this.add(FAItemTags.CORDAITES_LOGS, "Cordaites Logs");
        ...
        this.add(FAItemTags.PALAEOZOIC_FOSSIL, "Palaeozoic Fossil");
        ...
        this.add(FAItemTags.WOLLEMIA_LOGS, "Wollemia Logs");
    ...
    public void add(AttributeGene attributeGene, String translation) {
        this.add(attributeGene.getDescriptionID(), translation);
    }
    ...
    public void addModelType(ResourceKey<ModelGene> modelType, String translation) {
