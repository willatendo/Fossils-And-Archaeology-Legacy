...
import willatendo.fossilslegacy.server.entity.entities.DrownedPirate;
import willatendo.fossilslegacy.server.utils.FAUtils;

public class DrownedPirateRenderer extends HumanoidMobRenderer<DrownedPirate, SkeletonRenderState, SkeletonModel<SkeletonRenderState>> {
    ...
    public DrownedPirateRenderer(EntityRendererProvider.Context context) {
        super(context, new SkeletonModel<>(context.bakeLayer(FAModelLayers.DROWNED_PIRATE)), 0.5F);
