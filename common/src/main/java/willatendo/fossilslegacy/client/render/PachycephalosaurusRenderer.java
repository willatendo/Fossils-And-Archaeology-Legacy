...
public class PachycephalosaurusRenderer extends DataDrivenModelDinosaurRenderer<Pachycephalosaurus, DinosaurRenderState> {
    ...
    public ResourceKey<CompositeTextureRules.RuleSource> getSkinCompositeTextureRuleSource() {
        return FACompositeTextureRuleSources.PACHYCEPHALOSAURUS_SKIN;
    }

    @Override
    public ResourceKey<CompositeTextureRules.RuleSource> getPatternCompositeTextureRuleSource() {
        return FACompositeTextureRuleSources.PACHYCEPHALOSAURUS_PATTERN;
    }

    @Override
    public ResourceLocation getBasePath() {
        return this.createPath("pachycephalosaurus");
    }
}
