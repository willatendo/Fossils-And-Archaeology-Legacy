...
public class PachycephalosaurusRenderer extends MobRenderer<Pachycephalosaurus, PachycephalosaurusModel> {
    public static final ResourceLocation BABY_TEXTURE = FossilsLegacyUtils.resource("textures/entity/animals/pachycephalosaurus/pachycephalosaurus_baby.png");
    public static final ResourceLocation ADULT_TEXTURE = FossilsLegacyUtils.resource("textures/entity/animals/pachycephalosaurus/pachycephalosaurus_adult.png");
