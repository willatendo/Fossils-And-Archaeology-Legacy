...
public class DilophosaurusRenderer extends MobRenderer<Dilophosaurus, DilophosaurusModel> {
    public static final ResourceLocation TEXTURE = FossilsLegacyUtils.resource("textures/entity/animals/dilophosaurus/dilophosaurus.png");
    public static final ResourceLocation AGGRESSIVE_TEXTURE = FossilsLegacyUtils.resource("textures/entity/animals/dilophosaurus/aggressive_dilophosaurus.png");
