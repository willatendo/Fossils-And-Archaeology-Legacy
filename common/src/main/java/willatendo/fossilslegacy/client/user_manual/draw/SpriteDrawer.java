...
public final class SpriteDrawer {
    ...
    private final Map<TextInformation, Component> centeredData = new HashMap<>();
    ...
    public void drawCentered(int x, int y, Component component, int color) {
        this.centeredData.put(new TextInformation(new Coordinate(x, y), color), component);
    }
    ...
    public Set<Map.Entry<TextInformation, Component>> forEachCenteredText() {
        return this.centeredData.entrySet();
    }
}
