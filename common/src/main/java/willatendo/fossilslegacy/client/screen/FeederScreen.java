...
public class FeederScreen extends AbstractContainerScreen<FeederMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int x, int y) {
        ...
        guiGraphics.blitSprite(FEEDER_CAPACITY_SPRITE, 3, 46, 0, 46 - meat, leftPos + 67, topPos + 55 - meat, 46 - meat, 3, meat);
        int plants = this.menu.getPlantsScaled(46);
        guiGraphics.blitSprite(FEEDER_CAPACITY_SPRITE, 3, 46, 0, 46 - plants, leftPos + 111, topPos + 55 - plants, 46 - plants, 3, plants);
    }
}
