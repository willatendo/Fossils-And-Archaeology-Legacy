...
public enum FASearchRecipeBookCategory implements ExtendedRecipeBookCategory {
    ANALYZATION(FARecipeBookCategories.ANALYZATION_PALAEONTOLOGY.get(), FARecipeBookCategories.ANALYZATION_ARCHAEOLOGY.get(), FARecipeBookCategories.ANALYZATION_MISC.get()),
