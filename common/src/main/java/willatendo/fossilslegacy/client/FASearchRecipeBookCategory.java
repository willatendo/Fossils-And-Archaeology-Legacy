...
public enum FASearchRecipeBookCategory implements ExtendedRecipeBookCategory {
    ANALYZATION(FARecipeBookCategories.ANALYZATION_PALAEONTOLOGY.get(), FARecipeBookCategories.ANALYZATION_PALAEOBOTANY.get(), FARecipeBookCategories.ANALYZATION_MISC.get()),
