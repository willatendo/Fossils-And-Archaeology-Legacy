...
public class TherizinosaurusModel extends EntityModel<Therizinosaurus> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        leftLowerFeather.addOrReplaceChild("left_front_claw", CubeListBuilder.create().texOffs(18, 10).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 3.1F, 0.0F, 0.33161255787892263F, 0.0F, 0.0F));
        leftLowerFeather.addOrReplaceChild("left_middle_claw", CubeListBuilder.create().texOffs(18, 10).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F), PartPose.offsetAndRotation(0.1F, 3.2F, 0.0F, 0.767944870877505F, -0.0F, 0.0F));
