...
public final class BaryonyxModels {
    public static final JsonModel BARYONYX_MODEL = BaryonyxModels.createBaryonyxBodyLayer().withWalkAnimations(FAUtils.resource("baryonyx_walk")).withHeadPieces("neck").build();
    ...
    private static JsonModel.Builder createBaryonyxBodyLayer() {
        ...
        builder.addOrReplaceChild("body", elementBuilder -> elementBuilder.addBox(0, 0, -3F, -15F, -3F, 6F, 7F, 12F).addBox(0, 32, -2F, -14F, -9F, 4F, 6F, 6F).addBox(26, 31, 0F, -19F, -1F, 0F, 4F, 10F).build(), JsonPose.offset(0F, 24F, 0F));
        return builder;
    }
}
