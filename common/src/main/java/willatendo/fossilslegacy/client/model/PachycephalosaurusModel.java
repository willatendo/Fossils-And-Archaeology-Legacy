...
public class PachycephalosaurusModel extends HierarchicalModel<Pachycephalosaurus> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -14.0F, -4.0F, 6.0F, 8.0F, 8.0F).texOffs(0, 36).addBox(-2.0F, -14.0F, -7.0F, 4.0F, 7.0F, 3.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
