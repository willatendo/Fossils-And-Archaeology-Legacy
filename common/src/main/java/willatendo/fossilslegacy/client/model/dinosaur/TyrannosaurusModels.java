...
public final class TyrannosaurusModels {
    ...
    public static LayerDefinition createKnockedOutTyrannosaurusBodyLayer() {
        ...
        PartDefinition neck = partDefinition.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(26, 34).addBox(-2.0F, -8.0F, -4.0F, 4.0F, 12.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 17.0F, -7.0F, 1.5708F, 0.0F, 0.0F));
        neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(34, 0).addBox(-3.0F, -3.0F, -6.0F, 6.0F, 7.0F, 7.0F).texOffs(46, 49).addBox(-2.0F, -2.0F, -13.0F, 4.0F, 4.0F, 7.0F).texOffs(20, 52).addBox(-2.0F, 2.0F, -13.0F, 4.0F, 2.0F, 7.0F), PartPose.offsetAndRotation(0.0F, -5.0F, -2.0F, -1.5708F, 0.0F, 0.0F));
        partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -10.0F, -1.0F, 8.0F, 10.0F, 9.0F).texOffs(30, 19).addBox(-3.0F, -10.0F, -8.0F, 6.0F, 8.0F, 7.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
