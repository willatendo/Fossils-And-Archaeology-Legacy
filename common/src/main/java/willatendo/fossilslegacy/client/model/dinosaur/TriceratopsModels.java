...
public final class TriceratopsModels {
    public static final JsonModel TRICERATOPS_MODEL = TriceratopsModels.createTriceratopsBodyLayer(FAUtils.resource("triceratops")).withWalkAnimations(FAUtils.resource("triceratops_walk")).withHeadPieces("head").build();
    public static final JsonModel LEGACY_TRICERATOPS_MODEL = TriceratopsModels.createLegacyTriceratopsBodyLayer(FAUtils.resource("legacy_triceratops")).withWalkAnimations(BuiltInAnimationTypes.LEGACY_TRICERATOPS_WALK.getId()).build();

    private static JsonModel.Builder createTriceratopsBodyLayer(ResourceLocation modelId) {
        ...
        builder.addOrReplaceChild("legt_leg", elementBuilder -> elementBuilder.addBox(50, 62, -2.0F, 4.0F, -2.0F, 3.0F, 6.0F, 4.0F).addBox(50, 49, -1.0F, -3.0F, -3.0F, 3.0F, 7.0F, 6.0F).build(), JsonPose.offset(5.0F, 14.0F, 4.0F));
    ...
    private static JsonModel.Builder createLegacyTriceratopsBodyLayer(ResourceLocation modelId) {
