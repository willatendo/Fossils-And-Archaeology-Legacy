...
public final class DodoModels {
    public static final JsonModel DODO_MODEL = DodoModels.createDodoBodyLayer(FAUtils.resource("dodo")).withWalkAnimations(FAUtils.resource("dodo_walk")).withFloatDownAnimations(FAUtils.resource("dodo_float_down")).withHeadPieces("head").build();

    private static JsonModel.Builder createDodoBodyLayer(ResourceLocation modelId) {
