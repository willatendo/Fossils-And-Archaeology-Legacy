...
public final class TyrannosaurusAnimations {
    ...
    static void legacyTyrannosaurusWalkAnimation(DinosaurRenderState dinosaurRenderState, JsonTypeModel jsonTypeModel, float limbSwing, float limbSwingAmount, float netHeadYaw) {
        ...
        if (dinosaurRenderState.isMoving) {
            TyrannosaurusAnimations.legacyTyrannosaurusRunPose(jsonTypeModel);
        } else {
            TyrannosaurusAnimations.legacyTyrannosaurusStandPose(jsonTypeModel);
        }
    }

    private static void legacyTyrannosaurusRunPose(JsonTypeModel jsonTypeModel) {
        TyrannosaurusAnimations.legacyTyrannosaurusRunPose(jsonTypeModel, 20.0F);
    }
    ...
    private static void legacyTyrannosaurusStandPose(JsonTypeModel jsonTypeModel) {
        TyrannosaurusAnimations.legacyTyrannosaurusStandPose(jsonTypeModel, 20.0F);
    }
