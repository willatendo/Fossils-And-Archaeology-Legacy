...
public enum BuiltInAnimationTypes implements BuiltInAnimationType {
    ...
    LEGACY_FUTABASAURUS_SWIM("legacy_futabasaurus_swim", dinosaur -> true, FutabasaurusAnimations::legacyFutabasaurusSwimAnimation, FutabasaurusAnimations::legacyFutabasaurusDiveModelPrep),
    ...
    LEGACY_TYRANNOSAURUS_WALK("legacy_tyrannosaurus_walk", dinosaur -> true, TyrannosaursAnimations::legacyTyrannosaurusWalkAnimation),
