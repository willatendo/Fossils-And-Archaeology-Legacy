...
public enum BuiltInAnimationTypes implements BuiltInAnimationType {
    ...
    LEGACY_PTERANODON_FLY("legacy_pteranodon_fly", dinosaur -> dinosaur instanceof FlyingDinosaur, AnimationUtils::pteranodonFlyingAnimation),
    LEGACY_PTERANODON_HEAD("legacy_pteranodon_head", dinosaur -> true, AnimationUtils::pteranodonHeadAnimation),
    LEGACY_PTERANODON_WALK("legacy_pteranodon_walk", dinosaur -> true, AnimationUtils::pteranodonWalkAnimation),
