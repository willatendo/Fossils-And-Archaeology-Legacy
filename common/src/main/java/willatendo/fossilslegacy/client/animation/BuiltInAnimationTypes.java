...
public enum BuiltInAnimationTypes implements BuiltInAnimationType {
    ...
    PTERANODON_BODY_FLY("pteranodon_body_fly", dinosaur -> dinosaur instanceof FlyingDinosaur, AnimationUtils::pteranodonFlyingAnimation),
    LEGACY_PTERANODON_FLY("legacy_pteranodon_fly", dinosaur -> dinosaur instanceof FlyingDinosaur, AnimationUtils::legacyPteranodonFlyingAnimation),
    LEGACY_PTERANODON_HEAD("legacy_pteranodon_head", dinosaur -> true, AnimationUtils::legacyPteranodonHeadAnimation),
    LEGACY_PTERANODON_WALK("legacy_pteranodon_walk", dinosaur -> true, AnimationUtils::legacyPteranodonWalkAnimation),
