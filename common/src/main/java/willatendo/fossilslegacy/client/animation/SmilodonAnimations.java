...
public final class SmilodonAnimations {
    ...
    public static final JsonAnimation SMILODON_SIT = JsonAnimation.builder(0.0F).addAnimation("left_leg", "positiom", JsonKeyframe.create(0.0F, -1.0F, -4.5F, -6.0F, "linear")).addAnimation("left_leg", "rotation", JsonKeyframe.create(0.0F, -90.0F, 0.0F, 0.0F, "linear")).addAnimation("right_leg", "positiom", JsonKeyframe.create(0.0F, 1.0F, -4.5F, -6.0F, "linear")).addAnimation("right_leg", "rotation", JsonKeyframe.create(0.0F, -90.0F, 0.0F, 0.0F, "linear")).addAnimation("tail", "positiom", JsonKeyframe.create(0.0F, 0.0F, -8.0F, -3.0F, "linear")).addAnimation("tail", "rotation", JsonKeyframe.create(0.0F, 70.0F, 0.0F, 0.0F, "linear")).addAnimation("neck", "positiom", JsonKeyframe.create(0.0F, 0.0F, 1.0F, 2.0F, "linear")).addAnimation("body", "positiom", JsonKeyframe.create(0.0F, 0.0F, -3.0F, -1.0F, "linear")).addAnimation("body", "rotation", JsonKeyframe.create(0.0F, -45.0F, 0.0F, 0.0F, "linear")).build();
