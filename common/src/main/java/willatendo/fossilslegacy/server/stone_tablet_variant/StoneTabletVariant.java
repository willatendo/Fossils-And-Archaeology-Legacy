...
public record StoneTabletVariant(int width, int height, ResourceLocation assetId) {
    ...
    public static final Codec<Holder<StoneTabletVariant>> CODEC = RegistryFileCodec.create(FARegistries.STONE_TABLET_VARIANTS, DIRECT_CODEC);
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<StoneTabletVariant>> STREAM_CODEC = ByteBufCodecs.holder(FARegistries.STONE_TABLET_VARIANTS, DIRECT_STREAM_CODEC);
