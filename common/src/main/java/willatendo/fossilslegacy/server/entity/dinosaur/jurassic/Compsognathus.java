...
public class Compsognathus extends Dinosaur implements DinopediaInformation {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new DinoNearestAttackableTargetGoal<>(this, FossilsLegacyEntityTypeTags.COMPSOGNATHUS_VICTIMS, true));
    }
    ...
    public Optional<ResourceKey<DinopediaType>> getDinopediaType() {
        return Optional.of(FossilsLegacyDinopediaTypes.COMPSOGNATHUS);
    }
