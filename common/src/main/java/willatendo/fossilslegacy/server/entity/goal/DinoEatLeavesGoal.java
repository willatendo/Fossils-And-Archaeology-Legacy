...
public class DinoEatLeavesGoal extends Goal {
	...
	public boolean canUse() {
		if (this.dinosaur.getHunger() >= this.hungerLimit) {
			...
			return this.level.getBlockState(blockPos).is(FossilsLegacyBlockTags.EATABLE_LEAVES);
		}
	}
	...
	public void tick() {
		...
		if (this.level.getBlockState(eyePos).is(FossilsLegacyBlockTags.EATABLE_LEAVES)) {
