...
public class PregnantCamel extends Camel implements DinopediaInformation, PregnantAnimal<Camel> {
    private static final EntityDataAccessor<Integer> PREGNANCY_TIME = SynchedEntityData.defineId(PregnantCamel.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY_TYPE = SynchedEntityData.defineId(PregnantCamel.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantCamel.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantCamel.class, FAEntityDataSerializers.CHROMOSOME.get());
    ...
    public PregnantCamel(EntityType<? extends Camel> entityType, Level level) {
    ...
    public ItemStack getPickResult() {
        return Items.CAMEL_SPAWN_EGG.getDefaultInstance();
    }
    ...
    @Override
    public Camel getBaseEntity(Level level) {
