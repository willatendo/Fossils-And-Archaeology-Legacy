...
public class Baryonyx extends Dinosaur implements DinopediaInformation {
    public Baryonyx(EntityType<? extends Baryonyx> entityType, Level level) {
        super(entityType, level);
    }

    public static AttributeSupplier baryonyxAttributes() {
    ...
    public EntityType<Egg> getEggEntityType() {
        return FAEntityTypes.BARYONYX_EGG.get();
    }
    ...
    public TagKey<ModelGene> getModelTypes() {
        return FAModelGeneTags.BARYONYX;
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new DinoNearestAttackableTargetGoal<>(this, FAEntityTypeTags.BARYONYX_VICTIMS, true));
    }
