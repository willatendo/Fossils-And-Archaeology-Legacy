...
public class Dilophosaurus extends Dinosaur implements DinopediaInformation, RangedAttackMob {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new DinoNearestAttackableTargetGoal<>(this, FossilsLegacyEntityTypeTags.DILOPHOSAURUS_VICTIMS, true));
    }
    ...
    public Optional<ResourceKey<DinopediaType>> getDinopediaType() {
        return Optional.of(FossilsLegacyDinopediaTypes.DILOPHOSAURUS);
    }
