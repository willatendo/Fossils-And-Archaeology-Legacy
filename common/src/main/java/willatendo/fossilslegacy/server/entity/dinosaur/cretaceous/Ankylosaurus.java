...
public class Ankylosaurus extends Dinosaur implements DinopediaInformation, RideableDinosaur, CoatTypeEntity {
    private static final EntityDataAccessor<Holder<CoatType>> COAT_TYPE = SynchedEntityData.defineId(Ankylosaurus.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    public TagKey<CoatType> getCoatTypes() {
        return FossilsLegacyCoatTypeTags.ANKYLOSAURUS;
    }

    @Override
    public Holder<EggVariant> getEggVariant() {
        return FossilsLegacyEggVariants.ANKYLOSAURUS;
    }
    ...
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FossilsLegacySoundEvents.ANKYLOSAURUS_AMBIENT.get(), CoatType.OverrideInfo.OverridenSoundType.AMBIENT);
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FossilsLegacySoundEvents.ANKYLOSAURUS_HURT.get(), CoatType.OverrideInfo.OverridenSoundType.HURT);
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FossilsLegacySoundEvents.ANKYLOSAURUS_DEATH.get(), CoatType.OverrideInfo.OverridenSoundType.DEATH);
    }
    ...
    public CommandingType commandItems() {
        return CommandingType.tag(FossilsLegacyItemTags.ANKYLOSAURUS_COMMANDABLES);
    }
}
