...
public class PregnantLlama extends Llama implements DinopediaInformation, PregnantAnimal<Llama> {
    private static final EntityDataAccessor<Integer> PREGNANCY_TIME = SynchedEntityData.defineId(PregnantLlama.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY_TYPE = SynchedEntityData.defineId(PregnantLlama.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
    private static final EntityDataAccessor<Holder<ModelGene>> OFFSPRING_MODEL_TYPE = SynchedEntityData.defineId(PregnantLlama.class, FAEntityDataSerializers.MODEL_TYPES.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_SKIN = SynchedEntityData.defineId(PregnantLlama.class, FAEntityDataSerializers.PATTERN.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_PATTERN = SynchedEntityData.defineId(PregnantLlama.class, FAEntityDataSerializers.PATTERN.get());

    public PregnantLlama(EntityType<? extends Llama> entityType, Level level) {
        super(entityType, level);
    }

    @Override
    public ItemStack getPickResult() {
        return Items.LLAMA_SPAWN_EGG.getDefaultInstance();
    }
    ...
    @Override
    public Llama getBaseEntity(Level level) {
        return EntityType.LLAMA.create(level, EntitySpawnReason.BREEDING);
    }
}
