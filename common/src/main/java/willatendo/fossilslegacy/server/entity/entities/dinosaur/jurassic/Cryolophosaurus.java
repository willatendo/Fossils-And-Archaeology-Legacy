...
public class Cryolophosaurus extends Dinosaur implements DinopediaInformation {
    ...
    public TagKey<ModelGene> getModelTypes() {
        return FAModelGeneTags.CRYOLOPHOSAURUS;
    }
    ...
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FASoundEvents.CRYOLOPHOSAURUS_AMBIENT.get(), ModelGene.OverrideInfo.OverridenSoundType.AMBIENT, this.registryAccess());
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FASoundEvents.CRYOLOPHOSAURUS_HURT.get(), ModelGene.OverrideInfo.OverridenSoundType.HURT, this.registryAccess());
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FASoundEvents.CRYOLOPHOSAURUS_DEATH.get(), ModelGene.OverrideInfo.OverridenSoundType.DEATH, this.registryAccess());
    }
