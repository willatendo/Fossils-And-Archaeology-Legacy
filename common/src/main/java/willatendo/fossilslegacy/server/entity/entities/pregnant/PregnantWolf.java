...
public class PregnantWolf extends Wolf implements DinopediaInformation, PregnantAnimal<Wolf> {
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY_TYPE = SynchedEntityData.defineId(PregnantWolf.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
    private static final EntityDataAccessor<Holder<ModelGene>> OFFSPRING_MODEL_TYPE = SynchedEntityData.defineId(PregnantWolf.class, FAEntityDataSerializers.MODEL_TYPES.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_SKIN = SynchedEntityData.defineId(PregnantWolf.class, FAEntityDataSerializers.PATTERN.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_PATTERN = SynchedEntityData.defineId(PregnantWolf.class, FAEntityDataSerializers.PATTERN.get());
    ...
    public Wolf getBaseEntity(Level level) {
        return EntityType.WOLF.create(level, EntitySpawnReason.BREEDING);
    }
}
