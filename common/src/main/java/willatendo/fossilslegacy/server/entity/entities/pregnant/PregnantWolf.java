...
public class PregnantWolf extends Wolf implements DinopediaInformation, PregnantAnimal<Wolf> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantWolf.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantWolf.class, FAEntityDataSerializers.CHROMOSOME.get());
