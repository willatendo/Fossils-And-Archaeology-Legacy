...
public class PregnantPolarBear extends PolarBear implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantPolarBear.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
