...
public class PregnantDolphin extends Dolphin implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantDolphin.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
