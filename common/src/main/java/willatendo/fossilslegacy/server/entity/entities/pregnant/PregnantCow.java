...
public class PregnantCow extends Cow implements DinopediaInformation, PregnantAnimal<Cow> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantCow.class, FAEntityDataSerializers.COAT_TYPES.get());
