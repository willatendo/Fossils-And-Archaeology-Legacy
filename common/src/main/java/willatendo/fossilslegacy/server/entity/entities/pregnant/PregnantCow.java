...
public class PregnantCow extends Cow implements DinopediaInformation, PregnantAnimal<Cow> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantCow.class, FAEntityDataSerializers.MODEL_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantCow.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
