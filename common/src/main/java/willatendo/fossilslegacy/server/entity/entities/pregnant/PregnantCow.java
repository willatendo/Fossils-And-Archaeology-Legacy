...
public class PregnantCow extends Cow implements DinopediaInformation, PregnantAnimal<Cow> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantCow.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantCow.class, FAEntityDataSerializers.CHROMOSOME.get());
