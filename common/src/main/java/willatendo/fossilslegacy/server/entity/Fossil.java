...
public class Fossil extends Mob {
    private static final EntityDataAccessor<FossilVariant> FOSSIL_VARIANT = SynchedEntityData.defineId(Fossil.class, FossilsLegacyEntityDataSerializers.FOSSIL_VARIANTS.get());
