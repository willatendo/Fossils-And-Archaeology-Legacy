...
public record CoatType(Component name, ResourceLocation model, ResourceLocation texture, Optional<ResourceLocation> babyTexture, float boundingBoxWidth, float boundingBoxHeight, float boundingBoxGrowth, float baseScaleWidth, float baseScaleHeight, float ageScale) {
