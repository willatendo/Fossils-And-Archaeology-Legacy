...
public class PregnantArmadillo extends Armadillo implements PregnantAnimal<Armadillo>, DinopediaInformation {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantArmadillo.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantArmadillo.class, FAEntityDataSerializers.CHROMOSOME.get());
