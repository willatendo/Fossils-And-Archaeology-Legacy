...
public class PregnantBat extends Bat implements DinopediaInformation, PregnantAnimal<Bat> {
    private static final EntityDataAccessor<Integer> PREGNANCY_TIME = SynchedEntityData.defineId(PregnantBat.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY_TYPE = SynchedEntityData.defineId(PregnantBat.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantBat.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantBat.class, FAEntityDataSerializers.CHROMOSOME.get());
    ...
    public PregnantBat(EntityType<? extends Bat> entityType, Level level) {
    ...
    public ItemStack getPickResult() {
        return Items.BAT_SPAWN_EGG.getDefaultInstance();
    }
    ...
    @Override
    public Bat getBaseEntity(Level level) {
        return EntityType.BAT.create(level, EntitySpawnReason.BREEDING);
    }
}
