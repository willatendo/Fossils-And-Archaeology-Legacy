...
public class PregnantPig extends Pig implements DinopediaInformation, PregnantAnimal<Pig> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantPig.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
