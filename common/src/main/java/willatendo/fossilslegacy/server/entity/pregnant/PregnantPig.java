...
public class PregnantPig extends Pig implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantPig.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
