...
public class Carnotaurus extends Dinosaur implements DinopediaInformation {
    ...
    public EntityType<Egg> getEggEntityType() {
        return FAEntityTypes.CARNOTAURUS_EGG.get();
    }
    ...
    public TagKey<ModelGene> getModelTypes() {
        return FAModelGeneTags.CARNOTAURUS;
    }
    ...
    protected ItemStack getHead() {
        return new ItemStack(FAItems.CARNOTAURUS_HEAD.get());
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new DinoNearestAttackableTargetGoal<>(this, FAEntityTypeTags.CARNOTAURUS_VICTIMS, true));
    }

    @Override
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FASoundEvents.CARNOTAURUS_AMBIENT.get(), ModelGene.OverrideInfo.OverridenSoundType.AMBIENT, this.registryAccess());
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FASoundEvents.CARNOTAURUS_HURT.get(), ModelGene.OverrideInfo.OverridenSoundType.HURT, this.registryAccess());
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FASoundEvents.CARNOTAURUS_DEATH.get(), ModelGene.OverrideInfo.OverridenSoundType.DEATH, this.registryAccess());
    }

    @Override
    public Optional<ResourceKey<DinopediaType>> getDinopediaType() {
        return Optional.of(FADinopediaTypes.CARNOTAURUS);
    }

    @Override
    public CommandingType commandItems() {
        return CommandingType.tag(FAItemTags.CARNOTAURUS_COMMANDABLES);
    }
}
