...
public class PregnantMule extends Mule implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantMule.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
