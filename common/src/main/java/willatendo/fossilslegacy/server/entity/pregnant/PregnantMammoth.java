...
public class PregnantMammoth extends Mammoth implements DinopediaInformation, PregnantAnimal<Mammoth> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantMammoth.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantMammoth.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
