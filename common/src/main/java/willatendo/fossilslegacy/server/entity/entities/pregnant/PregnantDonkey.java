...
public class PregnantDonkey extends Donkey implements DinopediaInformation, PregnantAnimal<Donkey> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.CHROMOSOME.get());
