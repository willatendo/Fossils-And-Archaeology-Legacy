...
public class PregnantDonkey extends Donkey implements DinopediaInformation, PregnantAnimal<Donkey> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.MODEL_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
