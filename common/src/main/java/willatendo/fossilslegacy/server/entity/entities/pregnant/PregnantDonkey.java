...
public class PregnantDonkey extends Donkey implements DinopediaInformation, PregnantAnimal<Donkey> {
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY_TYPE = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
    private static final EntityDataAccessor<Holder<ModelGene>> OFFSPRING_MODEL_TYPE = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.MODEL_TYPES.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_SKIN = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.PATTERN.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_PATTERN = SynchedEntityData.defineId(PregnantDonkey.class, FAEntityDataSerializers.PATTERN.get());
    ...
    @Override
    public Donkey getBaseEntity(Level level) {
        return EntityType.DONKEY.create(level, EntitySpawnReason.BREEDING);
    }
}
