...
public class PregnantMule extends Mule implements DinopediaInformation, PregnantAnimal<Mule> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantMule.class, FAEntityDataSerializers.MODEL_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantMule.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
