...
public class PregnantMule extends Mule implements DinopediaInformation, PregnantAnimal<Mule> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantMule.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantMule.class, FAEntityDataSerializers.CHROMOSOME.get());
