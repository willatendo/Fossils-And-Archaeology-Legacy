...
public class PregnantRabbit extends Rabbit implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantRabbit.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
