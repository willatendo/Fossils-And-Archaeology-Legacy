...
public class PregnantRabbit extends Rabbit implements DinopediaInformation, PregnantAnimal<Rabbit> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantRabbit.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantRabbit.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
