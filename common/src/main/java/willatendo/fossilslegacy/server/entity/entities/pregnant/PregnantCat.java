...
public class PregnantCat extends Cat implements DinopediaInformation, PregnantAnimal<Cat> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantCat.class, FAEntityDataSerializers.MODEL_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantCat.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
