...
public class PregnantFox extends Fox implements DinopediaInformation, PregnantAnimal<Fox> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantFox.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantFox.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
    ...
    public Fox getBaseEntity(Level level) {
        return EntityType.FOX.create(level);
    }
}
