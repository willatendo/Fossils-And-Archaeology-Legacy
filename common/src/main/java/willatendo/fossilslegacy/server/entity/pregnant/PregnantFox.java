...
public class PregnantFox extends Fox implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantFox.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
