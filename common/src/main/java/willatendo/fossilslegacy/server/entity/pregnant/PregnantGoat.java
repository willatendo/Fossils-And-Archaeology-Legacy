...
public class PregnantGoat extends Goat implements DinopediaInformation, PregnantAnimal<Goat> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantGoat.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantGoat.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
    ...
    public Goat getBaseEntity(Level level) {
        return EntityType.GOAT.create(level);
    }
}
