...
public class PregnantGoat extends Goat implements DinopediaInformation, PregnantAnimal<Goat> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantGoat.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantGoat.class, FAEntityDataSerializers.CHROMOSOME.get());
