...
public class PregnantGoat extends Goat implements DinopediaInformation, PregnantAnimal<Goat> {
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY_TYPE = SynchedEntityData.defineId(PregnantGoat.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
    private static final EntityDataAccessor<Holder<ModelGene>> OFFSPRING_MODEL_TYPE = SynchedEntityData.defineId(PregnantGoat.class, FAEntityDataSerializers.MODEL_TYPES.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_SKIN = SynchedEntityData.defineId(PregnantGoat.class, FAEntityDataSerializers.PATTERN.get());
    private static final EntityDataAccessor<Holder<PatternGene>> OFFSPRING_PATTERN = SynchedEntityData.defineId(PregnantGoat.class, FAEntityDataSerializers.PATTERN.get());

    public PregnantGoat(EntityType<? extends Goat> entityType, Level level) {
        super(entityType, level);
    }

    @Override
    public ItemStack getPickResult() {
        return Items.GOAT_SPAWN_EGG.getDefaultInstance();
    }
    ...
    @Override
    public Goat getBaseEntity(Level level) {
        return EntityType.GOAT.create(level, EntitySpawnReason.BREEDING);
    }
}
