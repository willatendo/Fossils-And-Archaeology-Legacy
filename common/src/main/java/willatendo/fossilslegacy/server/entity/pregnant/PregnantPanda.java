...
public class PregnantPanda extends Panda implements DinopediaInformation, PregnantAnimal<Panda> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantPanda.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantPanda.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
