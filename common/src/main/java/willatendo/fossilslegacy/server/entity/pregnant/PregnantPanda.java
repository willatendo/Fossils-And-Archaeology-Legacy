...
public class PregnantPanda extends Panda implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantPanda.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
