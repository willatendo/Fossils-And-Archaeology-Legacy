...
public class PregnantSheep extends Sheep implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantSheep.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
