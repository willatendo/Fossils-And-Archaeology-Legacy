...
public class Gallimimus extends Dinosaur implements DinopediaInformation, RideableDinosaur {
    ...
    public TagKey<CoatType> getCoatTypes() {
        return FACoatTypeTags.GALLIMIMUS;
    }

    @Override
    public Holder<EggVariant> getEggVariant() {
        return FAEggVariants.GALLIMIMUS;
    }
    ...
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FASoundEvents.GALLIMIMUS_AMBIENT.get(), CoatType.OverrideInfo.OverridenSoundType.AMBIENT);
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FASoundEvents.GALLIMIMUS_HURT.get(), CoatType.OverrideInfo.OverridenSoundType.HURT);
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FASoundEvents.GALLIMIMUS_DEATH.get(), CoatType.OverrideInfo.OverridenSoundType.DEATH);
    }

    @Override
    public Optional<ResourceKey<DinopediaType>> getDinopediaType() {
        return Optional.of(FADinopediaTypes.GALLIMIMUS);
    }

    @Override
    public CommandingType commandItems() {
        return CommandingType.tag(FAItemTags.GALLIMIMUS_COMMANDABLES);
    }
}
