...
public class Gallimimus extends Dinosaur implements DinopediaInformation, RideableDinosaur {
    ...
    protected ItemStack getHead() {
        return new ItemStack(FAItems.GALLIMIMUS_HEAD.get());
    }
    ...
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FASoundEvents.GALLIMIMUS_AMBIENT.get(), ModelType.OverrideInfo.OverridenSoundType.AMBIENT);
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FASoundEvents.GALLIMIMUS_HURT.get(), ModelType.OverrideInfo.OverridenSoundType.HURT);
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FASoundEvents.GALLIMIMUS_DEATH.get(), ModelType.OverrideInfo.OverridenSoundType.DEATH);
    }
