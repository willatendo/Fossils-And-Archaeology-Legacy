...
public class Triceratops extends Dinosaur implements DinopediaInformation, RideableDinosaur {
    ...
    public TagKey<ModelGene> getModelTypes() {
        return FAModelGeneTags.TRICERATOPS;
    }
    ...
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FASoundEvents.TRICERATOPS_AMBIENT.get(), ModelGene.OverrideInfo.OverridenSoundType.AMBIENT, this.registryAccess());
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FASoundEvents.TRICERATOPS_HURT.get(), ModelGene.OverrideInfo.OverridenSoundType.HURT, this.registryAccess());
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FASoundEvents.TRICERATOPS_DEATH.get(), ModelGene.OverrideInfo.OverridenSoundType.DEATH, this.registryAccess());
    }
