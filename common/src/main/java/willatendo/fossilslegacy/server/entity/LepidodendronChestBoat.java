...
public class LepidodendronChestBoat extends ChestBoat implements BoatTypeAccessor {
    private static final EntityDataAccessor<Holder<BoatType>> BOAT_TYPE = SynchedEntityData.defineId(LepidodendronChestBoat.class, FossilsLegacyEntityDataSerializers.BOAT_TYPES.get());

    public LepidodendronChestBoat(EntityType<? extends LepidodendronChestBoat> entityType, Level level) {
        super(entityType, level);
    }

    public LepidodendronChestBoat(Level level, double x, double y, double z) {
        this(FossilsLegacyEntityTypes.LEPIDODENDRON_CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
