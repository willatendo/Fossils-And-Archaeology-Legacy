...
public class PregnantHorse extends Horse implements DinopediaInformation, PregnantAnimal<Horse> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantHorse.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantHorse.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
