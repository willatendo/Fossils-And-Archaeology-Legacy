...
public class PregnantRabbit extends Rabbit implements DinopediaInformation, PregnantAnimal<Rabbit> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantRabbit.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantRabbit.class, FAEntityDataSerializers.CHROMOSOME.get());
