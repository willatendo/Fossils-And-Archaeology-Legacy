...
public class PregnantRabbit extends Rabbit implements DinopediaInformation, PregnantAnimal<Rabbit> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantRabbit.class, FAEntityDataSerializers.COAT_TYPES.get());
