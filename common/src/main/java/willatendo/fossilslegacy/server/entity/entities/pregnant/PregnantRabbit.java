...
public class PregnantRabbit extends Rabbit implements DinopediaInformation, PregnantAnimal<Rabbit> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantRabbit.class, FAEntityDataSerializers.MODEL_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantRabbit.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
    ...
    public ItemStack getPickResult() {
        return Items.RABBIT_SPAWN_EGG.getDefaultInstance();
    }
    ...
    @Override
    public Rabbit getBaseEntity(Level level) {
        return EntityType.RABBIT.create(level, EntitySpawnReason.BREEDING);
    }
}
