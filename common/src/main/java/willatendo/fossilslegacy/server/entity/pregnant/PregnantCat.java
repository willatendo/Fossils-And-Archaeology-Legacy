...
public class PregnantCat extends Cat implements DinopediaInformation, PregnantAnimal<Cat> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantCat.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantCat.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
