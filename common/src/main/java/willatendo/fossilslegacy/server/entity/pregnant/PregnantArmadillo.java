...
public class PregnantArmadillo extends Armadillo implements PregnantAnimal<Armadillo>, DinopediaInformation {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantArmadillo.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantArmadillo.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
