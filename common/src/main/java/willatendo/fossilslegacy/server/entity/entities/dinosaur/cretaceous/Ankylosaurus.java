...
public class Ankylosaurus extends Dinosaur implements DinopediaInformation, RideableDinosaur {
    ...
    public TagKey<CoatType> getCoatTypes() {
        return FACoatTypeTags.ANKYLOSAURUS;
    }

    @Override
    public Holder<EggVariant> getEggVariant() {
        return FAEggVariants.ANKYLOSAURUS;
    }
    ...
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FASoundEvents.ANKYLOSAURUS_AMBIENT.get(), CoatType.OverrideInfo.OverridenSoundType.AMBIENT);
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FASoundEvents.ANKYLOSAURUS_HURT.get(), CoatType.OverrideInfo.OverridenSoundType.HURT);
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FASoundEvents.ANKYLOSAURUS_DEATH.get(), CoatType.OverrideInfo.OverridenSoundType.DEATH);
    }
