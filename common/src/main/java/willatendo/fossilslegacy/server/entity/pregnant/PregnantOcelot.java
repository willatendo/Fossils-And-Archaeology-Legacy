...
public class PregnantOcelot extends Ocelot implements DinopediaInformation, PregnantAnimal<Ocelot> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantOcelot.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantOcelot.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
