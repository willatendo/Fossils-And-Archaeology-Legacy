...
public final class FAEntityDataSerializers {
    ...
    public static final Supplier<EntityDataSerializer<Holder<Pattern>>> PATTERN = FossilsModloaderHelper.INSTANCE.registerDataSerializer("pattern", ByteBufCodecs.holderRegistry(FARegistries.PATTERN));
