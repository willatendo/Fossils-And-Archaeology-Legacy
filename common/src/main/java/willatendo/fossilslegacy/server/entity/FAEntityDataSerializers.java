...
public final class FAEntityDataSerializers {
    ...
    public static final Supplier<EntityDataSerializer<Holder<ModelGene>>> MODEL_TYPES = FAModloaderHelper.INSTANCE.registerDataSerializer("model_types", ByteBufCodecs.holderRegistry(FARegistries.MODEL_GENE));
    public static final Supplier<EntityDataSerializer<Holder<PatternGene>>> PATTERN = FAModloaderHelper.INSTANCE.registerDataSerializer("skinGenes", ByteBufCodecs.holderRegistry(FARegistries.PATTERN_GENE));
