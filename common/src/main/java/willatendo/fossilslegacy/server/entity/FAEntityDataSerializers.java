...
public final class FAEntityDataSerializers {
    ...
    public static final Supplier<EntityDataSerializer<Holder<DecorationPlaqueType>>> DECORATION_PLAQUE_TYPE = FossilsModloaderHelper.INSTANCE.registerDataSerializer("decoration_plaque_type", ByteBufCodecs.holderRegistry(FARegistries.DECORATION_PLAQUE_TYPE));
    ...
    public static final Supplier<EntityDataSerializer<Holder<PregnancyType>>> PREGNANCY_TYPES = FossilsModloaderHelper.INSTANCE.registerDataSerializer("pregnancy_types", ByteBufCodecs.holderRegistry(FARegistries.PREGNANCY_TYPE));
    public static final Supplier<EntityDataSerializer<Holder<StoneTabletVariant>>> STONE_TABLET_VARIANTS = FossilsModloaderHelper.INSTANCE.registerDataSerializer("stone_tablet_variants", ByteBufCodecs.holderRegistry(FARegistries.STONE_TABLET_VARIANT));
