...
public class PregnantDonkey extends Donkey implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantDonkey.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
