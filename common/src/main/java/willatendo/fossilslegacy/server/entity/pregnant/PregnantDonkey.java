...
public class PregnantDonkey extends Donkey implements DinopediaInformation, PregnantAnimal<Donkey> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantDonkey.class, FossilsLegacyEntityDataSerializers.COAT_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantDonkey.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
