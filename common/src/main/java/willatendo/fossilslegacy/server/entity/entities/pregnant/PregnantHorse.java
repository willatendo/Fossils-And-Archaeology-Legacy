...
public class PregnantHorse extends Horse implements DinopediaInformation, PregnantAnimal<Horse> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantHorse.class, FAEntityDataSerializers.MODEL_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantHorse.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
