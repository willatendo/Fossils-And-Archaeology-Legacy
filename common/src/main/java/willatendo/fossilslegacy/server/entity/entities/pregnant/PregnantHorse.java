...
public class PregnantHorse extends Horse implements DinopediaInformation, PregnantAnimal<Horse> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantHorse.class, FAEntityDataSerializers.COAT_TYPES.get());
