...
public final class FAEntityTypes {
    ...
    public static final SimpleHolder<EntityType<Velociraptor>> VELOCIRAPTOR = ENTITY_TYPES.register("velociraptor", () -> SimpleUtils.entityTypeBuilder("velociraptor", Velociraptor::new, MobCategory.CREATURE, 0.5F, 0.65F));
    public static final SimpleHolder<EntityType<Carnotaurus>> CARNOTAURUS = FAEntityTypes.ENTITY_TYPES.register("carnotaurus", () -> SimpleUtils.entityTypeBuilder("carnotaurus", Carnotaurus::new, MobCategory.CREATURE, 0.5F, 0.75F));
    public static final SimpleHolder<EntityType<Cryolophosaurus>> CRYOLOPHOSAURUS = FAEntityTypes.ENTITY_TYPES.register("cryolophosaurus", () -> SimpleUtils.entityTypeBuilder("cryolophosaurus", Cryolophosaurus::new, MobCategory.CREATURE, 0.5F, 0.75F));
    public static final SimpleHolder<EntityType<Therizinosaurus>> THERIZINOSAURUS = FAEntityTypes.ENTITY_TYPES.register("therizinosaurus", () -> SimpleUtils.entityTypeBuilder("therizinosaurus", Therizinosaurus::new, MobCategory.CREATURE, 0.5F, 0.75F));
    ...
    public static final SimpleHolder<EntityType<Compsognathus>> COMPSOGNATHUS = ENTITY_TYPES.register("compsognathus", () -> SimpleUtils.entityTypeBuilder("compsognathus", Compsognathus::new, MobCategory.CREATURE, 0.5F, 0.5F));
