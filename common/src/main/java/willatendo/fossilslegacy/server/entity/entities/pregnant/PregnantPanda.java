...
public class PregnantPanda extends Panda implements DinopediaInformation, PregnantAnimal<Panda> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantPanda.class, FAEntityDataSerializers.MODEL_TYPES.get());
