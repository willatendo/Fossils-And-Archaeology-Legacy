...
public class PregnantPanda extends Panda implements DinopediaInformation, PregnantAnimal<Panda> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantPanda.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantPanda.class, FAEntityDataSerializers.CHROMOSOME.get());
