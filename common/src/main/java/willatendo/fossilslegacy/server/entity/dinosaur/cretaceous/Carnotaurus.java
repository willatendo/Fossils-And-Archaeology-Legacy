...
public class Carnotaurus extends Dinosaur implements DinopediaInformation {
    ...
    public TagKey<CoatType> getCoatTypes() {
        return FossilsLegacyCoatTypeTags.CARNOTAURUS;
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new DinoNearestAttackableTargetGoal<>(this, FossilsLegacyEntityTypeTags.CARNOTAURUS_VICTIMS, true));
    }
    ...
    public Optional<ResourceKey<DinopediaType>> getDinopediaType() {
        return Optional.of(FossilsLegacyDinopediaTypes.CARNOTAURUS);
    }
