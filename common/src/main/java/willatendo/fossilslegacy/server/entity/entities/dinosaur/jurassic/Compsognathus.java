...
public class Compsognathus extends Dinosaur implements DinopediaInformation {
    ...
    public TagKey<CoatType> getCoatTypes() {
        return FACoatTypeTags.COMPSOGNATHUS;
    }
    ...
    protected SoundEvent getAmbientSound() {
        return this.getOverridenSoundEvent(FASoundEvents.COMPSOGNATHUS_AMBIENT.get(), CoatType.OverrideInfo.OverridenSoundType.AMBIENT);
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return this.getOverridenSoundEvent(FASoundEvents.COMPSOGNATHUS_HURT.get(), CoatType.OverrideInfo.OverridenSoundType.HURT);
    }

    @Override
    protected SoundEvent getDeathSound() {
        return this.getOverridenSoundEvent(FASoundEvents.COMPSOGNATHUS_DEATH.get(), CoatType.OverrideInfo.OverridenSoundType.DEATH);
    }
