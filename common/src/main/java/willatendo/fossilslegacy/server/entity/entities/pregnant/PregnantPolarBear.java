...
public class PregnantPolarBear extends PolarBear implements DinopediaInformation, PregnantAnimal<PolarBear> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantPolarBear.class, FAEntityDataSerializers.COAT_TYPES.get());
