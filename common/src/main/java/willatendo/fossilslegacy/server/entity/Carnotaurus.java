...
public class Carnotaurus extends Dinosaur implements DinopediaInformation, SubSpecies {
    ...
    public ResourceLocation[][] textures() {
        return new ResourceLocation[][]{{FossilsLegacyUtils.resource("textures/entity/carnotaurus/green_carnotaurus.png")}, {FossilsLegacyUtils.resource("textures/entity/animals/red_carnotaurus.png")}};
    }
