...
public class PregnantLlama extends Llama implements DinopediaInformation, PregnantAnimal {
    ...
    private static final EntityDataAccessor<PregnancyType> PREGNANCY = SynchedEntityData.defineId(PregnantLlama.class, FossilsLegacyEntityDataSerializers.PREGNANCY_TYPES.get());
