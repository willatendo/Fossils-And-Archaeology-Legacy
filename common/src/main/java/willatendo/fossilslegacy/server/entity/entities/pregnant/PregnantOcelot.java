...
public class PregnantOcelot extends Ocelot implements DinopediaInformation, PregnantAnimal<Ocelot> {
    private static final EntityDataAccessor<Holder<ModelType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantOcelot.class, FAEntityDataSerializers.MODEL_TYPES.get());
    ...
    private static final EntityDataAccessor<Holder<PregnancyType>> PREGNANCY = SynchedEntityData.defineId(PregnantOcelot.class, FAEntityDataSerializers.PREGNANCY_TYPES.get());
