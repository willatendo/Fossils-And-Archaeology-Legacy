...
public class PregnantOcelot extends Ocelot implements DinopediaInformation, PregnantAnimal<Ocelot> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantOcelot.class, FAEntityDataSerializers.COAT_TYPES.get());
