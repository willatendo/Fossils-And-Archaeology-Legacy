...
public class PregnantFox extends Fox implements DinopediaInformation, PregnantAnimal<Fox> {
    ...
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_1 = SynchedEntityData.defineId(PregnantFox.class, FAEntityDataSerializers.CHROMOSOME.get());
    private static final EntityDataAccessor<Chromosome> CHROMOSOME_2 = SynchedEntityData.defineId(PregnantFox.class, FAEntityDataSerializers.CHROMOSOME.get());
