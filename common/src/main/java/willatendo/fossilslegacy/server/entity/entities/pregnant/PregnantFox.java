...
public class PregnantFox extends Fox implements DinopediaInformation, PregnantAnimal<Fox> {
    private static final EntityDataAccessor<Holder<CoatType>> OFFSPRING_COAT_TYPE = SynchedEntityData.defineId(PregnantFox.class, FAEntityDataSerializers.COAT_TYPES.get());
