...
public final class FAAnalyzerResults {
    ...
    public static final ResourceKey<AnalyzerResult> BAT_DNA = FAAnalyzerResults.create("bat_dna");
    public static final ResourceKey<AnalyzerResult> BEE_DNA = FAAnalyzerResults.create("bee_dna");
    public static final ResourceKey<AnalyzerResult> CAMEL_DNA = FAAnalyzerResults.create("camel_dna");
    public static final ResourceKey<AnalyzerResult> COD_DNA = FAAnalyzerResults.create("cod_dna");
    ...
    public static final ResourceKey<AnalyzerResult> PUFFERFISH_DNA = FAAnalyzerResults.create("pufferfish_dna");
    public static final ResourceKey<AnalyzerResult> SALMON_DNA = FAAnalyzerResults.create("salmon_dna");
    ...
    public static final ResourceKey<AnalyzerResult> SQUID_DNA = FAAnalyzerResults.create("squid_dna");
    public static final ResourceKey<AnalyzerResult> TROPICAL_FISH_DNA = FAAnalyzerResults.create("tropical_fish_dna");
    public static final ResourceKey<AnalyzerResult> TURTLE_DNA = FAAnalyzerResults.create("turtle_dna");
    ...
    public static void bootstrap(BootstrapContext<AnalyzerResult> bootstrapContext) {
        ...
        FAAnalyzerResults.register(bootstrapContext, BAT_DNA, new ItemStack(FAItems.BAT_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, BEE_DNA, new ItemStack(FAItems.BEE_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, CAMEL_DNA, new ItemStack(FAItems.CAMEL_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, COD_DNA, new ItemStack(FAItems.COD_DNA.get()), 100);
        ...
        FAAnalyzerResults.register(bootstrapContext, SALMON_DNA, new ItemStack(FAItems.SALMON_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, SHEEP_DNA, new ItemStack(FAItems.SHEEP_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, PUFFERFISH_DNA, new ItemStack(FAItems.PUFFERFISH_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, RABBIT_DNA, new ItemStack(FAItems.RABBIT_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, SQUID_DNA, new ItemStack(FAItems.SQUID_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, TROPICAL_FISH_DNA, new ItemStack(FAItems.TROPICAL_FISH_DNA.get()), 100);
        FAAnalyzerResults.register(bootstrapContext, TURTLE_DNA, new ItemStack(FAItems.TURTLE_DNA.get()), 100);
