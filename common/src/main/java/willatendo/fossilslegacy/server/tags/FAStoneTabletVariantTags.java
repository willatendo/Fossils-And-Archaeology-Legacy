...
public class FAStoneTabletVariantTags {
    public static final TagRegister<StoneTabletVariant> STONE_TABLET_VARIANT_TAGS = TagRegister.create(FARegistries.STONE_TABLET_VARIANTS, FossilsLegacyUtils.ID);
