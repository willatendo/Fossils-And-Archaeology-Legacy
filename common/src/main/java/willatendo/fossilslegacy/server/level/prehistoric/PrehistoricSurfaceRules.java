...
public class PrehistoricSurfaceRules {
    ...
    public static SurfaceRules.RuleSource prehistoric() {
        ...
        SurfaceRules.ConditionSource isWarmOceanOrBeach = SurfaceRules.isBiome(new ResourceKey[]{FABiomes.PREHISTORIC_BEACH});
        SurfaceRules.ConditionSource isDesert = SurfaceRules.isBiome(new ResourceKey[]{FABiomes.PREHISTORIC_DESERT});
