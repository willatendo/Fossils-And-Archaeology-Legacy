...
public class PrehistoricSurfaceRules {
    ...
    public static SurfaceRules.RuleSource prehistoric() {
        ...
        SurfaceRules.RuleSource sandyBeach = SurfaceRules.ifTrue(isWarmOceanOrBeach, SurfaceRules.ifTrue(SurfaceRules.DEEP_UNDER_FLOOR, SANDSTONE));
        SurfaceRules.RuleSource coldDesert = SurfaceRules.ifTrue(isColdDesert, SurfaceRules.ifTrue(SurfaceRules.VERY_DEEP_UNDER_FLOOR, SANDSTONE));
        SurfaceRules.RuleSource redDesert = SurfaceRules.ifTrue(isRedDesert, SurfaceRules.ifTrue(SurfaceRules.VERY_DEEP_UNDER_FLOOR, RED_SANDSTONE));
