...
public final class PrehistoricSurfaceRules {
    ...
    public static SurfaceRules.RuleSource prehistoric() {
        ...
        SurfaceRules.RuleSource swamp = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(FABiomes.PREHISTORIC_SWAMP, FABiomes.RAINY_FLOODPLAINS), SurfaceRules.ifTrue(y62, SurfaceRules.ifTrue(SurfaceRules.not(y63Multi), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SWAMP, 0.0), WATER)))));
