...
public final class FARegistries {
    ...
    public static final ResourceKey<Registry<KeyDispatchDataCodec<? extends InheritanceRules.ConditionSource>>> INHERITANCE_CONDITION = ResourceKey.createRegistryKey(FAUtils.resource("inheritance_condition"));
    public static final ResourceKey<Registry<KeyDispatchDataCodec<? extends InheritanceRules.RuleSource>>> INHERITANCE_RULE = ResourceKey.createRegistryKey(FAUtils.resource("inheritance_rule"));
    ...
    public static final ResourceKey<Registry<TextureInformationType<?>>> TEXTURE_INFORMATION_TYPE = ResourceKey.createRegistryKey(FAUtils.resource("texture_information_type"));
