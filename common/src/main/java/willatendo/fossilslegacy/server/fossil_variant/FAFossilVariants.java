...
public final class FAFossilVariants {
    ...
    public static void bootstrap(BootstrapContext<FossilVariant> bootstrapContext) {
        ...
        FAFossilVariants.registerMesozoic(bootstrapContext, DIMETRODON, 12, "dimetrodon", FAUtils.resource("dimetrodon"), 5, 60.0F, 0.5F, 0.5F, 0.05F, 0.5F, 0.5F, 0.075F, 0.15F, 0.05F);
