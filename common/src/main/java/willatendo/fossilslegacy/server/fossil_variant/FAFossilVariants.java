...
public final class FAFossilVariants {
    ...
    public static final ResourceKey<FossilVariant> SMILODON = FAFossilVariants.create("smilodon");
    ...
    public static void bootstrap(BootstrapContext<FossilVariant> bootstrapContext) {
        ...
        FAFossilVariants.registerMesozoic(bootstrapContext, MOA, 8, "moa", FAUtils.resource("moa"), 4, 45.0F, 2, 0.5F, 1.5F, 0.1F, 0.5F, 0.5F, 0.25F, 0.15F, 0.1F);
        ...
        FAFossilVariants.registerMesozoic(bootstrapContext, SMILODON, 8, "smilodon", FAUtils.resource("smilodon"), 5, 60.0F, -3, 0.75F, 0.75F, 0.1F, 0.7F, 0.7F, 0.1F, 0.5F, 0.05F);
