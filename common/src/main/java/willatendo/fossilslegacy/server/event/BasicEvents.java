...
public class BasicEvents {
    ...
    public static void villagerTradesEvent(VillagerTradeModification villagerTradeModification) {
        ...
        villagerTradeModification.add(FossilsLegacyVillagerProfessions.PALAEONTOLOGIST.get(), List.of(new VillagerTrades.EmeraldForItems(FossilsLegacyItems.FOSSIL.get(), 5, 16, 2), new VillagerTrades.EmeraldForItems(FossilsLegacyItems.FROZEN_MEAT.get(), 5, 16, 2)), List.of(new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.DINOPEDIA.get(), 10, 1, 4, 4), new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.THERIZINOSAURUS_CLAWS.get(), 25, 1, 16, 2), new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.TYRANNOSAURUS_TOOTH.get(), 30, 1, 16, 2), new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.NAUTILUS_SHELL.get(), 10, 1, 16, 2)), List.of(new VillagerTrades.ItemsAndEmeraldsToItems(new ItemStack(FossilsLegacyBlocks.FOSSIL_ORE.get()).getItem(), 1, 10, new ItemStack(FossilsLegacyBlocks.DEEPSLATE_FOSSIL_ORE.get()).getItem(), 1, 8, 3, 15), new VillagerTrades.EmeraldForItems(new ItemStack(FossilsLegacyBlocks.SKULL_BLOCK.get()).getItem(), 10, 16, 3), new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.LEPIDODENDRON_DNA.get(), 20, 1, 1, 2)), List.of(new VillagerTrades.EmeraldForItems(FossilsLegacyItems.JURASSIC_FERN_SPORES.get(), 3, 8, 6), new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.CALAMITES_DNA.get(), 20, 1, 4, 12), new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.LEPIDODENDRON_DNA.get(), 20, 1, 4, 12), new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.SIGILLARIA_DNA.get(), 20, 1, 4, 12)), List.of(new VillagerTrades.ItemsForEmeralds(FossilsLegacyItems.LEGACY_GENETIC_CODE.get(), 30, 1, 12)));
    }
