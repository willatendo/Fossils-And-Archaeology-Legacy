...
public final class FAModelTypes {
    ...
    public static final ResourceKey<ModelType> ISOTELUS_LARVA = FAModelTypes.create("isotelus_larva");
    ...
    public static void bootstrap(BootstrapContext<ModelType> bootstrapContext) {
        ...
        FAModelTypes.register(bootstrapContext, ISOTELUS_LARVA, ModelType.build(Component.translatable("model_type.fossilslegacy.isotelus_larva"), 0xCBA840, 3.0F, -1.0F, FAUtils.resource("isotelus_larva"), FAPatternTags.ISOTELUS_LARVA_2025_SKINS, FAPatternTags.ISOTELUS_LARVA_2025_PATTERNS, 0.15F, 0.15F, 0.0F, 1.0F, 1.0F, 0.0F, 0.1F, 0.0F).build());
