...
public final class FAModelTypes {
    ...
    public static void bootstrap(BootstrapContext<ModelType> bootstrapContext) {
        ...
        FAModelTypes.register(bootstrapContext, MOSASAURUS, ModelType.build(Component.translatable("model_type.fossilslegacy.mosasaurus"), 0x0D7346, 0.9F, 0.25F, FAUtils.resource("mosasaurus"), FAPatternTags.MOSASAURUS_2024_SKINS, FAPatternTags.MOSASAURUS_2024_PATTERNS, 0.5F, 0.5F, 0.1F, 0.5F, 0.5F, 0.5125F, 0.5F, 0.1F).build());
        ...
        FAModelTypes.register(bootstrapContext, PTERANODON, ModelType.build(Component.translatable("model_type.fossilslegacy.pteranodon"), 0x7C5D89, 1.5F, 0.0F, FAUtils.resource("pteranodon"), FAPatternTags.PTERANODON_2024_SKINS, FAPatternTags.PTERANODON_2024_PATTERNS, 0.5F, 0.5F, 0.2F, 0.8F, 0.8F, 0.2F, 0.5F, 0.075F).build());
        ...
        FAModelTypes.register(bootstrapContext, STEGOSAURUS, ModelType.build(Component.translatable("model_type.fossilslegacy.stegosaurus"), 0x8BE400, 1.0F, 0.5F, FAUtils.resource("stegosaurus"), FAPatternTags.STEGOSAURUS_2024_SKINS, FAPatternTags.STEGOSAURUS_2024_PATTERNS, 0.75F, 0.75F, 0.2F, 0.8F, 0.8F, 0.2F, 1.0F, 0.1F).build());
        FAModelTypes.register(bootstrapContext, THERIZINOSAURUS, ModelType.build(Component.translatable("model_type.fossilslegacy.therizinosaurus"), 0xCE551D, 1.25F, 1.0F, FAUtils.resource("therizinosaurus"), FAPatternTags.THERIZINOSAURUS_2024_SKINS, FAPatternTags.THERIZINOSAURUS_2024_PATTERNS, 0.5F, 0.5F, 0.35F, 0.5F, 0.5F, 0.25F, 0.75F, 0.1F).build());
        FAModelTypes.register(bootstrapContext, TRICERATOPS, ModelType.build(Component.translatable("model_type.fossilslegacy.triceratops"), 0xADE642, 1.0F, 0.0F, FAUtils.resource("triceratops"), FAPatternTags.TRICERATOPS_2024_SKINS, FAPatternTags.TRICERATOPS_2024_PATTERNS, 1.0F, 1.0F, 0.2F, 1.0F, 1.0F, 0.15F, 1.0F, 0.1F).build());
