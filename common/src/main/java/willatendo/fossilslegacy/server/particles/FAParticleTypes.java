...
import willatendo.simplelibrary.server.registry.ParticleRegistry;
import willatendo.simplelibrary.server.registry.SimpleHolder;
import willatendo.simplelibrary.server.registry.SimpleRegistry;

public class FAParticleTypes {
    public static final ParticleRegistry PARTICLE_TYPES = SimpleRegistry.createParticle(FAUtils.ID);
