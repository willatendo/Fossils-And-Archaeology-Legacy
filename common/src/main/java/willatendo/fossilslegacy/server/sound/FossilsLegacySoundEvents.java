...
public class FossilsLegacySoundEvents {
    ...
    public static final SimpleHolder<SoundEvent> COMPSOGNATHUS_AMBIENT = SOUND_EVENTS.register("entity.compsognathus.ambient", () -> SoundEvent.createVariableRangeEvent(FossilsLegacyUtils.resource("entity.compsognathus.ambient")));
    public static final SimpleHolder<SoundEvent> COMPSOGNATHUS_HURT = SOUND_EVENTS.register("entity.compsognathus.hurt", () -> SoundEvent.createVariableRangeEvent(FossilsLegacyUtils.resource("entity.compsognathus.hurt")));
    public static final SimpleHolder<SoundEvent> COMPSOGNATHUS_DEATH = SOUND_EVENTS.register("entity.compsognathus.death", () -> SoundEvent.createVariableRangeEvent(FossilsLegacyUtils.resource("entity.compsognathus.death")));
