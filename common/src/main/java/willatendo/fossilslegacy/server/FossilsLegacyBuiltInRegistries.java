...
public class FossilsLegacyBuiltInRegistries {
    public static final RegistryHolder<EggVariant> EGG_VARIANTS = FossilsModloaderHelper.INSTANCE.<EggVariant>createRegistry(FossilsLegacyRegistries.EGG_VARIANTS);
