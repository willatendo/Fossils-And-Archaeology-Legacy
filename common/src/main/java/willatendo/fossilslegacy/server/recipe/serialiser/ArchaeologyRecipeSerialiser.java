...
public class ArchaeologyRecipeSerialiser implements RecipeSerializer<ArchaeologyRecipe> {
    private static final MapCodec<ArchaeologyRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(ArchaeologyBookCategory.CODEC.fieldOf("category").orElse(ArchaeologyBookCategory.MISC).forGetter(archaeologyRecipe -> archaeologyRecipe.archaeologyBookCategory), Codec.STRING.optionalFieldOf("group", "").forGetter(archaeologyRecipe -> archaeologyRecipe.group), Ingredient.CODEC.fieldOf("ingredient").forGetter(archaeologyRecipe -> archaeologyRecipe.ingredient), ItemStack.STRICT_SINGLE_ITEM_CODEC.fieldOf("result").forGetter(archaeologyRecipe -> archaeologyRecipe.result), Codec.INT.fieldOf("time").orElse(100).forGetter(archaeologyRecipe -> archaeologyRecipe.time)).apply(instance, ArchaeologyRecipe::new));
