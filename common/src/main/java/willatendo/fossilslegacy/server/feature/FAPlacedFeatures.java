...
public final class FAPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapContext) {
        ...
        // Ores
        PlacementUtils.register(bootstrapContext, ORE_FOSSIL, configuredFeatures.getOrThrow(FAConfiguredFeatures.ORE_FOSSIL), FAPlacedFeatures.commonOrePlacement(25, HeightRangePlacement.triangle(VerticalAnchor.absolute(10), VerticalAnchor.absolute(128))));
