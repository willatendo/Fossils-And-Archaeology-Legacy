...
public class BuiltInDinopediaLines implements DinopediaLine {
    ...
    public static final BuiltInDinopediaLines EGG_DISPLAY_NAME = BuiltInDinopediaLines.createEgg("egg_display_name", dinosaur -> FAUtils.translation("dinopedia", "egg", dinosaur.getEggVariant().value().entityType().get().getDescription().getString()), BuiltInDinopediaLines::alwaysTrue);
    ...
    public static final BuiltInDinopediaLines STATUS = BuiltInDinopediaLines.createEgg("status", dinosaur -> FAUtils.translation("dinopedia", "status", dinosaur.getEggVariant().value().getTemperature(dinosaur)), BuiltInDinopediaLines::alwaysTrue);
