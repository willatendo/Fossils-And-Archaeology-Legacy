...
public final class PrehistoricBiomeBuilder {
    ...
    public PrehistoricBiomeBuilder() {
        ...
        this.MIDDLE_BIOMES = new ResourceKey[][]{{FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_TAIGA}, {FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_TAIGA, FossilsLegacyBiomes.PREHISTORIC_TAIGA}, {FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_FOREST}, {FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_JUNGLE, FossilsLegacyBiomes.PREHISTORIC_JUNGLE}, {FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT}};
        this.PLATEAU_BIOMES = new ResourceKey[][]{{FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_TAIGA, FossilsLegacyBiomes.PREHISTORIC_TAIGA}, {FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_TAIGA, FossilsLegacyBiomes.PREHISTORIC_TAIGA}, {FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_FOREST}, {FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_PLAINS, FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_FOREST, FossilsLegacyBiomes.PREHISTORIC_JUNGLE}, {FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT, FossilsLegacyBiomes.PREHISTORIC_DESERT}};
    }

    protected void addBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> point) {
    ...
    private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> point) {
        ...
        point.accept(Pair.of(Climate.parameters(this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.point(0.0F), this.FULL_RANGE, 0.01F), FossilsLegacyBiomes.PREHISTORIC_PLAINS));
        ...
        if (erosionOffsetSpline instanceof CubicSpline.Multipoint<?, ?> multipoint) {
            ResourceKey<Biome> desert = FossilsLegacyBiomes.PREHISTORIC_DESERT;
        ...
        if (overworldOffset instanceof CubicSpline.Multipoint<?, ?> multipoint) {
            ...
            for (int i = 0; i < locations.length; ++i) {
                location = locations[i];
                point.accept(Pair.of(Climate.parameters(this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.point(location), this.FULL_RANGE, Climate.Parameter.point(0.0F), this.FULL_RANGE, 0.0F), FossilsLegacyBiomes.PREHISTORIC_TAIGA));
            }
        }
    ...
    private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> point) {
        for (int i = 0; i < this.temperatures.length; ++i) {
            ...
            this.addSurfaceBiome(point, temperature, this.FULL_RANGE, this.deepOceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, FossilsLegacyBiomes.DEEP_PREHISTORIC_OCEAN);
            this.addSurfaceBiome(point, temperature, this.FULL_RANGE, this.oceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, FossilsLegacyBiomes.PREHISTORIC_OCEAN);
        }
    ...
    private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> point, Climate.Parameter span) {
        this.addSurfaceBiome(point, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_BEACH);
        this.addSurfaceBiome(point, Climate.Parameter.span(this.temperatures[1], this.temperatures[2]), this.FULL_RANGE, Climate.Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_SWAMP);
    ...
    private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> point, Climate.Parameter span) {
        this.addSurfaceBiome(point, this.FROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), span, 0.0F, span.max() < 0L ? FossilsLegacyBiomes.PREHISTORIC_BEACH : FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, this.UNFROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), span, 0.0F, span.max() < 0L ? FossilsLegacyBiomes.PREHISTORIC_BEACH : FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, this.FROZEN_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, this.UNFROZEN_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, this.FROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, this.FROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, this.erosions[6], span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, this.UNFROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, this.erosions[6], span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_RIVER);
        this.addSurfaceBiome(point, Climate.Parameter.span(this.temperatures[1], this.temperatures[2]), this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_SWAMP);
        this.addSurfaceBiome(point, this.FROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_RIVER);
        ...
        for (int temperatureIndex = 0; temperatureIndex < this.temperatures.length; ++temperatureIndex) {
            ...
            for (int humitityIndex = 0; humitityIndex < this.humidities.length; ++humitityIndex) {
                ...
                this.addSurfaceBiome(point, temperature, humidity, Climate.Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[0], this.erosions[1]), span, 0.0F, FossilsLegacyBiomes.PREHISTORIC_PLAINS);
            }
        }
    ...
    private ResourceKey<Biome> pickBeachBiome(int temperature, int humidity) {
        return temperature == 4 ? FossilsLegacyBiomes.PREHISTORIC_DESERT : FossilsLegacyBiomes.PREHISTORIC_BEACH;
    }
