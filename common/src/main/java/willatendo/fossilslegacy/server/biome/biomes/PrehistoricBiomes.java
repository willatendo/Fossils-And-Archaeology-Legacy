...
public final class PrehistoricBiomes {
    private static Biome aridPlains(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> configuredWorldCarvers, boolean forest) {
        ...
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.ZAMITES_PATCH));
    ...
    private static Biome rainyFloodplains(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> configuredWorldCarvers) {
        MobSpawnSettings.Builder mobSpawnSettings = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder(placedFeatures, configuredWorldCarvers);
        FABiomes.globalPrehistoricGeneration(biomeGenerationSettings);
        BiomeDefaultFeatures.addDefaultOres(biomeGenerationSettings);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeGenerationSettings);
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.TREES_HELL_CREEK));
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.CYCADEOIDEA_PATCH));
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.SHORT_HORSETAIL_PATCH));
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.TALL_HORSETAIL_PATCH));
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.FERN_PATCH));
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.MOSS_PATCH));
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.SALVINIA_PATCH));
        biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(FAPlacedFeatures.LOTUS_PATCH));
        return FABiomes.biome(true, 0.8F, 0.9F, mobSpawnSettings, biomeGenerationSettings, FABiomes.NORMAL_MUSIC);
    }
    ...
    private static Biome river(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> configuredWorldCarvers, float temperature, float downfall) {
        MobSpawnSettings.Builder mobSpawnSettings = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder(placedFeatures, configuredWorldCarvers);
        FABiomes.globalPrehistoricGeneration(biomeGenerationSettings);
        BiomeDefaultFeatures.addDefaultOres(biomeGenerationSettings);
        ...
        return FABiomes.biome(true, temperature, downfall, mobSpawnSettings, biomeGenerationSettings, FABiomes.NORMAL_MUSIC);
    }

    private static Biome beach(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> configuredWorldCarvers, float temperature, float downfall) {
        MobSpawnSettings.Builder mobSpawnSettings = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder(placedFeatures, configuredWorldCarvers);
        FABiomes.globalPrehistoricGeneration(biomeGenerationSettings);
        BiomeDefaultFeatures.addDefaultOres(biomeGenerationSettings);
    ...
    public static void bootstrap(BootstrapContext<Biome> bootstrapContext, HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> configuredWorldCarvers) {
        ...
        bootstrapContext.register(FABiomes.RAINY_FLOODPLAINS, PrehistoricBiomes.rainyFloodplains(placedFeatures, configuredWorldCarvers));
        ...
        bootstrapContext.register(FABiomes.COLD_PREHISTORIC_RIVER, PrehistoricBiomes.river(placedFeatures, configuredWorldCarvers, 0.0F, 0.5F));
        bootstrapContext.register(FABiomes.PREHISTORIC_RIVER, PrehistoricBiomes.river(placedFeatures, configuredWorldCarvers, 0.5F, 0.5F));
        bootstrapContext.register(FABiomes.WARM_PREHISTORIC_RIVER, PrehistoricBiomes.river(placedFeatures, configuredWorldCarvers, 1.5F, 0.0F));
        bootstrapContext.register(FABiomes.COLD_PREHISTORIC_BEACH, PrehistoricBiomes.beach(placedFeatures, configuredWorldCarvers, 0.25F, 0.5F));
        bootstrapContext.register(FABiomes.PREHISTORIC_BEACH, PrehistoricBiomes.beach(placedFeatures, configuredWorldCarvers, 0.5F, 0.5F));
        bootstrapContext.register(FABiomes.WARM_PREHISTORIC_BEACH, PrehistoricBiomes.beach(placedFeatures, configuredWorldCarvers, 1.5F, 0.0F));
    }
}
