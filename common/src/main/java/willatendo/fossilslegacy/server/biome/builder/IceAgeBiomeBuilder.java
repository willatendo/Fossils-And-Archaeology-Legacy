...
public final class IceAgeBiomeBuilder {
    ...
    public IceAgeBiomeBuilder() {
        ...
        this.middleBiomes = new ResourceKey[][]{{FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_FOREST}, {FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_FOREST, FABiomes.FROZEN_FOREST, FABiomes.FROZEN_FOREST}, {FABiomes.COLD_FOREST, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS}, {FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS}, {FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS}};
        this.plateauBiomes = new ResourceKey[][]{{FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_FOREST, FABiomes.FROZEN_FOREST}, {FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_PLAINS, FABiomes.FROZEN_FOREST, FABiomes.FROZEN_FOREST, FABiomes.FROZEN_FOREST}, {FABiomes.COLD_FOREST, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS}, {FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS}, {FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS, FABiomes.COLD_PLAINS}};
