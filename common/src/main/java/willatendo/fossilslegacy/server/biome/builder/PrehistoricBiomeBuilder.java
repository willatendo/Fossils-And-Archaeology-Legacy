...
public final class PrehistoricBiomeBuilder {
    ...
    public PrehistoricBiomeBuilder() {
        ...
        this.middleBiomes = new ResourceKey[][]{{FABiomes.PREHISTORIC_PLAINS, FABiomes.PREHISTORIC_PLAINS, FABiomes.PREHISTORIC_PLAINS, FABiomes.PREHISTORIC_PLAINS, FABiomes.PREHISTORIC_TAIGA}, {FABiomes.PREHISTORIC_PLAINS, FABiomes.PREHISTORIC_PLAINS, FABiomes.PREHISTORIC_FOREST, FABiomes.PREHISTORIC_TAIGA, FABiomes.PREHISTORIC_TAIGA}, {FABiomes.PREHISTORIC_FOREST, FABiomes.ARID_PLAINS, FABiomes.ARID_PLAINS, FABiomes.ARID_FOREST, FABiomes.RAINY_FLOODPLAINS}, {FABiomes.PREHISTORIC_PLAINS, FABiomes.ARID_PLAINS, FABiomes.ARID_FOREST, FABiomes.RAINY_FLOODPLAINS, FABiomes.RAINY_FLOODPLAINS}, {FABiomes.COLD_DESERT, FABiomes.COLD_DESERT, FABiomes.COLD_DESERT, FABiomes.RED_DESERT, FABiomes.RED_DESERT}};
    ...
    private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> point) {
        ...
        if (erosionOffsetSpline instanceof CubicSpline.Multipoint<?, ?> multipoint) {
            ResourceKey<Biome> desert = FABiomes.RED_DESERT;
