...
public class FossilsLegacyStructures {
    ...
    public static void bootstrap(BootstrapContext<Structure> bootstrapContext) {
        ...
        bootstrapContext.register(TOTEM_POLE, new JigsawStructure(new Structure.StructureSettings.Builder(biomes.getOrThrow(FossilsLegacyBiomeTags.HAS_TOTEM_POLE)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), structureTemplatePools.getOrThrow(TotemPolePools.START), 7, ConstantHeight.of(VerticalAnchor.absolute(0)), false, Heightmap.Types.WORLD_SURFACE_WG));
