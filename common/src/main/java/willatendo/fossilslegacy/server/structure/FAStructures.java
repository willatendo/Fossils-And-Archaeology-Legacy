...
public final class FAStructures {
    ...
    public static final ResourceKey<Structure> CHINESE_WARSHIP = FAStructures.create("chinese_warship");
    ...
    public static final ResourceKey<Structure> VIKING_SHIP = FAStructures.create("viking_ship");
    ...
    public static void bootstrap(BootstrapContext<Structure> bootstrapContext) {
        ...
        bootstrapContext.register(CHINESE_WARSHIP, new JigsawStructure(new Structure.StructureSettings.Builder(biomes.getOrThrow(FABiomeTags.HAS_CHINESE_WARSHIP)).terrainAdapation(TerrainAdjustment.NONE).build(), structureTemplatePools.getOrThrow(ChineseWarshipPools.START), 7, ConstantHeight.of(VerticalAnchor.absolute(0)), false, Heightmap.Types.WORLD_SURFACE_WG));
        ...
        bootstrapContext.register(VIKING_SHIP, new JigsawStructure(new Structure.StructureSettings.Builder(biomes.getOrThrow(FABiomeTags.HAS_VIKING_SHIP)).terrainAdapation(TerrainAdjustment.NONE).build(), structureTemplatePools.getOrThrow(VikingShipPools.START), 7, ConstantHeight.of(VerticalAnchor.absolute(0)), false, Heightmap.Types.WORLD_SURFACE_WG));
