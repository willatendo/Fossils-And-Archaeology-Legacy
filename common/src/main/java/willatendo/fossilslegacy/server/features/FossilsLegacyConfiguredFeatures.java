...
public class FossilsLegacyConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapContext) {
        ...
        FeatureUtils.register(bootstapContext, TREES_PREHISTORIC_WATER, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeature.getOrThrow(FossilsLegacyPlacedFeatures.PREHISTORIC_FANCY_OAK_CHECKED), 0.1F)), placedFeature.getOrThrow(FossilsLegacyPlacedFeatures.PREHISTORIC_OAK_CHECKED)));
        FeatureUtils.register(bootstapContext, TREES_PREHISTORIC_TAIGA, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeature.getOrThrow(FossilsLegacyPlacedFeatures.PREHISTORIC_PINE_CHECKED), 0.33333334F)), placedFeature.getOrThrow(FossilsLegacyPlacedFeatures.PREHISTORIC_SPRUCE_CHECKED)));
        FeatureUtils.register(bootstapContext, TREES_PREHISTORIC_JUNGLE, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeature.getOrThrow(FossilsLegacyPlacedFeatures.PREHISTORIC_FANCY_OAK_CHECKED), 0.1F), new WeightedPlacedFeature(placedFeature.getOrThrow(TreePlacements.JUNGLE_BUSH), 0.5F), new WeightedPlacedFeature(placedFeature.getOrThrow(FossilsLegacyPlacedFeatures.MEGA_PREHISTORIC_JUNGLE_TREE_CHECKED), 0.33333334F)), placedFeature.getOrThrow(FossilsLegacyPlacedFeatures.PREHISTORIC_JUNGLE_TREE_CHECKED)));
    }
}
