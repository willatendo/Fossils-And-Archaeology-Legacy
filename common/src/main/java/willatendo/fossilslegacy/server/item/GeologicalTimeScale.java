...
public final class GeologicalTimeScale {
    public interface TimeScaleDescription {
    ...
    public static TimeScaleDescription range(GeologicalTimeScale.Period from, GeologicalTimeScale.Period to) {
    ...
    public enum Era implements TimeScaleDescription {
    ...
    public enum Period implements TimeScaleDescription {
