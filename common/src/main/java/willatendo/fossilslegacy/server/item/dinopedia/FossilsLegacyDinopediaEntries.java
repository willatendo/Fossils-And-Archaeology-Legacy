...
public class FossilsLegacyDinopediaEntries {
    ...
    public static final ResourceKey<DinopediaEntry> EGG_DATA = FossilsLegacyDinopediaEntries.create("egg_data");
    ...
    public static final ResourceKey<DinopediaEntry> PREGNANCY_DATA = FossilsLegacyDinopediaEntries.create("pregnancy_data");
    ...
    public static void bootstrap(BootstrapContext<DinopediaEntry> bootstrapContext) {
        ...
        FossilsLegacyDinopediaEntries.register(bootstrapContext, EGG_DATA, DinopediaEntry.of().addText(BuiltInDinopediaLines.EGG_DISPLAY_NAME, BuiltInDinopediaLines.REMAINING_TIME, BuiltInDinopediaLines.STATUS).drawEntity().centerText());
        ...
        FossilsLegacyDinopediaEntries.register(bootstrapContext, PREGNANCY_DATA, DinopediaEntry.of().addText(BuiltInDinopediaLines.PREGNANT_DISPLAY_NAME, BuiltInDinopediaLines.PREGNANT_HEALTH, BuiltInDinopediaLines.PREGNANCY_TIME, BuiltInDinopediaLines.PREGNANCY_TYPE).drawEntity().centerText());
