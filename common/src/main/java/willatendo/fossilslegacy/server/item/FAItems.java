...
public final class FAItems {
    ...
    public static final SimpleHolder<BoatItem> LEPIDODENDRON_BOAT = ITEMS.registerBoat("lepidodendron_boat", FAEntityTypes.LEPIDODENDRON_BOAT.get());
    public static final SimpleHolder<BoatItem> LEPIDODENDRON_CHEST_BOAT = ITEMS.registerChestBoat("lepidodendron_chest_boat", FAEntityTypes.LEPIDODENDRON_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> SIGILLARIA_BOAT = ITEMS.registerBoat("sigillaria_boat", FAEntityTypes.SIGILLARIA_BOAT.get());
    public static final SimpleHolder<BoatItem> SIGILLARIA_CHEST_BOAT = ITEMS.registerChestBoat("sigillaria_chest_boat", FAEntityTypes.SIGILLARIA_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> CALAMITES_BOAT = ITEMS.registerBoat("calamites_boat", FAEntityTypes.CALAMITES_BOAT.get());
    public static final SimpleHolder<BoatItem> CALAMITES_CHEST_BOAT = ITEMS.registerChestBoat("calamites_chest_boat", FAEntityTypes.CALAMITES_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> ARCHAEOPTERIS_BOAT = ITEMS.registerBoat("archaeopteris_boat", FAEntityTypes.ARCHAEOPTERIS_BOAT.get());
    public static final SimpleHolder<BoatItem> ARCHAEOPTERIS_CHEST_BOAT = ITEMS.registerChestBoat("archaeopteris_chest_boat", FAEntityTypes.ARCHAEOPTERIS_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> GINKGO_BOAT = ITEMS.registerBoat("ginkgo_boat", FAEntityTypes.GINKGO_BOAT.get());
    public static final SimpleHolder<BoatItem> GINKGO_CHEST_BOAT = ITEMS.registerChestBoat("ginkgo_chest_boat", FAEntityTypes.GINKGO_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> ARAUCARIA_BOAT = ITEMS.registerBoat("araucaria_boat", FAEntityTypes.ARAUCARIA_BOAT.get());
    public static final SimpleHolder<BoatItem> ARAUCARIA_CHEST_BOAT = ITEMS.registerChestBoat("araucaria_chest_boat", FAEntityTypes.ARAUCARIA_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> ARAUCARIOXYLON_BOAT = ITEMS.registerBoat("araucarioxylon_boat", FAEntityTypes.ARAUCARIOXYLON_BOAT.get());
    public static final SimpleHolder<BoatItem> ARAUCARIOXYLON_CHEST_BOAT = ITEMS.registerChestBoat("araucarioxylon_chest_boat", FAEntityTypes.ARAUCARIOXYLON_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> CORDAITES_BOAT = ITEMS.registerBoat("cordaites_boat", FAEntityTypes.CORDAITES_BOAT.get());
    public static final SimpleHolder<BoatItem> CORDAITES_CHEST_BOAT = ITEMS.registerChestBoat("cordaites_chest_boat", FAEntityTypes.CORDAITES_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> WOLLEMIA_BOAT = ITEMS.registerBoat("wollemia_boat", FAEntityTypes.WOLLEMIA_BOAT.get());
    public static final SimpleHolder<BoatItem> WOLLEMIA_CHEST_BOAT = ITEMS.registerChestBoat("wollemia_chest_boat", FAEntityTypes.WOLLEMIA_CHEST_BOAT.get());
    public static final SimpleHolder<BoatItem> METASEQUOIA_BOAT = ITEMS.registerBoat("metasequoia_boat", FAEntityTypes.METASEQUOIA_BOAT.get());
    public static final SimpleHolder<BoatItem> METASEQUOIA_CHEST_BOAT = ITEMS.registerChestBoat("metasequoia_chest_boat", FAEntityTypes.METASEQUOIA_CHEST_BOAT.get());
