...
public final class FACreativeModeTabs {
    ...
    public static final SimpleHolder<CreativeModeTab> FA_PALAEOBOTANY_ITEMS = CREATIVE_MODE_TABS.register("fa_palaeobotany_items", () -> SimpleUtils.create(FAUtils.ID, "fa_palaeobotany_items", FAItems.LEPIDODENDRON_CONE::get, (itemDisplayParameters, output) -> {
        output.accept(FAItems.CYCAD_DNA.get());
        output.accept(FAItems.GINKGO_DNA.get());
        output.accept(FAItems.HORSETAIL_DNA.get());
        output.accept(FAItems.ARAUCARIA_DNA.get());
