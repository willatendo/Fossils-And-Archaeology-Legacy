...
public final class FACreativeModeTabs {
    ...
    public static final SimpleHolder<CreativeModeTab> FOSSILS_LEGACY = CREATIVE_MODE_TABS.register("fossils_legacy", () -> SimpleUtils.create(FossilsLegacyUtils.ID, FossilsLegacyUtils.ID, () -> FAItems.FOSSIL.get(), (itemDisplayParameters, output) -> {
