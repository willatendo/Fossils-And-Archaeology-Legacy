...
public final class FACreativeModeTabs {
    ...
    public static final SimpleHolder<CreativeModeTab> FA_ITEMS = FACreativeModeTabs.register("fa_items", () -> new ItemStack(FAItems.MESOZOIC_FOSSIL.get()), (itemDisplayParameters, output) -> {
        ...
        output.accept(FAItems.CENOCERAS_SHELL.get());
        output.accept(FAItems.NAUTILUS_MAGIC_CONCH.get());
        output.accept(FAItems.CENOCERAS_MAGIC_CONCH.get());
        output.accept(FAItems.JEEP.get());
    ...
    public static final SimpleHolder<CreativeModeTab> FA_SKELETONS = FACreativeModeTabs.register("fa_skeletons", () -> {
        ItemStack itemStack = new ItemStack(FAItems.ARTICULATED_FOSSIL.get());
        itemStack.set(FADataComponents.FOSSIL_VARIANT.get(), Minecraft.getInstance().level.registryAccess().lookupOrThrow(FARegistries.FOSSIL_VARIANTS).getOrThrow(FAFossilVariants.STEGOSAURUS));
        return itemStack;
    }, (itemDisplayParameters, output) -> {
        FACreativeModeTabs.addFossils(itemDisplayParameters, output, FAFossilVariantTags.CENOZOIC);
        FACreativeModeTabs.addFossils(itemDisplayParameters, output, FAFossilVariantTags.MESOZOIC);
        FACreativeModeTabs.addFossils(itemDisplayParameters, output, FAFossilVariantTags.PALAEOZOIC);
    });
    public static final SimpleHolder<CreativeModeTab> FA_BLOCKS = FACreativeModeTabs.register("fa_blocks", () -> new ItemStack(FABlocks.MESOZOIC_FOSSIL_ORE.get()), (itemDisplayParameters, output) -> {
        ...
        output.accept(FABlocks.SHATTERED_CULTIVATOR.get());
        ...
        output.accept(FABlocks.THATCH_BLOCK.get());
        output.accept(FABlocks.THATCH_STAIRS.get());
        output.accept(FABlocks.THATCH_SLAB.get());
        ...
        FACreativeModeTabs.generateDecorationPlaques(output, itemDisplayParameters.holders().lookupOrThrow(FARegistries.DECORATION_PLAQUE_TYPE));
        ...
        output.accept(FABlocks.NIPA_STEM.get());
        output.accept(FABlocks.NIPA_LEAVES.get());
        output.accept(FABlocks.DRIED_NIPA_LEAVES.get());
        output.accept(FABlocks.ONYCHIOPSIS.get());
        output.accept(FABlocks.PACHYPTERIS.get());
        output.accept(FABlocks.PACHYPODIUM.get());
        output.accept(FABlocks.WILLIAMSONIA.get());
    ...
    private static void addFossils(CreativeModeTab.ItemDisplayParameters itemDisplayParameters, CreativeModeTab.Output output, TagKey<FossilVariant> variants) {
        itemDisplayParameters.holders().lookupOrThrow(FARegistries.FOSSIL_VARIANTS).listElements().filter(fossilVariantHolder -> fossilVariantHolder.is(variants)).sorted(FOSSIL_VARIANT_COMPARATOR).forEach(reference -> {
            ItemStack itemStack = new ItemStack(FAItems.ARTICULATED_FOSSIL.get());
    ...
    private static void generateDecorationPlaques(CreativeModeTab.Output output, HolderLookup.RegistryLookup<DecorationPlaqueType> registryLookup) {
        output.accept(FAItems.DECORATION_PLAQUE.get());
        registryLookup.listElements().sorted(DECORATION_PLAQUE_COMPARATOR).forEach(reference -> {
            ItemStack itemStack = new ItemStack(FAItems.DECORATION_PLAQUE.get());
            itemStack.set(FADataComponents.DECORATION_PLAQUE_TYPE.get(), reference);
            output.accept(itemStack);
        });
    }
