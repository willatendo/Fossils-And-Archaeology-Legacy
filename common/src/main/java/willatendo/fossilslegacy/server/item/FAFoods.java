...
public final class FAFoods {
    ...
    public static final FoodProperties RAW_BIRD = new FoodProperties.Builder().nutrition(3).saturationModifier(0.3F).build();
    ...
    public static final FoodProperties RAW_CHICKEN_SOUP = new FoodProperties.Builder().nutrition(2).saturationModifier(0.3F).build();
