...
public final class FAFoods {
    ...
    public static final FoodProperties RAW_DODO = new FoodProperties.Builder().nutrition(3).saturationModifier(0.3F).effect(new MobEffectInstance(MobEffects.HUNGER, 600, 0), 0.3F).build();
