...
public class FossilsLegacyItems {
    ...
    public static final SimpleHolder<EggItem> BRACHIOSAURUS_EGG = ITEMS.register("brachiosaurus_egg", () -> new EggItem(FossilsLegacyEggVariants.BRACHIOSAURUS, FossilsLegacyCoatTypeTags.BRACHIOSAURUS, new Item.Properties().stacksTo(1)));
    ...
    public static final SimpleHolder<EggItem> CRYOLOPHOSAURUS_EGG = ITEMS.register("cryolophosaurus_egg", () -> new EggItem(FossilsLegacyEggVariants.CRYOLOPHOSAURUS, FossilsLegacyCoatTypeTags.CRYOLOPHOSAURUS, new Item.Properties().stacksTo(1)));
