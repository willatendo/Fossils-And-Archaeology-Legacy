...
public class FossilsLegacyItems {
    ...
    public static final SimpleHolder<SyringeItem> CAT_EMBRYO_SYRINGE = ITEMS.register("cat_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.CAT.get(), new Item.Properties().stacksTo(1)));
    ...
    public static final SimpleHolder<SyringeItem> COW_EMBRYO_SYRINGE = ITEMS.register("cow_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.COW.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> DOLPHIN_EMBRYO_SYRINGE = ITEMS.register("dolphin_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.DOLPHIN.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> DONKEY_EMBRYO_SYRINGE = ITEMS.register("donkey_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.DONKEY.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> FOX_EMBRYO_SYRINGE = ITEMS.register("fox_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.FOX.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> GOAT_EMBRYO_SYRINGE = ITEMS.register("goat_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.GOAT.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> HORSE_EMBRYO_SYRINGE = ITEMS.register("horse_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.HORSE.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> LLAMA_EMBRYO_SYRINGE = ITEMS.register("llama_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.LLAMA.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> MULE_EMBRYO_SYRINGE = ITEMS.register("mule_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.MULE.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> OCELOT_EMBRYO_SYRINGE = ITEMS.register("ocelot_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.OCELOT.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> PANDA_EMBRYO_SYRINGE = ITEMS.register("panda_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.PANDA.get(), new Item.Properties().stacksTo(1)));
    ...
    public static final SimpleHolder<SyringeItem> PIG_EMBRYO_SYRINGE = ITEMS.register("pig_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.PIG.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> POLAR_BEAR_EMBRYO_SYRINGE = ITEMS.register("polar_bear_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.POLAR_BEAR.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> RABBIT_EMBRYO_SYRINGE = ITEMS.register("rabbit_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.RABBIT.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> SHEEP_EMBRYO_SYRINGE = ITEMS.register("sheep_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.SHEEP.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> WOLF_EMBRYO_SYRINGE = ITEMS.register("wolf_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.WOLF.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> SMILODON_EMBRYO_SYRINGE = ITEMS.register("smilodon_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.SMILODON.get(), new Item.Properties().stacksTo(1)));
    public static final SimpleHolder<SyringeItem> MAMMOTH_EMBRYO_SYRINGE = ITEMS.register("mammoth_embryo_syringe", () -> new SyringeItem(() -> FossilsLegacyPregnancyTypes.MAMMOTH.get(), new Item.Properties().stacksTo(1)));
    ...
    public static final SimpleHolder<SpawnEggItem> ANU_SPAWN_EGG = ITEMS.register("anu_spawn_egg", () -> FossilsModloaderHelper.INSTANCE.createSpawnEgg(() -> FossilsLegacyEntityTypes.ANU.get(), 0x432600, 0xa62c14, new Item.Properties()));
    public static final SimpleHolder<SpawnEggItem> FAILURESAURUS_SPAWN_EGG = ITEMS.register("failuresaurus_spawn_egg", () -> FossilsModloaderHelper.INSTANCE.createSpawnEgg(() -> FossilsLegacyEntityTypes.FAILURESAURUS.get(), 0x51e6a5, 0x1b5128, new Item.Properties()));
    ...
    public static final SimpleHolder<SpawnEggItem> NAUTILUS_SPAWN_EGG = ITEMS.register("nautilus_spawn_egg", () -> FossilsModloaderHelper.INSTANCE.createSpawnEgg(() -> FossilsLegacyEntityTypes.NAUTILUS.get(), 0xc1c1c1, 0xa95453, new Item.Properties()));
