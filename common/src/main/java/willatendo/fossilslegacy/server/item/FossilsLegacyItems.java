...
public class FossilsLegacyItems {
    ...
    public static final SimpleHolder<DNAItem> GALLIMIMUS_DNA = ITEMS.register("gallimimus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.GALLIMIMUS, FossilsLegacyEntityTypes.GALLIMIMUS::get));
    ...
    public static final SimpleHolder<DNAItem> MOA_DNA = ITEMS.register("moa_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.MOA, FossilsLegacyEntityTypes.MOA::get));
