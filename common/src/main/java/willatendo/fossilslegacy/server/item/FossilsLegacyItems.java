...
public class FossilsLegacyItems {
    ...
    public static final SimpleHolder<DNAItem> TRICERATOPS_DNA = ITEMS.register("triceratops_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.TRICERATOPS));
    public static final SimpleHolder<DNAItem> VELOCIRAPTOR_DNA = ITEMS.register("velociraptor_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.VELOCIRAPTOR));
    public static final SimpleHolder<DNAItem> TYRANNOSAURUS_DNA = ITEMS.register("tyrannosaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.TYRANNOSAURUS));
    public static final SimpleHolder<DNAItem> PTERANODON_DNA = ITEMS.register("pteranodon_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.PTERANODON));
    public static final SimpleHolder<DNAItem> NAUTILUS_DNA = ITEMS.register("nautilus_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> FUTABASAURUS_DNA = ITEMS.register("futabasaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.FUTABASAURUS));
    public static final SimpleHolder<DNAItem> MOSASAURUS_DNA = ITEMS.register("mosasaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.MOSASAURUS));
    public static final SimpleHolder<DNAItem> STEGOSAURUS_DNA = ITEMS.register("stegosaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.STEGOSAURUS));
    public static final SimpleHolder<DNAItem> DILOPHOSAURUS_DNA = ITEMS.register("dilophosaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.DILOPHOSAURUS));
    public static final SimpleHolder<DNAItem> BRACHIOSAURUS_DNA = ITEMS.register("brachiosaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.BRACHIOSAURUS));
    public static final SimpleHolder<DNAItem> CARNOTAURUS_DNA = ITEMS.register("carnotaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.CARNOTAURUS));
    public static final SimpleHolder<DNAItem> CRYOLOPHOSAURUS_DNA = ITEMS.register("cryolophosaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.CRYOLOPHOSAURUS));
    public static final SimpleHolder<DNAItem> THERIZINOSAURUS_DNA = ITEMS.register("therizinosaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.THERIZINOSAURUS));
    public static final SimpleHolder<DNAItem> PACHYCEPHALOSAURUS_DNA = ITEMS.register("pachycephalosaurus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.PACHYCEPHALOSAURUS));
    public static final SimpleHolder<DNAItem> COMPSOGNATHUS_DNA = ITEMS.register("compsognathus_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.COMPSOGNATHUS));
    ...
    public static final SimpleHolder<DNAItem> CAT_DNA = ITEMS.register("cat_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> CHICKEN_DNA = ITEMS.register("chicken_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> COW_DNA = ITEMS.register("cow_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> DOLPHIN_DNA = ITEMS.register("dolphin_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> DONKEY_DNA = ITEMS.register("donkey_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> FOX_DNA = ITEMS.register("fox_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> FROG_DNA = ITEMS.register("frog_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> GOAT_DNA = ITEMS.register("goat_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> HORSE_DNA = ITEMS.register("horse_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> LLAMA_DNA = ITEMS.register("llama_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> MULE_DNA = ITEMS.register("mule_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> OCELOT_DNA = ITEMS.register("ocelot_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> PANDA_DNA = ITEMS.register("panda_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> PARROT_DNA = ITEMS.register("parrot_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> PIG_DNA = ITEMS.register("pig_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> POLAR_BEAR_DNA = ITEMS.register("polar_bear_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> RABBIT_DNA = ITEMS.register("rabbit_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> SHEEP_DNA = ITEMS.register("sheep_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> WOLF_DNA = ITEMS.register("wolf_dna", () -> new DNAItem(new Item.Properties()));
    public static final SimpleHolder<DNAItem> SMILODON_DNA = ITEMS.register("smilodon_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.SMILODON));
    public static final SimpleHolder<DNAItem> MAMMOTH_DNA = ITEMS.register("mammoth_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.MAMMOTH));
    public static final SimpleHolder<DNAItem> DODO_DNA = ITEMS.register("dodo_dna", () -> new DNAItem(new Item.Properties(), FossilsLegacyCoatTypeTags.DODO));
