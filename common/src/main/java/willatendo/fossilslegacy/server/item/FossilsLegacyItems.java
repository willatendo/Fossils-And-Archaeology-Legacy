...
public class FossilsLegacyItems {
    ...
    public static final SimpleHolder<EggItem> CARNOTAURUS_EGG = ITEMS.register("carnotaurus_egg", () -> new EggItem(FossilsLegacyEggVariants.CARNOTAURUS, FossilsLegacyCoatTypeTags.CARNOTAURUS, new Item.Properties().stacksTo(1)));
