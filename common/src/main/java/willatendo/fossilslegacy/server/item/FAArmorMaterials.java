...
public final class FAArmorMaterials {
    ...
    public static final SimpleHolder<ArmorMaterial> ANCIENT = FAArmorMaterials.register("ancient", Util.make(new EnumMap(ArmorItem.Type.class), (types) -> {
    ...
    public static final SimpleHolder<ArmorMaterial> SCARAB_GEM = FAArmorMaterials.register("scarab_gem", Util.make(new EnumMap(ArmorItem.Type.class), (types) -> {
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_IRON, 5.0F, 0.2F, () -> Ingredient.of(FAItems.SCARAB_GEM.get()));
