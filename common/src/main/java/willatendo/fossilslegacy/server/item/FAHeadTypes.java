...
public enum FAHeadTypes implements StringRepresentable {
    ...
    HERRERASAURUS("herrerasaurus", FAModelGeneTags.HERRERASAURUS, FACompositeTextureRuleSources.HERRERASAURUS_SKIN, FACompositeTextureRuleSources.HERRERASAURUS_PATTERN),
