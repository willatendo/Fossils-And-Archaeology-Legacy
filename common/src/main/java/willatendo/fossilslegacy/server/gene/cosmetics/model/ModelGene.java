package willatendo.fossilslegacy.server.gene.cosmetics.model;
...
public record ModelGene(DisplayInfo displayInfo, Models models, TagKey<SkinGene> skinGenes, TagKey<PatternGene> patternGenes, BoundingBoxInfo boundingBoxInfo, AgeScaleInfo ageScaleInfo, Optional<OverrideInfo> overrideInfo) {
    public static final Codec<ModelGene> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(DisplayInfo.CODEC.fieldOf("display_info").forGetter(ModelGene::displayInfo), Models.CODEC.fieldOf("models").forGetter(ModelGene::models), TagKey.codec(FARegistries.SKIN_GENE).fieldOf("skin_genes").forGetter(ModelGene::skinGenes), TagKey.codec(FARegistries.PATTERN_GENE).fieldOf("pattern_genes").forGetter(ModelGene::patternGenes), BoundingBoxInfo.CODEC.fieldOf("bounding_box_info").forGetter(ModelGene::boundingBoxInfo), AgeScaleInfo.CODEC.fieldOf("age_scale_info").forGetter(ModelGene::ageScaleInfo), OverrideInfo.CODEC.optionalFieldOf("override_info").forGetter(ModelGene::overrideInfo)).apply(instance, ModelGene::new));
    public static final Codec<Holder<ModelGene>> CODEC = RegistryFileCodec.create(FARegistries.MODEL_GENE, DIRECT_CODEC);
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<ModelGene>> STREAM_CODEC = ByteBufCodecs.holderRegistry(FARegistries.MODEL_GENE);
    ...
    public record OverrideInfo(Optional<Component> animalName, Optional<ResourceLocation> ambientSound, Optional<ResourceLocation> hurtSound, Optional<ResourceLocation> deathSound) {
        ...
        public static ModelGene.OverrideInfo.Builder builder() {
            return new Builder();
        }
    ...
    public static Builder build(Component name, int color, float displayScale, float displayYOffset, ResourceLocation model, TagKey<SkinGene> skins, TagKey<PatternGene> patterns, float boundingBoxWidth, float boundingBoxHeight, float boundingBoxGrowth, float baseScaleWidth, float baseScaleHeight, float ageScale, float shadowSize, float shadowGrowth) {
    ...
    public static class Builder {
        ...
        private final TagKey<SkinGene> skins;
        private final TagKey<PatternGene> patterns;
        ...
        private Builder(Component name, int color, float displayScale, float displayYOffset, ResourceLocation model, TagKey<SkinGene> skins, TagKey<PatternGene> patterns, float boundingBoxWidth, float boundingBoxHeight, float boundingBoxGrowth, float baseScaleWidth, float baseScaleHeight, float ageScale, float shadowSize, float shadowGrowth) {
            this.name = name;
            this.color = color;
        ...
        public ModelGene build() {
            return new ModelGene(new DisplayInfo(this.name, this.color, this.displayScale, this.displayYOffset), new Models(this.model, this.flyingModel, this.landingModel, this.knockedOutModel), this.skins, this.patterns, new BoundingBoxInfo(this.boundingBoxWidth, this.boundingBoxHeight, this.boundingBoxGrowth), new AgeScaleInfo(this.baseScaleWidth, this.baseScaleHeight, this.ageScale, this.shadowSize, this.shadowGrowth), this.overrideInfo);
        }
    }
}
