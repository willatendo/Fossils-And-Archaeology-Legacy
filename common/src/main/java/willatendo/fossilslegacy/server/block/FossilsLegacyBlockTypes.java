...
public class FossilsLegacyBlockTypes {
    public static final SimpleRegistry<MapCodec<? extends Block>> BLOCK_TYPES = SimpleRegistry.create(Registries.BLOCK_TYPE, FossilsLegacyUtils.ID);
