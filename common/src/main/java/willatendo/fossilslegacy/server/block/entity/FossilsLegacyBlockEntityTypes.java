...
public class FossilsLegacyBlockEntityTypes {
    ...
    public static final SimpleHolder<BlockEntityType<GeneModificationTableBlockEntity>> GENE_MODIFICATION_TABLE = BLOCK_ENTITY_TYPES.register("gene_modification_table", () -> BlockEntityType.Builder.<GeneModificationTableBlockEntity>of(GeneModificationTableBlockEntity::new, FossilsLegacyBlocks.GENE_MODIFICATION_TABLE.get()).build(null));
