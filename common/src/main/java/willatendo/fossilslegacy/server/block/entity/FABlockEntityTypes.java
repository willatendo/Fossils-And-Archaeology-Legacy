...
public class FABlockEntityTypes {
    ...
    public static final SimpleHolder<BlockEntityType<ShatteredCultivatorBlockEntity>> SHATTERED_CULTIVATOR = BLOCK_ENTITY_TYPES.register("shattered_cultivator", () -> new BlockEntityType<>(ShatteredCultivatorBlockEntity::new, Set.of(FABlocks.SHATTERED_CULTIVATOR.get())));
    ...
    public static final SimpleHolder<BlockEntityType<HologramProjectorBlockEntity>> HOLOGRAM_PROJECTOR = BLOCK_ENTITY_TYPES.register("hologram_projector", () -> new BlockEntityType<>(HologramProjectorBlockEntity::new, Set.of(FABlocks.HOLOGRAM_PROJECTOR.get())));
