...
public final class FABlocks {
    ...
    public static final SimpleHolder<ClaytosmundaBlock> CLAYTOSMUNDA = BLOCKS.registerBlock("claytosmunda", ClaytosmundaBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ));
    public static final SimpleHolder<ClaytosmundaBlock> CYCADEOIDEA = BLOCKS.registerBlock("cycadeoidea", ClaytosmundaBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ));
    public static final SimpleHolder<ClaytosmundaBlock> NIPA = BLOCKS.registerBlock("nipa", ClaytosmundaBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ));
    public static final SimpleHolder<ClaytosmundaBlock> ONYCHIOPSIS = BLOCKS.registerBlock("onychiopsis", ClaytosmundaBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ));
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_ARCHAEOPTERIS_LOG = BLOCKS.registerLog("stripped_archaeopteris_log", MapColor.TERRACOTTA_BROWN, MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_ARCHAEOPTERIS_WOOD = BLOCKS.registerWood("stripped_archaeopteris_wood", MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_GINKGO_LOG = BLOCKS.registerLog("stripped_ginkgo_log", MapColor.TERRACOTTA_BROWN, MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_GINKGO_WOOD = BLOCKS.registerWood("stripped_ginkgo_wood", MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_ARAUCARIA_LOG = BLOCKS.registerLog("stripped_araucaria_log", MapColor.TERRACOTTA_BROWN, MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_ARAUCARIA_WOOD = BLOCKS.registerWood("stripped_araucaria_wood", MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_ARAUCARIOXYLON_LOG = BLOCKS.registerLog("stripped_araucarioxylon_log", MapColor.TERRACOTTA_BROWN, MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_ARAUCARIOXYLON_WOOD = BLOCKS.registerWood("stripped_araucarioxylon_wood", MapColor.TERRACOTTA_BROWN);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_CORDAITES_LOG = BLOCKS.registerLog("stripped_cordaites_log", MapColor.TERRACOTTA_PURPLE, MapColor.TERRACOTTA_PURPLE);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_CORDAITES_WOOD = BLOCKS.registerWood("stripped_cordaites_wood", MapColor.TERRACOTTA_PURPLE);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_WOLLEMIA_LOG = BLOCKS.registerLog("stripped_wollemia_log", MapColor.TERRACOTTA_GRAY, MapColor.TERRACOTTA_GRAY);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_WOLLEMIA_WOOD = BLOCKS.registerWood("stripped_wollemia_wood", MapColor.TERRACOTTA_GRAY);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_METASEQUOIA_LOG = BLOCKS.registerLog("stripped_metasequoia_log", MapColor.TERRACOTTA_RED, MapColor.TERRACOTTA_RED);
    ...
    public static final SimpleHolder<RotatedPillarBlock> STRIPPED_METASEQUOIA_WOOD = BLOCKS.registerWood("stripped_metasequoia_wood", MapColor.TERRACOTTA_RED);
