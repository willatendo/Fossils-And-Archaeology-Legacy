...
public final class FABlocks {
    ...
    public static final SimpleHolder<DropExperienceBlock> CENOZOIC_FOSSIL_ORE = BLOCKS.registerBlock("cenozoic_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F));
    public static final SimpleHolder<DropExperienceBlock> DEEPSLATE_CENOZOIC_FOSSIL_ORE = BLOCKS.registerBlock("deepslate_cenozoic_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE));
    public static final SimpleHolder<DropExperienceBlock> MESOZOIC_FOSSIL_ORE = BLOCKS.registerBlock("mesozoic_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F));
    public static final SimpleHolder<DropExperienceBlock> DEEPSLATE_MESOZOIC_FOSSIL_ORE = BLOCKS.registerBlock("deepslate_mesozoic_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE));
    public static final SimpleHolder<DropExperienceBlock> PALAEOZOIC_FOSSIL_ORE = BLOCKS.registerBlock("palaeozoic_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F));
    public static final SimpleHolder<DropExperienceBlock> DEEPSLATE_PALAEOZOIC_FOSSIL_ORE = BLOCKS.registerBlock("deepslate_palaeozoic_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE));
    public static final SimpleHolder<DropExperienceBlock> AMBER_ORE = BLOCKS.registerBlock("amber_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F));
    public static final SimpleHolder<DropExperienceBlock> DEEPSLATE_AMBER_ORE = BLOCKS.registerBlock("deepslate_amber_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE));
    public static final SimpleHolder<DropExperienceBlock> PLANT_FOSSIL_ORE = BLOCKS.registerBlock("plant_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F));
    public static final SimpleHolder<DropExperienceBlock> DEEPSLATE_PLANT_FOSSIL_ORE = BLOCKS.registerBlock("deepslate_plant_fossil_ore", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE));
    public static final SimpleHolder<DropExperienceBlock> RELIC_IN_STONE = BLOCKS.registerBlock("relic_in_stone", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F));
    public static final SimpleHolder<DropExperienceBlock> RELIC_IN_DEEPSLATE = BLOCKS.registerBlock("relic_in_deepslate", properties -> new DropExperienceBlock(UniformInt.of(0, 2), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE));
    ...
    public static final SimpleHolder<AmberBlock> AMBER_BLOCK = BLOCKS.registerBlock("amber_block", AmberBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F).noOcclusion());
    ...
    public static final SimpleHolder<ShatteredCultivatorBlock> SHATTERED_CULTIVATOR = BLOCKS.registerBlock("shattered_cultivator", ShatteredCultivatorBlock::new, () -> BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.HAT).strength(0.3F).sound(SoundType.GLASS).noOcclusion().isValidSpawn(BlockUtils::never).isRedstoneConductor(BlockUtils::never).isSuffocating(BlockUtils::never).isViewBlocking(BlockUtils::never));
    ...
    public static final SimpleHolder<PostBlock> WHITE_POST = BLOCKS.registerBlock("white_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_CONCRETE));
    public static final SimpleHolder<PostBlock> ORANGE_POST = BLOCKS.registerBlock("orange_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_CONCRETE));
    public static final SimpleHolder<PostBlock> MAGENTA_POST = BLOCKS.registerBlock("magenta_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_CONCRETE));
    public static final SimpleHolder<PostBlock> LIGHT_BLUE_POST = BLOCKS.registerBlock("light_blue_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_CONCRETE));
    public static final SimpleHolder<PostBlock> YELLOW_POST = BLOCKS.registerBlock("yellow_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_CONCRETE));
    public static final SimpleHolder<PostBlock> LIME_POST = BLOCKS.registerBlock("lime_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_CONCRETE));
    public static final SimpleHolder<PostBlock> PINK_POST = BLOCKS.registerBlock("pink_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_CONCRETE));
    public static final SimpleHolder<PostBlock> GRAY_POST = BLOCKS.registerBlock("gray_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_CONCRETE));
    public static final SimpleHolder<PostBlock> LIGHT_GRAY_POST = BLOCKS.registerBlock("light_gray_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_CONCRETE));
    public static final SimpleHolder<PostBlock> CYAN_POST = BLOCKS.registerBlock("cyan_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_CONCRETE));
    public static final SimpleHolder<PostBlock> PURPLE_POST = BLOCKS.registerBlock("purple_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_CONCRETE));
    public static final SimpleHolder<PostBlock> BLUE_POST = BLOCKS.registerBlock("blue_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_CONCRETE));
    public static final SimpleHolder<PostBlock> BROWN_POST = BLOCKS.registerBlock("brown_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_CONCRETE));
    public static final SimpleHolder<PostBlock> GREEN_POST = BLOCKS.registerBlock("green_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_CONCRETE));
    public static final SimpleHolder<PostBlock> RED_POST = BLOCKS.registerBlock("red_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.RED_CONCRETE));
    public static final SimpleHolder<PostBlock> BLACK_POST = BLOCKS.registerBlock("black_post", PostBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_CONCRETE));
    ...
    public static final SimpleHolder<SimpleGrassyBlock> NIPA_STEM = BLOCKS.registerBlock("nipa_stem", SimpleGrassyBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ));
    public static final SimpleHolder<SimpleGrassyBlock> NIPA_LEAVES = BLOCKS.registerBlock("nipa_leaves", SimpleGrassyBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY).dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ));
    public static final SimpleHolder<CarpetBlock> DRIED_NIPA_LEAVES = BLOCKS.registerBlock("dried_nipa_leaves", CarpetBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).noCollission().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY));
    ...
    public static final SimpleHolder<PachypodiumBlock> PACHYPODIUM = BLOCKS.registerBlock("pachypodium", PachypodiumBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY));
    ...
    public static final SimpleHolder<HeadBlock> ANKYLOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.ANKYLOSAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_ANKYLOSAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.ANKYLOSAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> BARYONYX_HEAD = BLOCKS.registerHead(8, FAHeadTypes.BARYONYX);
    public static final SimpleHolder<WallHeadBlock> WALL_BARYONYX_HEAD = BLOCKS.registerWallHead(FABlocks.BARYONYX_HEAD);
    public static final SimpleHolder<HeadBlock> BRACHIOSAURUS_HEAD = BLOCKS.registerHead(36, FAHeadTypes.BRACHIOSAURUS);
    ...
    public static final SimpleHolder<HeadBlock> CARNOTAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.CARNOTAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_CARNOTAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.CARNOTAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> COMPSOGNATHUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.COMPSOGNATHUS);
    ...
    public static final SimpleHolder<HeadBlock> CRYOLOPHOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.CRYOLOPHOSAURUS);
    ...
    public static final SimpleHolder<HeadBlock> DILOPHOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.DILOPHOSAURUS);
    ...
    public static final SimpleHolder<HeadBlock> DIMETRODON_HEAD = BLOCKS.registerHead(12, FAHeadTypes.DIMETRODON);
    public static final SimpleHolder<WallHeadBlock> WALL_DIMETRODON_HEAD = BLOCKS.registerWallHead(FABlocks.DIMETRODON_HEAD);
    public static final SimpleHolder<HeadBlock> DODO_HEAD = BLOCKS.registerHead(8, FAHeadTypes.DODO);
    public static final SimpleHolder<WallHeadBlock> WALL_DODO_HEAD = BLOCKS.registerWallHead(FABlocks.DODO_HEAD);
    public static final SimpleHolder<HeadBlock> DRYOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.DRYOSAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_DRYOSAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.DRYOSAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> ELASMOTHERIUM_HEAD = BLOCKS.registerHead(8, FAHeadTypes.ELASMOTHERIUM);
    ...
    public static final SimpleHolder<HeadBlock> FUTABASAURUS_HEAD = BLOCKS.registerHead(12, FAHeadTypes.FUTABASAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_FUTABASAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.FUTABASAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> GALLIMIMUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.GALLIMIMUS);
    public static final SimpleHolder<WallHeadBlock> WALL_GALLIMIMUS_HEAD = BLOCKS.registerWallHead(FABlocks.GALLIMIMUS_HEAD);
    public static final SimpleHolder<HeadBlock> HERRERASAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.HERRERASAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_HERRERASAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.HERRERASAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> ICHTHYOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.ICHTHYOSAURUS);
    ...
    public static final SimpleHolder<HeadBlock> MAMMOTH_HEAD = BLOCKS.registerHead(8, FAHeadTypes.MAMMOTH);
    public static final SimpleHolder<WallHeadBlock> WALL_MAMMOTH_HEAD = BLOCKS.registerWallHead(FABlocks.MAMMOTH_HEAD);
    public static final SimpleHolder<HeadBlock> MOA_HEAD = BLOCKS.registerHead(8, FAHeadTypes.MOA);
    public static final SimpleHolder<WallHeadBlock> WALL_MOA_HEAD = BLOCKS.registerWallHead(FABlocks.MOA_HEAD);
    public static final SimpleHolder<HeadBlock> MOSASAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.MOSASAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_MOSASAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.MOSASAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> PACHYCEPHALOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.PACHYCEPHALOSAURUS);
    ...
    public static final SimpleHolder<HeadBlock> PTERANODON_HEAD = BLOCKS.registerHead(8, FAHeadTypes.PTERANODON);
    public static final SimpleHolder<WallHeadBlock> WALL_PTERANODON_HEAD = BLOCKS.registerWallHead(FABlocks.PTERANODON_HEAD);
    public static final SimpleHolder<HeadBlock> SMILODON_HEAD = BLOCKS.registerHead(8, FAHeadTypes.SMILODON);
    public static final SimpleHolder<WallHeadBlock> WALL_SMILODON_HEAD = BLOCKS.registerWallHead(FABlocks.SMILODON_HEAD);
    public static final SimpleHolder<HeadBlock> SPINOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.SPINOSAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_SPINOSAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.SPINOSAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> STEGOSAURUS_HEAD = BLOCKS.registerHead(12, FAHeadTypes.STEGOSAURUS);
    public static final SimpleHolder<WallHeadBlock> WALL_STEGOSAURUS_HEAD = BLOCKS.registerWallHead(FABlocks.STEGOSAURUS_HEAD);
    public static final SimpleHolder<HeadBlock> THERIZINOSAURUS_HEAD = BLOCKS.registerHead(10, FAHeadTypes.THERIZINOSAURUS);
    ...
    public static final SimpleHolder<HeadBlock> TRICERATOPS_HEAD = BLOCKS.registerHead(12, FAHeadTypes.TRICERATOPS);
    public static final SimpleHolder<WallHeadBlock> WALL_TRICERATOPS_HEAD = BLOCKS.registerWallHead(FABlocks.TRICERATOPS_HEAD);
    public static final SimpleHolder<HeadBlock> TYRANNOSAURUS_HEAD = BLOCKS.registerHead(8, FAHeadTypes.TYRANNOSAURUS);
    ...
    public static final SimpleHolder<HeadBlock> VELOCIRAPTOR_HEAD = BLOCKS.registerHead(8, FAHeadTypes.VELOCIRAPTOR);
    ...
    public static final SimpleHolder<Block> THATCH_BLOCK = BLOCKS.registerBlock("thatch_block", Block::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).instrument(NoteBlockInstrument.BANJO).strength(0.5F).sound(SoundType.GRASS));
    public static final SimpleHolder<StairBlock> THATCH_STAIRS = BLOCKS.registerBlock("thatch_stairs", properties -> new StairBlock(FABlocks.THATCH_BLOCK.get().defaultBlockState(), properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).instrument(NoteBlockInstrument.BANJO).strength(0.5F).sound(SoundType.GRASS));
    public static final SimpleHolder<SlabBlock> THATCH_SLAB = BLOCKS.registerBlock("thatch_slab", SlabBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).instrument(NoteBlockInstrument.BANJO).strength(0.5F).sound(SoundType.GRASS));
    ...
    public static final SimpleHolder<RoadMarkingBlock> WHITE_ROAD_MARKING = BLOCKS.registerBlock("white_road_marking", RoadMarkingBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.1F).noOcclusion().noCollission().sound(SoundType.STONE));
    public static final SimpleHolder<RoadMarkingBlock> DOUBLE_WHITE_ROAD_MARKING = BLOCKS.registerBlock("double_white_road_marking", RoadMarkingBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.1F).noOcclusion().noCollission().sound(SoundType.STONE));
    public static final SimpleHolder<RoadMarkingBlock> YELLOW_ROAD_MARKING = BLOCKS.registerBlock("yellow_road_marking", RoadMarkingBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.1F).noOcclusion().noCollission().sound(SoundType.STONE));
