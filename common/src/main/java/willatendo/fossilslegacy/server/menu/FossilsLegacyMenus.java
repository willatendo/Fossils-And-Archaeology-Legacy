...
public class FossilsLegacyMenus {
    ...
    public static final SimpleHolder<MenuType<TimeMachineMenu>> TIME_MACHINE = MENU_TYPES.register("time_machine", () -> SimpleUtils.createMenuType(TimeMachineMenu::new));
