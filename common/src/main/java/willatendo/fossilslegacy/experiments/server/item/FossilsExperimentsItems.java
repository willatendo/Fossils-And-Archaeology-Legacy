...
public class FossilsExperimentsItems {
    ...
    public static final SimpleHolder<ExperimentalEggItem> CARNOTAURUS_EGG = ITEMS.register("carnotaurus_egg", () -> new ExperimentalEggItem(FossilsExperimentsEggVariants.CARNOTAURUS, new Item.Properties()));
    public static final SimpleHolder<ExperimentalEggItem> CRYOLOPHOSAURUS_EGG = ITEMS.register("cryolophosaurus_egg", () -> new ExperimentalEggItem(FossilsExperimentsEggVariants.CRYOLOPHOSAURUS, new Item.Properties()));
    public static final SimpleHolder<ExperimentalEggItem> THERIZINOSAURUS_EGG = ITEMS.register("therizinosaurus_egg", () -> new ExperimentalEggItem(FossilsExperimentsEggVariants.THERIZINOSAURUS, new Item.Properties()));
