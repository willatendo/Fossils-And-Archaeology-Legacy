...
public class Therizinosaurus extends Dinosaur implements DinopediaInformation {
    ...
    protected SoundEvent getAmbientSound() {
        return FossilsExperimentsSoundEvents.THERIZINOSAURUS_AMBIENT.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return FossilsExperimentsSoundEvents.THERIZINOSAURUS_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return FossilsExperimentsSoundEvents.THERIZINOSAURUS_DEATH.get();
    }
