...
public class Cryolophosaurus extends Dinosaur implements DinopediaInformation {
    ...
    public EggVariant getEggVariant() {
        return FossilsExperimentsEggVariants.CRYOLOPHOSAURUS.get();
    }
    ...
    protected SoundEvent getAmbientSound() {
        return FossilsExperimentsSoundEvents.CRYOLOPHOSAURUS_AMBIENT.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return FossilsExperimentsSoundEvents.CRYOLOPHOSAURUS_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return FossilsExperimentsSoundEvents.CRYOLOPHOSAURUS_DEATH.get();
    }
