    ...
    public void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        if (itemstack.is(FABlocks.SKULL_BLOCK.get().asItem())) {
            if (minecraft.options.getCameraType().isFirstPerson() && !itemstack.isEmpty() && !minecraft.player.isScoping()) {
                ...
                guiGraphics.blit(FAUtils.resource("textures/misc/skullblur.png"), 0, 0, -90, 0.0F, 0.0F, guiGraphics.guiWidth(), guiGraphics.guiHeight(), guiGraphics.guiWidth(), guiGraphics.guiHeight());
